...
- Install from the marketplace listing: https://agentskillexchange.com/skills/sqlite-utils-python-cli-sqlite-manipulation/
...
- Download the repository ZIP and extract `skills/sqlite-utils-python-cli-sqlite-manipulation`.
