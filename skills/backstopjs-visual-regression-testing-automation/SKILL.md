...
- Install from the marketplace listing: https://agentskillexchange.com/skills/backstopjs-visual-regression-testing-automation/
...
- Download the repository ZIP and extract `skills/backstopjs-visual-regression-testing-automation`.
