...
- Install from the marketplace listing: https://agentskillexchange.com/skills/graphql-schema-registry-agent/
...
- Download the repository ZIP and extract `skills/graphql-schema-registry-agent`.
