...
- Install from the marketplace listing: https://agentskillexchange.com/skills/ripgrep-recursive-regex-search-tool/
...
- Download the repository ZIP and extract `skills/ripgrep-recursive-regex-search-tool`.
