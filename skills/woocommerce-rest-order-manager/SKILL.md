...
- Install from the marketplace listing: https://agentskillexchange.com/skills/woocommerce-rest-order-manager/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/woocommerce-rest-order-manager
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/woocommerce-rest-order-manager`.
