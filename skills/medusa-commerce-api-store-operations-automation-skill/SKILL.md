...
```bash
npx skills add agentskillexchange/skills --skill medusa-commerce-api-store-operations-automation-skill
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill medusa-commerce-api-store-operations-automation-skill -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill medusa-commerce-api-store-operations-automation-skill -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill medusa-commerce-api-store-operations-automation-skill -a codex
```
