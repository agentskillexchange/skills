...
- Install from the marketplace listing: https://agentskillexchange.com/skills/act-local-github-actions-runner/
...
- Download the repository ZIP and extract `skills/act-local-github-actions-runner`.
