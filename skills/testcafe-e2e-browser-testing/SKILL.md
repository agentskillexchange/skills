...
# OpenClaw CLI
openclaw skills install testcafe-e2e-browser-testing

# Chat command
/skill install testcafe-e2e-browser-testing

# Direct download
curl -L https://agentskillexchange.com/skills/testcafe-e2e-browser-testing/download -o testcafe-e2e-browser-testing.zip

# Git clone this repo and copy the skill folder
cp -r skills/testcafe-e2e-browser-testing ~/.openclaw/workspace/skills/
```
