...
```bash
npx skills add agentskillexchange/skills --skill himalaya-cli-email-client-imap-smtp-notmuch
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill himalaya-cli-email-client-imap-smtp-notmuch -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill himalaya-cli-email-client-imap-smtp-notmuch -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill himalaya-cli-email-client-imap-smtp-notmuch -a codex
```
