...
- Install from the marketplace listing: https://agentskillexchange.com/skills/investigate-failing-github-actions-runs-with-ci-doctor/
...
- Download the repository ZIP and extract `skills/investigate-failing-github-actions-runs-with-ci-doctor`.
