...
tool_ecosystem:
  github_repo: "https://github.com/yoast/wordpress-seo"
  github_stars: 1926
---
...
```bash
npx skills add agentskillexchange/skills --skill yoast-seo-wordpress-optimization-toolkit
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill yoast-seo-wordpress-optimization-toolkit -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill yoast-seo-wordpress-optimization-toolkit -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill yoast-seo-wordpress-optimization-toolkit -a codex
```

### OpenClaw

```bash
clawhub install yoast-seo-wordpress-optimization-toolkit
```


## Source

- [GitHub](https://github.com/Yoast/wordpress-seo)
