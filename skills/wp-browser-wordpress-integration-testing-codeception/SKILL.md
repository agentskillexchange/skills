...
- Install from the marketplace listing: https://agentskillexchange.com/skills/wp-browser-wordpress-integration-testing-codeception/
...
- Download the repository ZIP and extract `skills/wp-browser-wordpress-integration-testing-codeception`.
