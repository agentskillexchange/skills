...
- Install from the marketplace listing: https://agentskillexchange.com/skills/age-modern-file-encryption-tool/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/age-modern-file-encryption-tool
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/age-modern-file-encryption-tool`.
