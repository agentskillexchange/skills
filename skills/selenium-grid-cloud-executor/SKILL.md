...
- Install from the marketplace listing: https://agentskillexchange.com/skills/selenium-grid-cloud-executor/
...
- Download the repository ZIP and extract `skills/selenium-grid-cloud-executor`.
