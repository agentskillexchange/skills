...
- Install from the marketplace listing: https://agentskillexchange.com/skills/graphql-schema-introspection-mapper/
...
- Download the repository ZIP and extract `skills/graphql-schema-introspection-mapper`.
