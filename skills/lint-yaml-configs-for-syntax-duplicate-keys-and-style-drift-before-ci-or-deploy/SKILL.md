...
Download the skill folder or repository archive and extract `skills/lint-yaml-configs-for-syntax-duplicate-keys-and-style-drift-before-ci-or-deploy` into your local skills collection.
