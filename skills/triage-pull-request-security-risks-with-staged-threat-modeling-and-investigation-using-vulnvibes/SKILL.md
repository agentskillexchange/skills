...
Download the skill folder or repository archive and extract `skills/triage-pull-request-security-risks-with-staged-threat-modeling-and-investigation-using-vulnvibes` into your local skills collection.
