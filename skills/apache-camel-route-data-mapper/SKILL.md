...
- Install from the marketplace listing: https://agentskillexchange.com/skills/apache-camel-route-data-mapper/
...
- Download the repository ZIP and extract `skills/apache-camel-route-data-mapper`.
