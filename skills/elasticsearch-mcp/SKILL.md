...
- Install from the marketplace listing: https://agentskillexchange.com/skills/elasticsearch-mcp/
...
- Download the repository ZIP and extract `skills/elasticsearch-mcp`.
