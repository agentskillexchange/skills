...
```bash
npx skills add agentskillexchange/skills --skill scrapegraphai-llm-web-scraping
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill scrapegraphai-llm-web-scraping -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill scrapegraphai-llm-web-scraping -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill scrapegraphai-llm-web-scraping -a codex
```
