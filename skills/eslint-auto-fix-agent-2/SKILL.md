...
### OpenClaw
```bash
clawhub install eslint-auto-fix-agent-2
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skill/eslint-auto-fix-agent-2/) · [Browse All Skills](https://agentskillexchange.com)
