...
- Install from the marketplace listing: https://agentskillexchange.com/skills/shiori-self-hosted-bookmark-manager-cli-web/
...
- Download the repository ZIP and extract `skills/shiori-self-hosted-bookmark-manager-cli-web`.
