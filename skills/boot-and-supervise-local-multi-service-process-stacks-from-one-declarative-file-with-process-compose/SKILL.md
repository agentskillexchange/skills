...
Download the skill folder or repository archive and extract `skills/boot-and-supervise-local-multi-service-process-stacks-from-one-declarative-file-with-process-compose` into your local skills collection.
