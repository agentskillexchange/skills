...
- Install from the marketplace listing: https://agentskillexchange.com/skills/slack-mcp-server/
...
- Download the repository ZIP and extract `skills/slack-mcp-server`.
