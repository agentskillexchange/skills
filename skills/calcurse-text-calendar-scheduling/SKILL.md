...
- Install from the marketplace listing: https://agentskillexchange.com/skills/calcurse-text-calendar-scheduling/
...
- Download the repository ZIP and extract `skills/calcurse-text-calendar-scheduling`.
