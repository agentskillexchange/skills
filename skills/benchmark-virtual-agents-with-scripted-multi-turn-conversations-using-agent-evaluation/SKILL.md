...
Download the skill folder or repository archive and extract `skills/benchmark-virtual-agents-with-scripted-multi-turn-conversations-using-agent-evaluation` into your local skills collection.
