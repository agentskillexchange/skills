...
Download the skill folder or repository archive and extract `skills/run-repeatable-google-ads-and-seo-audits-inside-claude-code-with-toprank` into your local skills collection.
