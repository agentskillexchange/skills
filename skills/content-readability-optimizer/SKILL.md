...
- Install from the marketplace listing: https://agentskillexchange.com/skills/content-readability-optimizer/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/content-readability-optimizer
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/content-readability-optimizer`.
