...
### Claude Code
```bash
npx skills add wordpress-mcp-adapter-model-context-protocol-bridge --claude
```

### Cursor
```bash
npx skills add wordpress-mcp-adapter-model-context-protocol-bridge --cursor
```

### Codex
```bash
npx skills add wordpress-mcp-adapter-model-context-protocol-bridge --codex
```
