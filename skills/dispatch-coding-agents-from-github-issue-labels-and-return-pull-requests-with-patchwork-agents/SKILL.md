...
Download the skill folder or repository archive and extract `skills/dispatch-coding-agents-from-github-issue-labels-and-return-pull-requests-with-patchwork-agents` into your local skills collection.
