---
title: Check Kubernetes hosts against CIS guidance with kube-bench before audit or
  hardening work
description: Run a benchmark-driven posture check on Kubernetes nodes and control
  planes before an audit, upgrade, or hardening sprint starts.
verification: listed
