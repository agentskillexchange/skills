...
- Install from the marketplace listing: https://agentskillexchange.com/skills/eslint-auto-fixer/
...
- Download the repository ZIP and extract `skills/eslint-auto-fixer`.
