...
- Install from the marketplace listing: https://agentskillexchange.com/skills/python-type-coverage-analyzer/
...
- Download the repository ZIP and extract `skills/python-type-coverage-analyzer`.
