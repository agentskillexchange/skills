...
- Install from the marketplace listing: https://agentskillexchange.com/skills/dockge-docker-compose-stack-manager/
...
- Download the repository ZIP and extract `skills/dockge-docker-compose-stack-manager`.
