...
- Install from the marketplace listing: https://agentskillexchange.com/skills/snowflake-mcp-server/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/snowflake-mcp-server
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/snowflake-mcp-server`.
