...
description: Snowflake MCP Server is built around Snowflake cloud data warehouse.
  ...
  for real tasks. In practice, the skill gives an agent a stable interface to snowflake
  ...
  on SQL, warehouses, stages, tasks, streams, Snowpark, query history, with configuration
