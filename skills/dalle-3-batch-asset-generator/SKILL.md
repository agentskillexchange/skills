...
- Install from the marketplace listing: https://agentskillexchange.com/skills/dalle-3-batch-asset-generator/
...
- Download the repository ZIP and extract `skills/dalle-3-batch-asset-generator`.
