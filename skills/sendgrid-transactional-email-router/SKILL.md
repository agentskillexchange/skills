...
- Install from the marketplace listing: https://agentskillexchange.com/skills/sendgrid-transactional-email-router/
...
- Download the repository ZIP and extract `skills/sendgrid-transactional-email-router`.
