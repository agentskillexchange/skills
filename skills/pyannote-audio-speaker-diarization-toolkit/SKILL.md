...
```bash
# Using OpenClaw CLI
openclaw skills install pyannote-audio-speaker-diarization-toolkit
```

**Or install from the Agent Skill Exchange:**
[https://agentskillexchange.com/skills/pyannote-audio-speaker-diarization-toolkit/](https://agentskillexchange.com/skills/pyannote-audio-speaker-diarization-toolkit/)
