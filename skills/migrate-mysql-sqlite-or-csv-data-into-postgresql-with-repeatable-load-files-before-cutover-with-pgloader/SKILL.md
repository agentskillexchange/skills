...
Download the skill folder or repository archive and extract `skills/migrate-mysql-sqlite-or-csv-data-into-postgresql-with-repeatable-load-files-before-cutover-with-pgloader` into your local skills collection.
