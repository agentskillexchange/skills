...
Download the skill folder or repository archive and extract `skills/nocobase-extensible-no-code-low-code-platform` into your local skills collection.
