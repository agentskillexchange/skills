...
- Install from the marketplace listing: https://agentskillexchange.com/skills/slack-workflow-bot-bolt-sdk/
...
- Download the repository ZIP and extract `skills/slack-workflow-bot-bolt-sdk`.
