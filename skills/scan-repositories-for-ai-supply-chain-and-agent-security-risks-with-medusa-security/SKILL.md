...
Download the skill folder or repository archive and extract `skills/scan-repositories-for-ai-supply-chain-and-agent-security-risks-with-medusa-security` into your local skills collection.
