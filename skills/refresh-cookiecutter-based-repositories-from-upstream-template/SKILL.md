...
Download the skill folder or repository archive and extract `skills/refresh-cookiecutter-based-repositories-from-upstream-template` into your local skills collection.
