...
- Install from the marketplace listing: https://agentskillexchange.com/skills/wikijs-wiki-platform-nodejs/
...
- Download the repository ZIP and extract `skills/wikijs-wiki-platform-nodejs`.
