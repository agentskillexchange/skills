...
Download the skill folder or repository archive and extract `skills/playwright-python-browser-automation-library-cross-browser-testing` into your local skills collection.
