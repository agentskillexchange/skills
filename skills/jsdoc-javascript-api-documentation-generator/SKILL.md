...
- Install from the marketplace listing: https://agentskillexchange.com/skills/jsdoc-javascript-api-documentation-generator/
...
- Download the repository ZIP and extract `skills/jsdoc-javascript-api-documentation-generator`.
