...
Download the skill folder or repository archive and extract `skills/find-duplicate-and-visually-similar-media-before-cleanup-with-czkawka` into your local skills collection.
...
- [Agent Skill Exchange](https://agentskillexchange.com/skills/find-duplicate-and-visually-similar-media-before-cleanup-with-czkawka/)
