...
### Any Agent
```bash
npx skills add svgo-svg-optimization-tool
```

### Claude Code
```bash
npx skills add --claude svgo-svg-optimization-tool
```

### Cursor
```bash
npx skills add --cursor svgo-svg-optimization-tool
```

### Codex
```bash
npx skills add --codex svgo-svg-optimization-tool
```
