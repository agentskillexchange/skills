...
- Install from the marketplace listing: https://agentskillexchange.com/skills/svgo-svg-optimization-tool/
...
- Download the repository ZIP and extract `skills/svgo-svg-optimization-tool`.
