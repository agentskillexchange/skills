...
- Install from the marketplace listing: https://agentskillexchange.com/skills/cypress-e2e-api-intercept-skill/
...
- Download the repository ZIP and extract `skills/cypress-e2e-api-intercept-skill`.
