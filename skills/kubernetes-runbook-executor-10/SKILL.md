...
### OpenClaw
```bash
clawhub install kubernetes-runbook-executor-10
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skill/kubernetes-runbook-executor-10/) · [Browse All Skills](https://agentskillexchange.com/)