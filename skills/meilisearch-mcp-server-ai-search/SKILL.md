...
- Install from the marketplace listing: https://agentskillexchange.com/skills/meilisearch-mcp-server-ai-search/
...
- Download the repository ZIP and extract `skills/meilisearch-mcp-server-ai-search`.
