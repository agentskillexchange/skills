...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/meilisearch-mcp-server-ai-search
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/meilisearch-mcp-server-ai-search` into your local skills collection.
