...
# OpenClaw CLI
openclaw skills install lipgloss-terminal-styling-library

# Chat command
/skill install lipgloss-terminal-styling-library

# Direct download
curl -L https://agentskillexchange.com/skills/lipgloss-terminal-styling-library/download -o lipgloss-terminal-styling-library.zip

# Git clone this repo and copy the skill folder
cp -r skills/lipgloss-terminal-styling-library ~/.openclaw/workspace/skills/
```
