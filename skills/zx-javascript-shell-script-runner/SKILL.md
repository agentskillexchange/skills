...
```bash
npx skills add agentskillexchange/skills --skill zx-javascript-shell-script-runner
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill zx-javascript-shell-script-runner -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill zx-javascript-shell-script-runner -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill zx-javascript-shell-script-runner -a codex
```
