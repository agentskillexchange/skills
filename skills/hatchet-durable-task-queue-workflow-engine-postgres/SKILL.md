...
# OpenClaw CLI
openclaw skills install hatchet-durable-task-queue-workflow-engine-postgres

# Git (manual)
git clone https://github.com/agentskillexchange/skills.git
cp -r skills/skills/hatchet-durable-task-queue-workflow-engine-postgres ~/.openclaw/workspace/skills/
```
