...
Download the skill folder or repository archive and extract `skills/run-academic-writing-analysis-and-replication-workflows-with-quality-gates-in-claude-code-my-workflow` into your local skills collection.
