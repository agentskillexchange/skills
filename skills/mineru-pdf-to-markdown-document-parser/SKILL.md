...
- Install from the marketplace listing: https://agentskillexchange.com/skills/mineru-pdf-to-markdown-document-parser/
...
- Download the repository ZIP and extract `skills/mineru-pdf-to-markdown-document-parser`.
