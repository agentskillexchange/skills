...
- Install from the marketplace listing: https://agentskillexchange.com/skills/postgresql-query-plan-diagnostics-wave48/
...
- Download the repository ZIP and extract `skills/postgresql-query-plan-diagnostics-wave48`.
