...
Download the skill folder or repository archive and extract `skills/reduce-agent-token-burn-on-repo-scale-coding-commands-with-the-rtk-cli-proxy` into your local skills collection.
