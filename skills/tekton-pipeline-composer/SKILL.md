...
- Install from the marketplace listing: https://agentskillexchange.com/skills/tekton-pipeline-composer/
...
- Download the repository ZIP and extract `skills/tekton-pipeline-composer`.
