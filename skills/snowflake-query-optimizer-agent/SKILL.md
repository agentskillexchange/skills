...
- Install from the marketplace listing: https://agentskillexchange.com/skills/snowflake-query-optimizer-agent/
...
- Download the repository ZIP and extract `skills/snowflake-query-optimizer-agent`.
