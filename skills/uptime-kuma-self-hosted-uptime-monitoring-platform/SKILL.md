...
Download the skill folder or repository archive and extract `skills/uptime-kuma-self-hosted-uptime-monitoring-platform` into your local skills collection.
