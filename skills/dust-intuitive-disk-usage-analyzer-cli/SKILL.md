...
### Claude Code
```bash
npx skills add https://agentskillexchange.com/skills/dust-intuitive-disk-usage-analyzer-cli/
```

### Cursor
```bash
npx skills add https://agentskillexchange.com/skills/dust-intuitive-disk-usage-analyzer-cli/ --cursor
```

### Codex
```bash
npx skills add https://agentskillexchange.com/skills/dust-intuitive-disk-usage-analyzer-cli/ --codex
```
