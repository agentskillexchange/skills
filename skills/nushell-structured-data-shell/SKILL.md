...
```bash
npx skills add agentskillexchange/skills --skill nushell-structured-data-shell
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill nushell-structured-data-shell -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill nushell-structured-data-shell -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill nushell-structured-data-shell -a codex
```
