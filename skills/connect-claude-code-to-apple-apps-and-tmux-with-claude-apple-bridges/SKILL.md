...
description: Give Claude Code local command access to Reminders, Calendar, Contacts,
  Notes, Mail, and tmux for workflow-aware personal ops on macOS.
verification: listed
...
- [Agent Skill Exchange](https://agentskillexchange.com/skills/connect-claude-code-to-apple-apps-and-tmux-with-claude-apple-bridges/)
