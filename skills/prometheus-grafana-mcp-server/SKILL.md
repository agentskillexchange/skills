...
description: Prometheus / Grafana MCP Server is built around Grafana visualization
  ...
  API, panels, Loki/Prometheus datasources, alerting, rendered images […]
...
Download the skill folder or repository archive and extract `skills/prometheus-grafana-mcp-server` into your local skills collection.
