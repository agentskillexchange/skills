...
- Install from the marketplace listing: https://agentskillexchange.com/skills/github-actions-cicd-pipeline-manager/
...
- Download the repository ZIP and extract `skills/github-actions-cicd-pipeline-manager`.
