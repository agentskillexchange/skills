...
- Install from the marketplace listing: https://agentskillexchange.com/skills/owasp-zap-api-security-tester/
...
- Download the repository ZIP and extract `skills/owasp-zap-api-security-tester`.
