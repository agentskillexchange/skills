...
- Install from the marketplace listing: https://agentskillexchange.com/skills/datadog-monitor-configuration-engine/
...
- Download the repository ZIP and extract `skills/datadog-monitor-configuration-engine`.
