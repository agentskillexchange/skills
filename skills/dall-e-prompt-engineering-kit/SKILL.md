...
- Install from the marketplace listing: https://agentskillexchange.com/skills/dall-e-prompt-engineering-kit/
...
- Download the repository ZIP and extract `skills/dall-e-prompt-engineering-kit`.
