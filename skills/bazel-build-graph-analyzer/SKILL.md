...
- Install from the marketplace listing: https://agentskillexchange.com/skills/bazel-build-graph-analyzer/
...
- Download the repository ZIP and extract `skills/bazel-build-graph-analyzer`.
