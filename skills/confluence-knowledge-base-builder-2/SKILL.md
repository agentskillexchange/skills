...
```bash
claude mcp add confluence-knowledge-base-builder-2
```

### Manual

Visit the [skill page](https://agentskillexchange.com/skill/confluence-knowledge-base-builder-2/) for detailed installation instructions.
