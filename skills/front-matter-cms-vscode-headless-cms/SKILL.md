...
### Claude Code
```bash
npx skills add --claude front-matter-cms-vscode-headless-cms
```

### Cursor
```bash
npx skills add --cursor front-matter-cms-vscode-headless-cms
```

### Codex
```bash
npx skills add --codex front-matter-cms-vscode-headless-cms
```
