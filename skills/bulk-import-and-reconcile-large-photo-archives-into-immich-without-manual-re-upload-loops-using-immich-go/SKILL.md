...
Download the skill folder or repository archive and extract `skills/bulk-import-and-reconcile-large-photo-archives-into-immich-without-manual-re-upload-loops-using-immich-go` into your local skills collection.
