...
Download the skill folder or repository archive and extract `skills/audit-python-dependency-sets-for-known-vulnerabilities-before-release-or-environment-promotion-with-safety` into your local skills collection.
