...
Novu is built with TypeScript and Node.js, using MongoDB for persistence and Redis for queuing and caching. The platform can be self-hosted via Docker Compose or deployed on Kubernetes. Novu also offers a managed cloud service for teams that prefer not to operate the infrastructure themselves.
...
- Download the repository ZIP and extract `skills/novu-open-source-notification-infrastructure-platform`.
