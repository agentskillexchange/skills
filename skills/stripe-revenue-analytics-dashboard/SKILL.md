...
- Install from the marketplace listing: https://agentskillexchange.com/skills/stripe-revenue-analytics-dashboard/
...
- Download the repository ZIP and extract `skills/stripe-revenue-analytics-dashboard`.
