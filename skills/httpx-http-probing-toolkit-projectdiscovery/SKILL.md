...
### Any Agent (npx)
```bash
npx skills add httpx-http-probing-toolkit-projectdiscovery
```

### Claude Code
```bash
npx skills add httpx-http-probing-toolkit-projectdiscovery --claude-code
```

### Cursor
```bash
npx skills add httpx-http-probing-toolkit-projectdiscovery --cursor
```

### Codex
```bash
npx skills add httpx-http-probing-toolkit-projectdiscovery --codex
```
