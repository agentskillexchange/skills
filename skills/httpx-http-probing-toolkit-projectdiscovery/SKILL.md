...
- Install from the marketplace listing: https://agentskillexchange.com/skills/httpx-http-probing-toolkit-projectdiscovery/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/httpx-http-probing-toolkit-projectdiscovery
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/httpx-http-probing-toolkit-projectdiscovery`.
