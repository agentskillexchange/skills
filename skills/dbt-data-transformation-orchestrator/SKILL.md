...
- Install from the marketplace listing: https://agentskillexchange.com/skills/dbt-data-transformation-orchestrator/
...
- Download the repository ZIP and extract `skills/dbt-data-transformation-orchestrator`.
