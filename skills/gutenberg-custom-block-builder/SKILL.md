...
- ### Using Gutenberg
- **Download:** To use the latest release of the Gutenberg plugin on your WordPress site: install from the plugins page in wp-admin, or [download from the WordPress.org plugins repository](https://wordpress.org/plugins/...

- Source: https://github.com/WordPress/gutenberg
- Extracted from upstream docs: https://raw.githubusercontent.com/WordPress/gutenberg/HEAD/README.md
