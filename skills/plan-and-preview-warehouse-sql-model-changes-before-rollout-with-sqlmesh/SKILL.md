...
Download the skill folder or repository archive and extract `skills/plan-and-preview-warehouse-sql-model-changes-before-rollout-with-sqlmesh` into your local skills collection.
