...
- Install from the marketplace listing: https://agentskillexchange.com/skills/zed-high-performance-multiplayer-code-editor/
...
- Download the repository ZIP and extract `skills/zed-high-performance-multiplayer-code-editor`.
