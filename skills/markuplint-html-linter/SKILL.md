...
- Install from the marketplace listing: https://agentskillexchange.com/skills/markuplint-html-linter/
...
- Download the repository ZIP and extract `skills/markuplint-html-linter`.
