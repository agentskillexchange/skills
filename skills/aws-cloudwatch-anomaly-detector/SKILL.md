...
- Install from the marketplace listing: https://agentskillexchange.com/skills/aws-cloudwatch-anomaly-detector/
...
- Download the repository ZIP and extract `skills/aws-cloudwatch-anomaly-detector`.
