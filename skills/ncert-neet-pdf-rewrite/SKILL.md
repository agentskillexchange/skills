---
name: "NCERT to NEET PDF Rewrite"
slug: "ncert-neet-pdf-rewrite"
description: "Convert an NCERT Biology chapter into a NEET-exam-focused, print-ready A4 PDF plus the Python/ReportLab script that generated it. Use when the user uploads an NCERT chapter and asks for a NEET rewrite, revision PDF, or exam-focused version. Zero information loss — every definition, number, qualifier, and table row is preserved."
category: "Content Writing & SEO"
framework: "Claude Code"
verification: listed
source: "https://github.com/vercel-labs/agent-skills/pull/313"
---
