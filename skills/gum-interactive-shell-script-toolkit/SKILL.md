...
- Install from the marketplace listing: https://agentskillexchange.com/skills/gum-interactive-shell-script-toolkit/
...
- Download the repository ZIP and extract `skills/gum-interactive-shell-script-toolkit`.
