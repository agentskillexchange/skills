...
- Install from the marketplace listing: https://agentskillexchange.com/skills/ingestr-cross-database-data-copier/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/ingestr-cross-database-data-copier
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/ingestr-cross-database-data-copier`.
