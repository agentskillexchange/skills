...
Download the skill folder or repository archive and extract `skills/create-and-debug-local-first-declarative-workflow-jobs-with-dagu` into your local skills collection.
