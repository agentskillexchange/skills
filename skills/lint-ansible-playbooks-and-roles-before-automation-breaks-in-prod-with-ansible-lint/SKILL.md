...
description: Run ansible-lint against playbooks, roles, and collections so risky patterns
  and common mistakes are caught before automation is merged or executed.
verification: listed
