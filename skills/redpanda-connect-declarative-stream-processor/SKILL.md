...
- Install from the marketplace listing: https://agentskillexchange.com/skills/redpanda-connect-declarative-stream-processor/
...
- Download the repository ZIP and extract `skills/redpanda-connect-declarative-stream-processor`.
