...
### Claude Code
```bash
npx skills add redpanda-connect-declarative-stream-processor --claude-code
```

### Cursor
```bash
npx skills add redpanda-connect-declarative-stream-processor --cursor
```

### Codex
```bash
npx skills add redpanda-connect-declarative-stream-processor --codex
```
