...
### Claude Code
```bash
npx skills add https://agentskillexchange.com/skills/eza-modern-file-listing-cli/
```

### Cursor
```bash
npx skills add https://agentskillexchange.com/skills/eza-modern-file-listing-cli/ --cursor
```

### Codex
```bash
npx skills add https://agentskillexchange.com/skills/eza-modern-file-listing-cli/ --codex
```
