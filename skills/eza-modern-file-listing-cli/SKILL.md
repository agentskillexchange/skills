...
- Install from the marketplace listing: https://agentskillexchange.com/skills/eza-modern-file-listing-cli/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/eza-modern-file-listing-cli
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/eza-modern-file-listing-cli`.
