...
- Install from the marketplace listing: https://agentskillexchange.com/skills/bat-syntax-highlighting-cat-replacement/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/bat-syntax-highlighting-cat-replacement
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/bat-syntax-highlighting-cat-replacement`.
