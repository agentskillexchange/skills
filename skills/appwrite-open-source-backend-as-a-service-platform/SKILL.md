...
- Install from the marketplace listing: https://agentskillexchange.com/skills/appwrite-open-source-backend-as-a-service-platform/
...
- Download the repository ZIP and extract `skills/appwrite-open-source-backend-as-a-service-platform`.
