...
```bash
npx skills add agentskillexchange/skills --skill budibase-open-source-low-code-operations-app-platform
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill budibase-open-source-low-code-operations-app-platform -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill budibase-open-source-low-code-operations-app-platform -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill budibase-open-source-low-code-operations-app-platform -a codex
```
