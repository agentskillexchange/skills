...
- Install from the marketplace listing: https://agentskillexchange.com/skills/naabu-fast-port-scanner-projectdiscovery/
...
- Download the repository ZIP and extract `skills/naabu-fast-port-scanner-projectdiscovery`.
