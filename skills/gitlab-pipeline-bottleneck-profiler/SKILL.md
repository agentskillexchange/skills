...
- Install from the marketplace listing: https://agentskillexchange.com/skills/gitlab-pipeline-bottleneck-profiler/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/gitlab-pipeline-bottleneck-profiler
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/gitlab-pipeline-bottleneck-profiler`.
