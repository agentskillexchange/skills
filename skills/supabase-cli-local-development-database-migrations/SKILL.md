...
Download the skill folder or repository archive and extract `skills/supabase-cli-local-development-database-migrations` into your local skills collection.
