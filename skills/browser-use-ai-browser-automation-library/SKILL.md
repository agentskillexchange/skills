...
```bash
npx skills add agentskillexchange/skills --skill browser-use-ai-browser-automation-library
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill browser-use-ai-browser-automation-library -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill browser-use-ai-browser-automation-library -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill browser-use-ai-browser-automation-library -a codex
```
