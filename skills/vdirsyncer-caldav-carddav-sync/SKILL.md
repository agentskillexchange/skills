...
- Install from the marketplace listing: https://agentskillexchange.com/skills/vdirsyncer-caldav-carddav-sync/
...
- Download the repository ZIP and extract `skills/vdirsyncer-caldav-carddav-sync`.
