...
Download the skill folder or repository archive and extract `skills/run-queued-background-coding-sessions-across-github-slack-linear-and-webhooks-with-background-agents` into your local skills collection.
