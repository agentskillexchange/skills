...
### OpenClaw
```bash
clawhub install playwright-visual-regression-tester
```
...
- [View on Agent Skill Exchange](https://agentskillexchange.com/skill/playwright-visual-regression-tester/)
