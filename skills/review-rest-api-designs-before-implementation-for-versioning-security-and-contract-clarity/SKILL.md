...
Download the skill folder or repository archive and extract `skills/review-rest-api-designs-before-implementation-for-versioning-security-and-contract-clarity` into your local skills collection.
