...
- Install from the marketplace listing: https://agentskillexchange.com/skills/postgresql-query-plan-analyzer-2/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/postgresql-query-plan-analyzer-2
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/postgresql-query-plan-analyzer-2`.
