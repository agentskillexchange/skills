...
- Install from the marketplace listing: https://agentskillexchange.com/skills/semgrep-pattern-matching-auditor/
...
- Download the repository ZIP and extract `skills/semgrep-pattern-matching-auditor`.
