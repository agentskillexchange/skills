...
Download the skill folder or repository archive and extract `skills/gate-mcp-tool-calls-behind-deterministic-policy-enforcement-with-intercept` into your local skills collection.
