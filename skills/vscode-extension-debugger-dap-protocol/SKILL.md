...
- Install from the marketplace listing: https://agentskillexchange.com/skills/vscode-extension-debugger-dap-protocol/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/vscode-extension-debugger-dap-protocol
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/vscode-extension-debugger-dap-protocol`.
