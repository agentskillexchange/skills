...
- Install from the marketplace listing: https://agentskillexchange.com/skills/patent-landscape-analyzer/
...
- Download the repository ZIP and extract `skills/patent-landscape-analyzer`.
