...
### Any Agent (npx)
```bash
npx skills add "polars-dataframe-query-engine"
```

### Claude Code
```bash
npx skills add "polars-dataframe-query-engine" --claude
```

### Cursor
```bash
npx skills add "polars-dataframe-query-engine" --cursor
```

### Codex
```bash
npx skills add "polars-dataframe-query-engine" --codex
```
