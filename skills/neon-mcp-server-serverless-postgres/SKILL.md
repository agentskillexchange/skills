...
- Install from the marketplace listing: https://agentskillexchange.com/skills/neon-mcp-server-serverless-postgres/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/neon-mcp-server-serverless-postgres
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/neon-mcp-server-serverless-postgres`.
