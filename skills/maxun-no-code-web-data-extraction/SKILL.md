...
### Any Agent (npx)
```bash
npx skills add maxun-no-code-web-data-extraction
```

### Claude Code
```bash
npx skills add maxun-no-code-web-data-extraction --claude-code
```

### Cursor
```bash
npx skills add maxun-no-code-web-data-extraction --cursor
```

### Codex
```bash
npx skills add maxun-no-code-web-data-extraction --codex
```
