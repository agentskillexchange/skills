...
```bash
npx skills add agentskillexchange/skills --skill maxun-no-code-web-data-extraction
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill maxun-no-code-web-data-extraction -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill maxun-no-code-web-data-extraction -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill maxun-no-code-web-data-extraction -a codex
```
