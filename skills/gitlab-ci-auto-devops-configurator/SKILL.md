...
```bash
openclaw install gitlab-ci-auto-devops-configurator
```
...
| Rating | ⭐⭐⭐⭐ 4.8/5.0 (70 reviews) |

---

*Published on [Agent Skill Exchange](https://agentskillexchange.com/skill/gitlab-ci-auto-devops-configurator/)*
