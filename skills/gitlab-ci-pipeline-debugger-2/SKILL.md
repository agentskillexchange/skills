...
### OpenClaw
```bash
clawhub install gitlab-ci-pipeline-debugger-2
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skills/gitlab-ci-pipeline-debugger-2/) · [Browse All Skills](https://agentskillexchange.com/)