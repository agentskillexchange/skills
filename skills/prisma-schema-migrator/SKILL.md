...
- Install from the marketplace listing: https://agentskillexchange.com/skills/prisma-schema-migrator/
...
- Download the repository ZIP and extract `skills/prisma-schema-migrator`.
