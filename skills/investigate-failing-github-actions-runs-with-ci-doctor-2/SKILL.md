...
Download the skill folder or repository archive and extract `skills/investigate-failing-github-actions-runs-with-ci-doctor-2` into your local skills collection.
