...
```bash
npx skills add mkcert-local-dev-tls-certificate-generator
```

### Cursor

```bash
npx skills add --cursor mkcert-local-dev-tls-certificate-generator
```

### Codex

```bash
npx skills add --codex mkcert-local-dev-tls-certificate-generator
```
