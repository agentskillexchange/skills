...
Download the skill folder or repository archive and extract `skills/strip-noisy-runtime-fields-from-kubernetes-yaml-before-review-with-kubectl-neat` into your local skills collection.
