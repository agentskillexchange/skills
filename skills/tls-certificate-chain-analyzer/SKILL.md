...
- Install from the marketplace listing: https://agentskillexchange.com/skills/tls-certificate-chain-analyzer/
...
- Download the repository ZIP and extract `skills/tls-certificate-chain-analyzer`.
