...
- Install from the marketplace listing: https://agentskillexchange.com/skills/playwright-network-har-recorder/
...
- Download the repository ZIP and extract `skills/playwright-network-har-recorder`.
