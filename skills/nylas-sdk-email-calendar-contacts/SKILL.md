...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/nylas-sdk-email-calendar-contacts
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/nylas-sdk-email-calendar-contacts` into your local skills collection.
