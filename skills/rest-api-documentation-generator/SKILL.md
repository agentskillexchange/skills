...
- Install from the marketplace listing: https://agentskillexchange.com/skills/rest-api-documentation-generator/
...
- Download the repository ZIP and extract `skills/rest-api-documentation-generator`.
