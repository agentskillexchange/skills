...
description: "Logdy is a zero-dependency single-binary log viewer that pipes any command output into an interactive browser-based UI. It supports custom TypeScript parsers, column definitions, filtering, and works "
...
- [Upstream Project](https://github.com/logdyhq/logdy-core)
