...
- Install from the marketplace listing: https://agentskillexchange.com/skills/logdy-realtime-log-viewer-web-ui-cli/
...
- Download the repository ZIP and extract `skills/logdy-realtime-log-viewer-web-ui-cli`.
