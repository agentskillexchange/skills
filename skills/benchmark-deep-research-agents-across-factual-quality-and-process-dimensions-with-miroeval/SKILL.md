...
Download the skill folder or repository archive and extract `skills/benchmark-deep-research-agents-across-factual-quality-and-process-dimensions-with-miroeval` into your local skills collection.
