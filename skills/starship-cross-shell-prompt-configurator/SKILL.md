...
### Claude Code
```bash
npx skills add https://agentskillexchange.com/skills/starship-cross-shell-prompt-configurator/
```

### Cursor
```bash
npx skills add https://agentskillexchange.com/skills/starship-cross-shell-prompt-configurator/ --cursor
```

### Codex
```bash
npx skills add https://agentskillexchange.com/skills/starship-cross-shell-prompt-configurator/ --codex
```
