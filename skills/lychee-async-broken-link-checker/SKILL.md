...
- Install from the marketplace listing: https://agentskillexchange.com/skills/lychee-async-broken-link-checker/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/lychee-async-broken-link-checker
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/lychee-async-broken-link-checker`.
