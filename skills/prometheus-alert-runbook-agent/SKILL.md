...
- Install from the marketplace listing: https://agentskillexchange.com/skills/prometheus-alert-runbook-agent/
...
- Download the repository ZIP and extract `skills/prometheus-alert-runbook-agent`.
