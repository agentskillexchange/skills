...
- Install from the marketplace listing: https://agentskillexchange.com/skills/commitlint-conventional-commit-message-linter/
...
- Download the repository ZIP and extract `skills/commitlint-conventional-commit-message-linter`.
