...
- Install from the marketplace listing: https://agentskillexchange.com/skills/digitalocean-droplet-manager/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/digitalocean-droplet-manager
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/digitalocean-droplet-manager`.
