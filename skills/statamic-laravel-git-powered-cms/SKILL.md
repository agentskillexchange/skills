...
- Install from the marketplace listing: https://agentskillexchange.com/skills/statamic-laravel-git-powered-cms/
...
- Download the repository ZIP and extract `skills/statamic-laravel-git-powered-cms`.
