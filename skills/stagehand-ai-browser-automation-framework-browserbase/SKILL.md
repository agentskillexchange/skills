...
Download the skill folder or repository archive and extract `skills/stagehand-ai-browser-automation-framework-browserbase` into your local skills collection.
