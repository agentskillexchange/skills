...
- Install from the marketplace listing: https://agentskillexchange.com/skills/rest-api-changelog-tracker/
...
- Download the repository ZIP and extract `skills/rest-api-changelog-tracker`.
