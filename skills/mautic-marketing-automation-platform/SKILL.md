...
- Install from the marketplace listing: https://agentskillexchange.com/skills/mautic-marketing-automation-platform/
...
- Download the repository ZIP and extract `skills/mautic-marketing-automation-platform`.
