...
Download the skill folder or repository archive and extract `skills/block-unsafe-agent-actions-and-scan-newly-added-skills-with-agentguard` into your local skills collection.
