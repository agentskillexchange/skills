...
- Install from the marketplace listing: https://agentskillexchange.com/skills/docker-compose-stack-builder-sdk/
...
- Download the repository ZIP and extract `skills/docker-compose-stack-builder-sdk`.
