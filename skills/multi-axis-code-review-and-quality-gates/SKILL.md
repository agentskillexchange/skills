...
description: Run a structured pre-merge review across correctness, readability, architecture,
  security, and performance instead of relying on a shallow spot check.
verification: listed
