...
- Install from the marketplace listing: https://agentskillexchange.com/skills/kubernetes-pod-crash-analyzer-3/
...
- Download the repository ZIP and extract `skills/kubernetes-pod-crash-analyzer-3`.
