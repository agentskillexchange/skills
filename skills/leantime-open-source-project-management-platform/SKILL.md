...
Download the skill folder or repository archive and extract `skills/leantime-open-source-project-management-platform` into your local skills collection.
