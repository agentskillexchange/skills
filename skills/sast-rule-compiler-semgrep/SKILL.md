...
- Install from the marketplace listing: https://agentskillexchange.com/skills/sast-rule-compiler-semgrep/
...
- Download the repository ZIP and extract `skills/sast-rule-compiler-semgrep`.
