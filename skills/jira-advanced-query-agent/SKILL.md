...
- Install from the marketplace listing: https://agentskillexchange.com/skills/jira-advanced-query-agent/
...
- Download the repository ZIP and extract `skills/jira-advanced-query-agent`.
