...
description: "Jira Advanced Query Agent is built around Jira issue tracking platform.\
  ...
  \ a thin one-line wrapper, using stable interfaces like JQL, issues, workflows,\
  \ comments, transitions, custom fields, sprint APIs and preserving the operational\
  \ context that matters for real tasks. The […]"
