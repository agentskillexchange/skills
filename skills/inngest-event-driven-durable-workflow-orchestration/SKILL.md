...
- Install from the marketplace listing: https://agentskillexchange.com/skills/inngest-event-driven-durable-workflow-orchestration/
...
- Download the repository ZIP and extract `skills/inngest-event-driven-durable-workflow-orchestration`.
