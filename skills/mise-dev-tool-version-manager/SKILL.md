...
- Install from the marketplace listing: https://agentskillexchange.com/skills/mise-dev-tool-version-manager/
...
- Download the repository ZIP and extract `skills/mise-dev-tool-version-manager`.
