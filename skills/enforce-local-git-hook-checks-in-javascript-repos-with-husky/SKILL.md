...
description: Use Husky to wire pre-commit, pre-push, and commit-msg checks into a
  repo so agents and developers run the same local guardrails before changes leave
  the workstation.
verification: listed
