...
- Install from the marketplace listing: https://agentskillexchange.com/skills/aws-cloudwatch-alarm-diagnostic/
...
- Download the repository ZIP and extract `skills/aws-cloudwatch-alarm-diagnostic`.
