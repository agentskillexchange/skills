...
- Install from the marketplace listing: https://agentskillexchange.com/skills/pgcli-interactive-postgresql-client/
...
- Download the repository ZIP and extract `skills/pgcli-interactive-postgresql-client`.
