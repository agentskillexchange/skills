...
Download the skill folder or repository archive and extract `skills/run-only-the-relevant-linters-and-formatters-on-changed-files-with-precious` into your local skills collection.
