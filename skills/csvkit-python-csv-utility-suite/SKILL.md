...
- Install from the marketplace listing: https://agentskillexchange.com/skills/csvkit-python-csv-utility-suite/
...
- Download the repository ZIP and extract `skills/csvkit-python-csv-utility-suite`.
