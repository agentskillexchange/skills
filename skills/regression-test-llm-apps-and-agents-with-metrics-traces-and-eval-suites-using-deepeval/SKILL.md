---
title: Regression test LLM apps and agents with metrics, traces, and eval suites using
  DeepEval
description: Run repeatable eval suites against prompts, RAG pipelines, and agents
