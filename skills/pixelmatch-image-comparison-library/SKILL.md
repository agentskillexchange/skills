...
- Install from the marketplace listing: https://agentskillexchange.com/skills/pixelmatch-image-comparison-library/
...
- Download the repository ZIP and extract `skills/pixelmatch-image-comparison-library`.
