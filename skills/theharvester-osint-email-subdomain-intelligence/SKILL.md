...
```bash
npx skills add theharvester-osint-email-subdomain-intelligence
```

### Cursor
```bash
npx skills add theharvester-osint-email-subdomain-intelligence --cursor
```

### Codex
```bash
npx skills add theharvester-osint-email-subdomain-intelligence --codex
```
