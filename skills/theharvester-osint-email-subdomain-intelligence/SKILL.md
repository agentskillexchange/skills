...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/theharvester-osint-email-subdomain-intelligence
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/theharvester-osint-email-subdomain-intelligence` into your local skills collection.
