...
Download the skill folder or repository archive and extract `skills/stress-test-javascript-and-typescript-test-suites-with-mutation-testing-before-risky-changes-ship-with-strykerjs` into your local skills collection.
