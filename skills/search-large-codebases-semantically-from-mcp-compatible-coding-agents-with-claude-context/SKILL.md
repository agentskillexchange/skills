...
Download the skill folder or repository archive and extract `skills/search-large-codebases-semantically-from-mcp-compatible-coding-agents-with-claude-context` into your local skills collection.
