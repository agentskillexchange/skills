...
Download the skill folder or repository archive and extract `skills/triage-active-security-incidents-with-ai-augmented-workflows-in-valhuntir-cli` into your local skills collection.
