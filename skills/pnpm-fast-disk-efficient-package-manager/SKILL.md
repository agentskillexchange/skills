...
```bash
npx skills add agentskillexchange/skills --skill pnpm-fast-disk-efficient-package-manager
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill pnpm-fast-disk-efficient-package-manager -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill pnpm-fast-disk-efficient-package-manager -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill pnpm-fast-disk-efficient-package-manager -a codex
```
