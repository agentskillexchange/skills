...
- Install from the marketplace listing: https://agentskillexchange.com/skills/pnpm-fast-disk-efficient-package-manager/
...
- Download the repository ZIP and extract `skills/pnpm-fast-disk-efficient-package-manager`.
