...
- Install from the marketplace listing: https://agentskillexchange.com/skills/dotenvx-secure-env-variable-manager/
...
- Download the repository ZIP and extract `skills/dotenvx-secure-env-variable-manager`.
