...
- Install from the marketplace listing: https://agentskillexchange.com/skills/makefile-dependency-auditor/
...
- Download the repository ZIP and extract `skills/makefile-dependency-auditor`.
