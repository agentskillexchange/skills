...
Download the skill folder or repository archive and extract `skills/wpgraphql-graphql-api-plugin-for-headless-wordpress` into your local skills collection.
