...
### Any Agent
```bash
npx @anthropic/agent-skills add navidrome-self-hosted-music-streaming-subsonic-api
```

### Claude Code
```bash
npx @anthropic/agent-skills add navidrome-self-hosted-music-streaming-subsonic-api --agent claude-code
```

### Cursor
```bash
npx @anthropic/agent-skills add navidrome-self-hosted-music-streaming-subsonic-api --agent cursor
```

### Codex
```bash
npx @anthropic/agent-skills add navidrome-self-hosted-music-streaming-subsonic-api --agent codex
```
