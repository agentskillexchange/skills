...
Download the skill folder or repository archive and extract `skills/navidrome-self-hosted-music-streaming-subsonic-api` into your local skills collection.
