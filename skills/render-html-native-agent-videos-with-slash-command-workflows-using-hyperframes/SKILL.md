...
Download the skill folder or repository archive and extract `skills/render-html-native-agent-videos-with-slash-command-workflows-using-hyperframes` into your local skills collection.
