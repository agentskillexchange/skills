...
- Install from the marketplace listing: https://agentskillexchange.com/skills/usql-universal-sql-client/
...
- Download the repository ZIP and extract `skills/usql-universal-sql-client`.
