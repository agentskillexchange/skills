...
description: LlamaIndex MCP Server is built around LlamaIndex framework for LLM data
  ...
  retrievers, query engines, agents, embeddings, nodes and […]
...
Download the skill folder or repository archive and extract `skills/llamaindex-mcp-server` into your local skills collection.
