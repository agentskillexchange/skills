...
Download the skill folder or repository archive and extract `skills/decap-cms-git-based-content-management-system-for-static-sites` into your local skills collection.
