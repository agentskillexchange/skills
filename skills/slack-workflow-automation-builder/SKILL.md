...
- Install from the marketplace listing: https://agentskillexchange.com/skills/slack-workflow-automation-builder/
...
- Download the repository ZIP and extract `skills/slack-workflow-automation-builder`.
