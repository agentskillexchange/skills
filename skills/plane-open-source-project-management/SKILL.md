...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/plane-open-source-project-management
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/plane-open-source-project-management` into your local skills collection.
