...
- Install from the marketplace listing: https://agentskillexchange.com/skills/plane-open-source-project-management/
...
- Download the repository ZIP and extract `skills/plane-open-source-project-management`.
