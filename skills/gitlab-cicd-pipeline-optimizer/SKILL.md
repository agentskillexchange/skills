...
- Install from the marketplace listing: https://agentskillexchange.com/skills/gitlab-cicd-pipeline-optimizer/
...
- Download the repository ZIP and extract `skills/gitlab-cicd-pipeline-optimizer`.
