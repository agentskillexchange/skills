...
- Install from the marketplace listing: https://agentskillexchange.com/skills/outlook-mail-triage-assistant/
...
- Download the repository ZIP and extract `skills/outlook-mail-triage-assistant`.
