...
Download the skill folder or repository archive and extract `skills/scan-agent-workflows-for-tools-mcp-exposure-and-adversarial-risk-with-agentic-radar` into your local skills collection.
