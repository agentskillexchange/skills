...
- Install from the marketplace listing: https://agentskillexchange.com/skills/graphql-schema-introspector/
...
- Download the repository ZIP and extract `skills/graphql-schema-introspector`.
