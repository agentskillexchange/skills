...
- Install from the marketplace listing: https://agentskillexchange.com/skills/rest-api-response-schema-validator/
...
- Download the repository ZIP and extract `skills/rest-api-response-schema-validator`.
