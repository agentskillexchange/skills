...
- Install from the marketplace listing: https://agentskillexchange.com/skills/markdoc-markdown-authoring-framework-stripe/
...
- Download the repository ZIP and extract `skills/markdoc-markdown-authoring-framework-stripe`.
