...
- Install from the marketplace listing: https://agentskillexchange.com/skills/acf-custom-fields-rest-exposer/
...
- Download the repository ZIP and extract `skills/acf-custom-fields-rest-exposer`.
