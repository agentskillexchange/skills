...
- Install from the marketplace listing: https://agentskillexchange.com/skills/remotion-programmatic-video-creator/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/remotion-programmatic-video-creator
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/remotion-programmatic-video-creator`.
