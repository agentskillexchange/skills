...
### Any Agent (npx)
```bash
npx skills add remotion-programmatic-video-creator
```

### Claude Code
```bash
npx skills add remotion-programmatic-video-creator --claude
```

### Cursor
```bash
npx skills add remotion-programmatic-video-creator --cursor
```

### Codex
```bash
npx skills add remotion-programmatic-video-creator --codex
```
