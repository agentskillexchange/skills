...
Download the skill folder or repository archive and extract `skills/run-ai-coding-agents-in-isolated-containers-and-compare-their-behavior-side-by-side-with-vibepod-cli` into your local skills collection.
