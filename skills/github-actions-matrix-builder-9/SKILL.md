...
### OpenClaw
```bash
clawhub install github-actions-matrix-builder-9
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skill/github-actions-matrix-builder-9/) · [Browse All Skills](https://agentskillexchange.com/)
