...
Download the skill folder or repository archive and extract `skills/audit-cloud-accounts-for-security-misconfigurations-with-prowler` into your local skills collection.
