...
- Install from the marketplace listing: https://agentskillexchange.com/skills/elevenlabs-voice-cloning-agent/
...
- Download the repository ZIP and extract `skills/elevenlabs-voice-cloning-agent`.
