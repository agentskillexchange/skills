...
Download the skill folder or repository archive and extract `skills/add-persistent-project-memory-and-hook-driven-synthesis-with-claude-memory-kit` into your local skills collection.
