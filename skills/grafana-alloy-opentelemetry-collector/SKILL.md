...
### Any Agent (npx)
```bash
npx skills add "grafana-alloy-opentelemetry-collector"
```

### Claude Code
```bash
npx skills add "grafana-alloy-opentelemetry-collector" --claude
```

### Cursor
```bash
npx skills add "grafana-alloy-opentelemetry-collector" --cursor
```

### Codex
```bash
npx skills add "grafana-alloy-opentelemetry-collector" --codex
```
