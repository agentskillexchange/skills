...
- Install from the marketplace listing: https://agentskillexchange.com/skills/terraform-cloud-mcp-server/
...
- Download the repository ZIP and extract `skills/terraform-cloud-mcp-server`.
