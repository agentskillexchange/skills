...
```bash
npx skills add agentskillexchange/skills --skill handbrake-open-source-video-transcoder
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill handbrake-open-source-video-transcoder -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill handbrake-open-source-video-transcoder -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill handbrake-open-source-video-transcoder -a codex
```
