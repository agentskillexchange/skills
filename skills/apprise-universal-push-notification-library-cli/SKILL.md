...
### OpenClaw CLI
```bash
openclaw skills install apprise-universal-push-notification-library-cli
```

### Claude Desktop
Install via [Agent Skill Exchange](https://agentskillexchange.com/skills/apprise-universal-push-notification-library-cli/)

### Cursor / Windsurf
Add the skill rules from [Agent Skill Exchange](https://agentskillexchange.com/skills/apprise-universal-push-notification-library-cli/)

### ChatGPT
Import as a custom action from [Agent Skill Exchange](https://agentskillexchange.com/skills/apprise-universal-push-notification-library-cli/)

### Manual Installation
Download from the [Agent Skill Exchange](https://agentskillexchange.com/skills/apprise-universal-push-notification-library-cli/) and follow the setup instructions.
