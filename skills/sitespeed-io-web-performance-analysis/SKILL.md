...
### OpenClaw CLI
```bash
openclaw skills install sitespeed-io-web-performance-analysis
```
...
cp -r skills/skills/sitespeed-io-web-performance-analysis your-project/skills/
```

### Download
Download the SKILL.md file directly from [GitHub](https://github.com/agentskillexchange/skills/tree/main/skills/sitespeed-io-web-performance-analysis).
