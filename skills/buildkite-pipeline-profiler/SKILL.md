...
- Install from the marketplace listing: https://agentskillexchange.com/skills/buildkite-pipeline-profiler/
...
- Download the repository ZIP and extract `skills/buildkite-pipeline-profiler`.
