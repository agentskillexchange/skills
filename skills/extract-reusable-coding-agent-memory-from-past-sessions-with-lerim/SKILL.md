...
Download the skill folder or repository archive and extract `skills/extract-reusable-coding-agent-memory-from-past-sessions-with-lerim` into your local skills collection.
