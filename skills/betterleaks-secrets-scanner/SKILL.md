...
### Any Agent (npx)
```bash
npx skills add betterleaks-secrets-scanner
```

### Claude Code
```bash
npx skills add betterleaks-secrets-scanner --claude-code
```

### Cursor
```bash
npx skills add betterleaks-secrets-scanner --cursor
```

### Codex
```bash
npx skills add betterleaks-secrets-scanner --codex
```
