...
### Claude Code
```bash
npx @anthropic/agent-skills add audiobookshelf-self-hosted-audiobook-podcast-server-api --agent claude-code
```

### Cursor
```bash
npx @anthropic/agent-skills add audiobookshelf-self-hosted-audiobook-podcast-server-api --agent cursor
```

### Codex
```bash
npx @anthropic/agent-skills add audiobookshelf-self-hosted-audiobook-podcast-server-api --agent codex
```
