...
- Install from the marketplace listing: https://agentskillexchange.com/skills/jnv-interactive-json-navigator/
...
- Download the repository ZIP and extract `skills/jnv-interactive-json-navigator`.
