...
- Install from the marketplace listing: https://agentskillexchange.com/skills/marker-pdf-to-markdown-converter/
...
- Download the repository ZIP and extract `skills/marker-pdf-to-markdown-converter`.
