...
```bash
npx skills add textstat-python-readability-statistics-calculator
```

### Cursor
```bash
npx skills add textstat-python-readability-statistics-calculator --cursor
```

### Codex
```bash
npx skills add textstat-python-readability-statistics-calculator --codex
```
