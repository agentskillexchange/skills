...
- Install from the marketplace listing: https://agentskillexchange.com/skills/capture-responsive-website-screenshots-pageres/
...
- Download the repository ZIP and extract `skills/capture-responsive-website-screenshots-pageres`.
