...
Agent-in-agent orchestration where one model delegates coding to another Cursor, Windsurf, or custom pipeline users who want Claude Code as a sub-agent Complex multi-step file operations that benefit from Claude Code capabilities
