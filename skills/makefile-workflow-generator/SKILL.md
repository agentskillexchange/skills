...
- Install from the marketplace listing: https://agentskillexchange.com/skills/makefile-workflow-generator/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/makefile-workflow-generator
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/makefile-workflow-generator`.
