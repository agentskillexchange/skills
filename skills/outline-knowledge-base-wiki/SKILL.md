...
- Install from the marketplace listing: https://agentskillexchange.com/skills/outline-knowledge-base-wiki/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/outline-knowledge-base-wiki
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/outline-knowledge-base-wiki`.
