...
```bash
npx skills add agentskillexchange/skills --skill outline-knowledge-base-wiki
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill outline-knowledge-base-wiki -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill outline-knowledge-base-wiki -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill outline-knowledge-base-wiki -a codex
```
