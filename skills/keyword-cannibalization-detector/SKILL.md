...
- Install from the marketplace listing: https://agentskillexchange.com/skills/keyword-cannibalization-detector/
...
- Download the repository ZIP and extract `skills/keyword-cannibalization-detector`.
