...
```bash
npx skills add agentskillexchange/skills --skill docker-selenium-grid-for-scalable-browser-automation
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill docker-selenium-grid-for-scalable-browser-automation -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill docker-selenium-grid-for-scalable-browser-automation -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill docker-selenium-grid-for-scalable-browser-automation -a codex
```
