...
- Install from the marketplace listing: https://agentskillexchange.com/skills/fx-terminal-json-viewer-processor/
...
- Download the repository ZIP and extract `skills/fx-terminal-json-viewer-processor`.
