...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/fx-terminal-json-viewer-processor
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/fx-terminal-json-viewer-processor` into your local skills collection.
