...
### Claude Code
```bash
npx skills add fx-terminal-json-viewer-processor --claude-code
```

### Cursor
```bash
npx skills add fx-terminal-json-viewer-processor --cursor
```

### Codex
```bash
npx skills add fx-terminal-json-viewer-processor --codex
```
