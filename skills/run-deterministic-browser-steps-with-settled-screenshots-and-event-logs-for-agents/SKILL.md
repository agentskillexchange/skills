...
Download the skill folder or repository archive and extract `skills/run-deterministic-browser-steps-with-settled-screenshots-and-event-logs-for-agents` into your local skills collection.
