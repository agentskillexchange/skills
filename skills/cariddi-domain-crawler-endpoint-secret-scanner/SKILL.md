...
description: "Cariddi is a Go-based security tool that takes a list of domains, crawls their URLs, and scans for endpoints, secrets, API keys, file extensions, tokens, and errors. It supports configurable concurren"
...
**OpenClaw Chat:**
> Install the skill cariddi-domain-crawler-endpoint-secret-scanner

**Manual Installation:**
Download from [Agent Skill Exchange](https://agentskillexchange.com/skills/cariddi-domain-crawler-endpoint-secret-scanner/)

## Source

- [Agent Skill Exchange](https://agentskillexchange.com/skills/cariddi-domain-crawler-endpoint-secret-scanner/)
- [Upstream Project](https://github.com/edoardottt/cariddi)
