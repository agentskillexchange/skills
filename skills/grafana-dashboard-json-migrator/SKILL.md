...
- Install from the marketplace listing: https://agentskillexchange.com/skills/grafana-dashboard-json-migrator/
...
- Download the repository ZIP and extract `skills/grafana-dashboard-json-migrator`.
