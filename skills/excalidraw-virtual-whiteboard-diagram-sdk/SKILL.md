...
### Option 2: OpenClaw Chat
```
/install excalidraw-virtual-whiteboard-diagram-sdk
```
...
cp -r skills/skills/excalidraw-virtual-whiteboard-diagram-sdk /your/agent/skills/
```

### Option 5: Direct Download
```bash
curl -O https://raw.githubusercontent.com/agentskillexchange/skills/main/skills/excalidraw-virtual-whiteboard-diagram-sdk/SKILL.md
```
