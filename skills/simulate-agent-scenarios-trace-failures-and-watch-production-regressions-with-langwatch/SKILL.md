...
Download the skill folder or repository archive and extract `skills/simulate-agent-scenarios-trace-failures-and-watch-production-regressions-with-langwatch` into your local skills collection.
