...
- Install from the marketplace listing: https://agentskillexchange.com/skills/codecov-coverage-report-analyzer/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/codecov-coverage-report-analyzer
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/codecov-coverage-report-analyzer`.
