...
- Install from the marketplace listing: https://agentskillexchange.com/skills/gron-greppable-json-flattener/
...
- Download the repository ZIP and extract `skills/gron-greppable-json-flattener`.
