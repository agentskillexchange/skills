...
### Claude Code
```bash
npx skills add gron-greppable-json-flattener --claude-code
```

### Cursor
```bash
npx skills add gron-greppable-json-flattener --cursor
```

### Codex
```bash
npx skills add gron-greppable-json-flattener --codex
```
