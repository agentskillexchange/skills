...
- Install from the marketplace listing: https://agentskillexchange.com/skills/firecrawl-web-data-api-for-ai-agents/
...
- Download the repository ZIP and extract `skills/firecrawl-web-data-api-for-ai-agents`.
