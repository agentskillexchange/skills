...
- Install from the marketplace listing: https://agentskillexchange.com/skills/openai-agents-sdk-python-multi-agent/
...
- Download the repository ZIP and extract `skills/openai-agents-sdk-python-multi-agent`.
