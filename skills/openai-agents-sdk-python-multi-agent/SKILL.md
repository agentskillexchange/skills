...
cp -r /tmp/ase-skills/skills/openai-agents-sdk-python-multi-agent ./
```

### Manual Download
Download `SKILL.md` from the [GitHub repository](https://github.com/agentskillexchange/skills/tree/main/skills/openai-agents-sdk-python-multi-agent) and place it in `~/.openclaw/workspace/skills/openai-agents-sdk-python-multi-agent/`.

### OpenClaw Marketplace
Browse and install from [Agent Skill Exchange](https://agentskillexchange.com/skills/openai-agents-sdk-python-multi-agent/).

### Direct curl
```bash
mkdir -p ~/.openclaw/workspace/skills/openai-agents-sdk-python-multi-agent
curl -sL https://raw.githubusercontent.com/agentskillexchange/skills/main/skills/openai-agents-sdk-python-multi-agent/SKILL.md > ~/.openclaw/workspace/skills/openai-agents-sdk-python-multi-agent/SKILL.md
```
