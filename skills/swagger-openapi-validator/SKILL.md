...
description: Swagger / OpenAPI Validator is built around Swagger/OpenAPI tooling.
  ...
  client generation, Swagger UI, examples, refs and preserving the […]
...
- Install from the marketplace listing: https://agentskillexchange.com/skills/swagger-openapi-validator/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/swagger-openapi-validator
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/swagger-openapi-validator`.
