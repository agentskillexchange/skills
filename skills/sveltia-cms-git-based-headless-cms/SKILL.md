...
```bash
# OpenClaw CLI
openclaw skills install sveltia-cms-git-based-headless-cms
```

```bash
# npx one-liner
npx @anthropic/skills add agentskillexchange/skills --skill sveltia-cms-git-based-headless-cms
```

```bash
# Git clone
git clone https://github.com/agentskillexchange/skills.git
cp -r skills/skills/sveltia-cms-git-based-headless-cms ~/.openclaw/workspace/skills/
```

```bash
# Manual download
curl -L https://raw.githubusercontent.com/agentskillexchange/skills/main/skills/sveltia-cms-git-based-headless-cms/SKILL.md -o SKILL.md
```
