...
- Install from the marketplace listing: https://agentskillexchange.com/skills/terraform-module-registry-browser/
...
- Download the repository ZIP and extract `skills/terraform-module-registry-browser`.
