...
### OpenClaw CLI
```bash
openclaw skills install serpbear-self-hosted-serp-rank-tracker
```
...
cp -r skills/skills/serpbear-self-hosted-serp-rank-tracker your-project/skills/
```

### Download
Download the SKILL.md file directly from [GitHub](https://github.com/agentskillexchange/skills/tree/main/skills/serpbear-self-hosted-serp-rank-tracker).
