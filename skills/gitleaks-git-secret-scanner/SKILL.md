...
description: "Gitleaks is an open-source SAST tool for detecting hardcoded secrets like passwords, API keys, and tokens in Git repositories, files, and directories. It is the most widely adopted open-source secret scanner."
github_stars: 25731
