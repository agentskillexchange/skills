...
Download the skill folder or repository archive and extract `skills/reproduce-sql-injection-paths-and-map-database-takeover-options-with-sqlmap` into your local skills collection.
