...
- Install from the marketplace listing: https://agentskillexchange.com/skills/ahrefs-backlink-content-planner/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/ahrefs-backlink-content-planner
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/ahrefs-backlink-content-planner`.
