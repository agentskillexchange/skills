...
Download the skill folder or repository archive and extract `skills/fuzz-web-paths-parameters-and-virtual-hosts-with-ffuf-to-surface-hidden-attack-surface` into your local skills collection.
