...
Download the skill folder or repository archive and extract `skills/turn-product-requirements-into-executable-claude-code-plans-and-validation-loops-with-prps-agentic-eng` into your local skills collection.
