...
### Any Agent (npx)
```bash
npx @anthropic/agent-skills add cal-com-open-source-scheduling-infrastructure-api
```

### Claude Code
```bash
npx @anthropic/agent-skills add cal-com-open-source-scheduling-infrastructure-api --agent claude-code
```

### Cursor
```bash
npx @anthropic/agent-skills add cal-com-open-source-scheduling-infrastructure-api --agent cursor
```

### Codex
```bash
npx @anthropic/agent-skills add cal-com-open-source-scheduling-infrastructure-api --agent codex
```
