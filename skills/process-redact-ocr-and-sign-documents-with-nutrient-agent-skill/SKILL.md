...
Download the skill folder or repository archive and extract `skills/process-redact-ocr-and-sign-documents-with-nutrient-agent-skill` into your local skills collection.
