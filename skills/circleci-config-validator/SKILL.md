...
- Install from the marketplace listing: https://agentskillexchange.com/skills/circleci-config-validator/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/circleci-config-validator
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/circleci-config-validator`.
