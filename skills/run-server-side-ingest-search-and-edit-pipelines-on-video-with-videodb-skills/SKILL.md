...
Download the skill folder or repository archive and extract `skills/run-server-side-ingest-search-and-edit-pipelines-on-video-with-videodb-skills` into your local skills collection.
