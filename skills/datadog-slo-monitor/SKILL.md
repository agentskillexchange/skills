...
- Install from the marketplace listing: https://agentskillexchange.com/skills/datadog-slo-monitor/
...
- Download the repository ZIP and extract `skills/datadog-slo-monitor`.
