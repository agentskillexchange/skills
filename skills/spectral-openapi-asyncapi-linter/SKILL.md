...
- Install from the marketplace listing: https://agentskillexchange.com/skills/spectral-openapi-asyncapi-linter/
...
- Download the repository ZIP and extract `skills/spectral-openapi-asyncapi-linter`.
