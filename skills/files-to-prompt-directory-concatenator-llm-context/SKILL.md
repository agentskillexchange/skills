...
- Install from the marketplace listing: https://agentskillexchange.com/skills/files-to-prompt-directory-concatenator-llm-context/
...
- Download the repository ZIP and extract `skills/files-to-prompt-directory-concatenator-llm-context`.
