...
### Any Agent (npx)
```bash
npx skills add typos-source-code-spell-checker
```

### Claude Code
```bash
npx skills add typos-source-code-spell-checker --claude-code
```

### Cursor
```bash
npx skills add typos-source-code-spell-checker --cursor
```

### Codex
```bash
npx skills add typos-source-code-spell-checker --codex
```
