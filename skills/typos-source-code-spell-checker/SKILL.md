...
- Install from the marketplace listing: https://agentskillexchange.com/skills/typos-source-code-spell-checker/
...
- Download the repository ZIP and extract `skills/typos-source-code-spell-checker`.
