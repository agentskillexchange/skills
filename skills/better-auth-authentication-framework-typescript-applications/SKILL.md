...
Download the skill folder or repository archive and extract `skills/better-auth-authentication-framework-typescript-applications` into your local skills collection.
