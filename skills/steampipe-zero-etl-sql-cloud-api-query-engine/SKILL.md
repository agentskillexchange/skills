...
- Install from the marketplace listing: https://agentskillexchange.com/skills/steampipe-zero-etl-sql-cloud-api-query-engine/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/steampipe-zero-etl-sql-cloud-api-query-engine
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/steampipe-zero-etl-sql-cloud-api-query-engine`.
