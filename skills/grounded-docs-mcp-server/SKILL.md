...
- Install from the marketplace listing: https://agentskillexchange.com/skills/grounded-docs-mcp-server/
...
- Download the repository ZIP and extract `skills/grounded-docs-mcp-server`.
