...
# OpenClaw CLI
openclaw skill install dagger-programmable-cicd-automation-engine

# Git clone
git clone https://github.com/agentskillexchange/skills.git
cp -r skills/skills/dagger-programmable-cicd-automation-engine ~/.openclaw/workspace/skills/

# Manual download
# Download from https://agentskillexchange.com/skills/dagger-programmable-cicd-automation-engine/
```
