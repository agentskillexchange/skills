...
- Install from the marketplace listing: https://agentskillexchange.com/skills/tolgee-localization-i18n-platform/
...
- Download the repository ZIP and extract `skills/tolgee-localization-i18n-platform`.
