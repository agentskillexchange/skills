...
- Install from the marketplace listing: https://agentskillexchange.com/skills/desktop-commander-mcp-terminal-file-control/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/desktop-commander-mcp-terminal-file-control
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/desktop-commander-mcp-terminal-file-control`.
