...
tool_ecosystem:  # ONLY if real signals exist in meta
  ...
  github_stars: 43434  # from ase_github_stars (integer, not string)
...
Adds monitoring and debugging patterns that help teams understand, trace, and improve AI-assisted software behavior.
