...
- Install from the marketplace listing: https://agentskillexchange.com/skills/cypress-component-testing-suite/
...
- Download the repository ZIP and extract `skills/cypress-component-testing-suite`.
