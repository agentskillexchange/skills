...
- Install from the marketplace listing: https://agentskillexchange.com/skills/langgraph-js-agent-orchestration-framework/
...
- Download the repository ZIP and extract `skills/langgraph-js-agent-orchestration-framework`.
