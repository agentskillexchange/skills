...
```bash
# OpenClaw CLI
openclaw skills install vikunja-self-hosted-task-management
```

```bash
# npx one-liner
npx @anthropic/skills add agentskillexchange/skills --skill vikunja-self-hosted-task-management
```

```bash
# Git clone
git clone https://github.com/agentskillexchange/skills.git
cp -r skills/skills/vikunja-self-hosted-task-management ~/.openclaw/workspace/skills/
```

```bash
# Manual download
curl -L https://raw.githubusercontent.com/agentskillexchange/skills/main/skills/vikunja-self-hosted-task-management/SKILL.md -o SKILL.md
```
