...
- Install from the marketplace listing: https://agentskillexchange.com/skills/gitbutler-virtual-branch-git-client/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/gitbutler-virtual-branch-git-client
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/gitbutler-virtual-branch-git-client`.
