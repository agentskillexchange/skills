...
```bash
npx skills add gitbutler-virtual-branch-git-client
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skills/gitbutler-virtual-branch-git-client/)
