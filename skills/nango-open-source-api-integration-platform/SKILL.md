...
- Install from the marketplace listing: https://agentskillexchange.com/skills/nango-open-source-api-integration-platform/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/nango-open-source-api-integration-platform
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/nango-open-source-api-integration-platform`.
