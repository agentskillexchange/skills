...
### Any Agent
```bash
npx skills add schema-dts-typescript-types-schemaorg-structured-data
```

### Claude Code
```bash
npx skills add schema-dts-typescript-types-schemaorg-structured-data --claude
```

### Cursor
```bash
npx skills add schema-dts-typescript-types-schemaorg-structured-data --cursor
```

### Codex
```bash
npx skills add schema-dts-typescript-types-schemaorg-structured-data --codex
```
