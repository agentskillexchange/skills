...
Download the skill folder or repository archive and extract `skills/tune-supabase-postgres-queries-indexing-and-rls-with-supabase-postgres-best-practices` into your local skills collection.
