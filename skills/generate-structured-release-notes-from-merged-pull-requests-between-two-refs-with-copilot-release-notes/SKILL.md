...
Download the skill folder or repository archive and extract `skills/generate-structured-release-notes-from-merged-pull-requests-between-two-refs-with-copilot-release-notes` into your local skills collection.
