...
source: "https://agentskillexchange.com/skills/httpie-cli-api-testing-debugging-client/"
---
...
```bash
npx skills add httpie-cli-api-testing-debugging-client
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skills/httpie-cli-api-testing-debugging-client/)
