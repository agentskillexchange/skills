...
- Install from the marketplace listing: https://agentskillexchange.com/skills/playwright-parallel-tab-manager/
...
- Download the repository ZIP and extract `skills/playwright-parallel-tab-manager`.
