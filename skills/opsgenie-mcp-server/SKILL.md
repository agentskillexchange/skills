...
description: OpsGenie MCP Server is built around Opsgenie incident and on-call platform.
  ...
  escalation policies, notes, integrations and preserving the […]
...
Download the skill folder or repository archive and extract `skills/opsgenie-mcp-server` into your local skills collection.
