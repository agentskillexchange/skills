...
- Install from the marketplace listing: https://agentskillexchange.com/skills/blurhash-compact-image-placeholder-encoder/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/blurhash-compact-image-placeholder-encoder
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/blurhash-compact-image-placeholder-encoder`.
