...
### Claude Code
```bash
npx skills add --claude blurhash-compact-image-placeholder-encoder
```

### Cursor
```bash
npx skills add --cursor blurhash-compact-image-placeholder-encoder
```

### Codex
```bash
npx skills add --codex blurhash-compact-image-placeholder-encoder
```
