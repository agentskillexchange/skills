...
```bash
npx skills add agentskillexchange/skills --skill posting-terminal-api-client
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill posting-terminal-api-client -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill posting-terminal-api-client -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill posting-terminal-api-client -a codex
```
