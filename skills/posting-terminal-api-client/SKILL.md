...
- Install from the marketplace listing: https://agentskillexchange.com/skills/posting-terminal-api-client/
...
- Download the repository ZIP and extract `skills/posting-terminal-api-client`.
