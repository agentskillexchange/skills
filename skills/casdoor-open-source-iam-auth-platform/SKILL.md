...
- Install from the marketplace listing: https://agentskillexchange.com/skills/casdoor-open-source-iam-auth-platform/
...
- Download the repository ZIP and extract `skills/casdoor-open-source-iam-auth-platform`.
