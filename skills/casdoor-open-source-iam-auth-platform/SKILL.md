...
Authentication protocols: OAuth 2.1, OpenID Connect (OIDC), SAML 2.0, CAS 3.0, LDAP, SCIM MFA methods: TOTP, SMS, Email, WebAuthn/FIDO2, Face ID Identity providers: Google Workspace, Azure AD, GitHub, GitLab, Facebook, and 100+ third-party OAuth providers AI gateway: MCP (Model Context Protocol) and A2A (Agent-to-Agent) gateway support for AI agent authentication User management: Registration, login, profile management, role-based access control, organization multi-tenancy
