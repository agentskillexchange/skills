...
```bash
npx skills add agentskillexchange/skills --skill devbox-nix-development-environment-jetify
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill devbox-nix-development-environment-jetify -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill devbox-nix-development-environment-jetify -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill devbox-nix-development-environment-jetify -a codex
```
