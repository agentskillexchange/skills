...
```bash
npx skills add agentskillexchange/skills --skill gitoxide-pure-rust-git-implementation
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill gitoxide-pure-rust-git-implementation -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill gitoxide-pure-rust-git-implementation -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill gitoxide-pure-rust-git-implementation -a codex
```
