...
- Install from the marketplace listing: https://agentskillexchange.com/skills/langchain-mcp-server/
...
- Download the repository ZIP and extract `skills/langchain-mcp-server`.
