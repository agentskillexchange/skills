...
Download the skill folder or repository archive and extract `skills/generate-release-prs-and-changelog-updates-from-conventional-commits` into your local skills collection.
