...
- Install from the marketplace listing: https://agentskillexchange.com/skills/swc-speedy-web-compiler-javascript-typescript/
...
- Download the repository ZIP and extract `skills/swc-speedy-web-compiler-javascript-typescript`.
