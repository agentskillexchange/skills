...
- Install from the marketplace listing: https://agentskillexchange.com/skills/rspack-rust-based-javascript-bundler/
...
- Download the repository ZIP and extract `skills/rspack-rust-based-javascript-bundler`.
