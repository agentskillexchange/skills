...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/rspack-rust-based-javascript-bundler
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/rspack-rust-based-javascript-bundler` into your local skills collection.
