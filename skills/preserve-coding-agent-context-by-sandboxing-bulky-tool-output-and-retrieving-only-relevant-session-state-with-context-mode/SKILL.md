...
Download the skill folder or repository archive and extract `skills/preserve-coding-agent-context-by-sandboxing-bulky-tool-output-and-retrieving-only-relevant-session-state-with-context-mode` into your local skills collection.
