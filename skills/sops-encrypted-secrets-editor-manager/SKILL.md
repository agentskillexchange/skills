...
```
/install sops-encrypted-secrets-editor-manager
```
...
cp -r skills/skills/sops-encrypted-secrets-editor-manager /your/agent/skills/
```

### Option 5: Direct Download
```bash
curl -O https://raw.githubusercontent.com/agentskillexchange/skills/main/skills/sops-encrypted-secrets-editor-manager/SKILL.md
```
