...
# OpenClaw CLI
openclaw skills install plausible-analytics-privacy-first-web-analytics

# Manual (git clone)
git clone https://github.com/agentskillexchange/skills.git
cp -r skills/skills/plausible-analytics-privacy-first-web-analytics ~/.openclaw/workspace/skills/
```
