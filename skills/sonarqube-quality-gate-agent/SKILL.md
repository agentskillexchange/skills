...
- Install from the marketplace listing: https://agentskillexchange.com/skills/sonarqube-quality-gate-agent/
...
- Download the repository ZIP and extract `skills/sonarqube-quality-gate-agent`.
