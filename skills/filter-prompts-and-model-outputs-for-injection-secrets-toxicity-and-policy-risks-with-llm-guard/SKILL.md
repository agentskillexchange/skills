---
name: Filter prompts and model outputs for injection, secrets, toxicity, and policy
...
Download the skill folder or repository archive and extract `skills/filter-prompts-and-model-outputs-for-injection-secrets-toxicity-and-policy-risks-with-llm-guard` into your local skills collection.
