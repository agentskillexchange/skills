...
- Install from the marketplace listing: https://agentskillexchange.com/skills/prometheus-alertmanager-bridge-2/
...
- Download the repository ZIP and extract `skills/prometheus-alertmanager-bridge-2`.
