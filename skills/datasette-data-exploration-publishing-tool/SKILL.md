...
### Claude Code
```bash
npx skills add datasette-data-exploration-publishing-tool --claude-code
```

### Cursor
```bash
npx skills add datasette-data-exploration-publishing-tool --cursor
```

### Codex
```bash
npx skills add datasette-data-exploration-publishing-tool --codex
```
