...
- Install from the marketplace listing: https://agentskillexchange.com/skills/stagehand-browser-automation/
...
- Download the repository ZIP and extract `skills/stagehand-browser-automation`.
