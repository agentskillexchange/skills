...
- Install from the marketplace listing: https://agentskillexchange.com/skills/resvg-svg-rendering-library-rust/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/resvg-svg-rendering-library-rust
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/resvg-svg-rendering-library-rust`.
