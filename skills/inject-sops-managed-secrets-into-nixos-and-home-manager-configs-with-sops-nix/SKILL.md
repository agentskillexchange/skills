...
Download the skill folder or repository archive and extract `skills/inject-sops-managed-secrets-into-nixos-and-home-manager-configs-with-sops-nix` into your local skills collection.
