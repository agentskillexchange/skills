...
- Install from the marketplace listing: https://agentskillexchange.com/skills/pedalboard-spotify-audio-effects-python/
...
- Download the repository ZIP and extract `skills/pedalboard-spotify-audio-effects-python`.
