...
- Install from the marketplace listing: https://agentskillexchange.com/skills/eslint-autofix-orchestrator/
...
- Download the repository ZIP and extract `skills/eslint-autofix-orchestrator`.
