...
Download the skill folder or repository archive and extract `skills/operate-airflow-and-warehouse-workflows-through-agent-safe-data-engineering-skills-with-astronomer-agents` into your local skills collection.
