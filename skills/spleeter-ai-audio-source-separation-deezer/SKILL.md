...
```bash
npx skills add spleeter-ai-audio-source-separation-deezer
```

### Cursor

```bash
npx skills add --cursor spleeter-ai-audio-source-separation-deezer
```

### Codex

```bash
npx skills add --codex spleeter-ai-audio-source-separation-deezer
```
