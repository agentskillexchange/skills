...
- Install from the marketplace listing: https://agentskillexchange.com/skills/browserable-self-hostable-browser-automation-ai-agents/
...
- Download the repository ZIP and extract `skills/browserable-self-hostable-browser-automation-ai-agents`.
