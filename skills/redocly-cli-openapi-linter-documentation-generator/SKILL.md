...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/redocly-cli-openapi-linter-documentation-generator
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/redocly-cli-openapi-linter-documentation-generator` into your local skills collection.
