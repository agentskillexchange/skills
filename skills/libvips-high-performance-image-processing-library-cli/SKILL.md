...
- Install from the marketplace listing: https://agentskillexchange.com/skills/libvips-high-performance-image-processing-library-cli/
...
- Download the repository ZIP and extract `skills/libvips-high-performance-image-processing-library-cli`.
