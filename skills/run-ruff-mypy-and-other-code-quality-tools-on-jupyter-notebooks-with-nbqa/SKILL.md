...
Download the skill folder or repository archive and extract `skills/run-ruff-mypy-and-other-code-quality-tools-on-jupyter-notebooks-with-nbqa` into your local skills collection.
