...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/pixi-cross-platform-package-manager-conda-rust
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/pixi-cross-platform-package-manager-conda-rust` into your local skills collection.
