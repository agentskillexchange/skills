...
- Install from the marketplace listing: https://agentskillexchange.com/skills/pixi-cross-platform-package-manager-conda-rust/
...
- Download the repository ZIP and extract `skills/pixi-cross-platform-package-manager-conda-rust`.
