...
Download the skill folder or repository archive and extract `skills/debug-dns-resolution-and-record-mismatches-from-the-terminal-with-doggo` into your local skills collection.
