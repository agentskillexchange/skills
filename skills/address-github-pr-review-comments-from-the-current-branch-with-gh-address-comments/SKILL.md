...
Download the skill folder or repository archive and extract `skills/address-github-pr-review-comments-from-the-current-branch-with-gh-address-comments` into your local skills collection.
