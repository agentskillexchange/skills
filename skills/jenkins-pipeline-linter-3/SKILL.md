...
### OpenClaw
```bash
clawhub install jenkins-pipeline-linter-3
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skills/jenkins-pipeline-linter-3/) · [Browse All Skills](https://agentskillexchange.com/)
