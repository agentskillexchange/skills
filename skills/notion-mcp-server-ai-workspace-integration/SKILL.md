...
- Install from the marketplace listing: https://agentskillexchange.com/skills/notion-mcp-server-ai-workspace-integration/
...
- Download the repository ZIP and extract `skills/notion-mcp-server-ai-workspace-integration`.
