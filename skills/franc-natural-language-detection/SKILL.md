...
- Install from the marketplace listing: https://agentskillexchange.com/skills/franc-natural-language-detection/
...
- Download the repository ZIP and extract `skills/franc-natural-language-detection`.
