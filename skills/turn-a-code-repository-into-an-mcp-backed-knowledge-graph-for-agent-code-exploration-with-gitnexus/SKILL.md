...
Download the skill folder or repository archive and extract `skills/turn-a-code-repository-into-an-mcp-backed-knowledge-graph-for-agent-code-exploration-with-gitnexus` into your local skills collection.
