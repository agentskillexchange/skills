...
- Install from the marketplace listing: https://agentskillexchange.com/skills/plaid-financial-data-connector/
...
- Download the repository ZIP and extract `skills/plaid-financial-data-connector`.
