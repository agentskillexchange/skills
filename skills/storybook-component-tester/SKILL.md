...
description: "Storybook Component Tester is built around Storybook component workshop.\
  ...
  \ than a thin one-line wrapper, using stable interfaces like stories, controls,\
  \ test runner, interaction tests, snapshots, addons and preserving the operational\
  \ […]"
