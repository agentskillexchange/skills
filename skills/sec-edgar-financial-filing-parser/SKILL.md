...
- Install from the marketplace listing: https://agentskillexchange.com/skills/sec-edgar-financial-filing-parser/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/sec-edgar-financial-filing-parser
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/sec-edgar-financial-filing-parser`.
