...
Download the skill folder or repository archive and extract `skills/run-one-formatter-plan-across-a-mixed-language-repo-and-keep-generated-edits-predictable-with-treefmt` into your local skills collection.
