...
Download the skill folder or repository archive and extract `skills/generate-domain-specific-claude-code-agent-teams-and-shared-skills-with-harness` into your local skills collection.
