...
```bash
npx skills add agentskillexchange/skills --skill strapi-open-source-headless-cms-custom-content-apis
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill strapi-open-source-headless-cms-custom-content-apis -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill strapi-open-source-headless-cms-custom-content-apis -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill strapi-open-source-headless-cms-custom-content-apis -a codex
```
