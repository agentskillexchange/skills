...
- Install from the marketplace listing: https://agentskillexchange.com/skills/aws-codepipeline-orchestrator/
...
- Download the repository ZIP and extract `skills/aws-codepipeline-orchestrator`.
