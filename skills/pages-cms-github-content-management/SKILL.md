...
```bash
# OpenClaw CLI
openclaw skills install pages-cms-github-content-management
```

```bash
# npx one-liner
npx @anthropic/skills add agentskillexchange/skills --skill pages-cms-github-content-management
```

```bash
# Git clone
git clone https://github.com/agentskillexchange/skills.git
cp -r skills/skills/pages-cms-github-content-management ~/.openclaw/workspace/skills/
```

```bash
# Manual download
curl -L https://raw.githubusercontent.com/agentskillexchange/skills/main/skills/pages-cms-github-content-management/SKILL.md -o SKILL.md
```
