...
- Install from the marketplace listing: https://agentskillexchange.com/skills/aws-mcp-servers-cloud-service-integration/
...
- Download the repository ZIP and extract `skills/aws-mcp-servers-cloud-service-integration`.
