...
- Install from the marketplace listing: https://agentskillexchange.com/skills/snyk-license-compliance-checker/
...
- Download the repository ZIP and extract `skills/snyk-license-compliance-checker`.
