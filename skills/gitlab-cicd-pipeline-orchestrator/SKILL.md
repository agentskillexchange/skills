...
- Install from the marketplace listing: https://agentskillexchange.com/skills/gitlab-cicd-pipeline-orchestrator/
...
- Download the repository ZIP and extract `skills/gitlab-cicd-pipeline-orchestrator`.
