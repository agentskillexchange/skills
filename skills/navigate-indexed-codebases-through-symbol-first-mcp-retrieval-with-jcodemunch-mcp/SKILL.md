---
title: Navigate indexed codebases through symbol-first MCP retrieval with jCodeMunch
  MCP
description: Use jCodeMunch MCP when an agent needs precise symbol lookups, outlines,
  call-graph context, and targeted source retrieval instead of brute-reading whole
