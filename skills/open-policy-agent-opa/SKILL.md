...
description: Open Policy Agent (OPA) is built around Kubernetes orchestration platform.
  ...
  pods, deployments, events, logs, probes, RBAC and preserving […]
...
Download the skill folder or repository archive and extract `skills/open-policy-agent-opa` into your local skills collection.
