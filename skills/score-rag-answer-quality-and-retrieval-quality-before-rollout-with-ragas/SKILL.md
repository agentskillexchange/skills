...
- Install from the marketplace listing: https://agentskillexchange.com/skills/score-rag-answer-quality-and-retrieval-quality-before-rollout-with-ragas/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/score-rag-answer-quality-and-retrieval-quality-before-rollout-with-ragas
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/score-rag-answer-quality-and-retrieval-quality-before-rollout-with-ragas`.
