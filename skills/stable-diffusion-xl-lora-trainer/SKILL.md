...
- Install from the marketplace listing: https://agentskillexchange.com/skills/stable-diffusion-xl-lora-trainer/
...
- Download the repository ZIP and extract `skills/stable-diffusion-xl-lora-trainer`.
