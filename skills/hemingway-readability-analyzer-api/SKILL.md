...
- Install from the marketplace listing: https://agentskillexchange.com/skills/hemingway-readability-analyzer-api/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/hemingway-readability-analyzer-api
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/hemingway-readability-analyzer-api`.
