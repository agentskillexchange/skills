...
Download the skill folder or repository archive and extract `skills/chartbrew-open-source-reporting-dashboard-platform` into your local skills collection.
