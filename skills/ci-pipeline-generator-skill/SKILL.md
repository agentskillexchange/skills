...
description: CI Pipeline Generator Skill is built around GitLab DevSecOps platform.
  ...
  merge requests, runners, registry, CI YAML and […]
...
Download the skill folder or repository archive and extract `skills/ci-pipeline-generator-skill` into your local skills collection.
