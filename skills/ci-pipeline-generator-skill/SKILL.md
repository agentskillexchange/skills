...
description: CI Pipeline Generator Skill is built around GitLab DevSecOps platform.
  The underlying ecosystem is represented by gitlabhq/gitlabhq (24,276+ GitHub stars).
  ...
  issue automation, and code hosting workflows. For generator-style use cases, the
  ...
  include CI/CD orchestration, issue automation, and code hosting workflows. In a
