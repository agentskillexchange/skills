...
- Install from the marketplace listing: https://agentskillexchange.com/skills/navi-interactive-cli-cheatsheet-tool/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/navi-interactive-cli-cheatsheet-tool
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/navi-interactive-cli-cheatsheet-tool`.
