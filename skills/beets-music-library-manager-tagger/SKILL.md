...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/beets-music-library-manager-tagger
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/beets-music-library-manager-tagger` into your local skills collection.
