...
- Install from the marketplace listing: https://agentskillexchange.com/skills/dioxus-rust-fullstack-cross-platform-framework/
...
- Download the repository ZIP and extract `skills/dioxus-rust-fullstack-cross-platform-framework`.
