...
- Install from the marketplace listing: https://agentskillexchange.com/skills/ocrmypdf-searchable-pdf-ocr-pipeline/
...
- Download the repository ZIP and extract `skills/ocrmypdf-searchable-pdf-ocr-pipeline`.
