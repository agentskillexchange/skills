...
- Install from the marketplace listing: https://agentskillexchange.com/skills/datadog-anomaly-alert-router/
...
- Download the repository ZIP and extract `skills/datadog-anomaly-alert-router`.
