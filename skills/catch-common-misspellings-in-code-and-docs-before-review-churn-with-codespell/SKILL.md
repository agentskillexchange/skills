...
```
Install with pip install codespell, run codespell at the repository root for a dry run, and use flags such as -w, -i, -I, or --skip to review and apply safe fixes.
```
