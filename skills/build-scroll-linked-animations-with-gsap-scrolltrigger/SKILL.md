...
Download the skill folder or repository archive and extract `skills/build-scroll-linked-animations-with-gsap-scrolltrigger` into your local skills collection.
