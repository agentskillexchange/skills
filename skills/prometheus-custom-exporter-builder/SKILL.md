...
- Install from the marketplace listing: https://agentskillexchange.com/skills/prometheus-custom-exporter-builder/
...
- Download the repository ZIP and extract `skills/prometheus-custom-exporter-builder`.
