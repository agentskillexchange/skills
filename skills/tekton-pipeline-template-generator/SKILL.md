...
- Install from the marketplace listing: https://agentskillexchange.com/skills/tekton-pipeline-template-generator/
...
- Download the repository ZIP and extract `skills/tekton-pipeline-template-generator`.
