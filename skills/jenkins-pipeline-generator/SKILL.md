...
description: Generates declarative Jenkins pipeline scripts using the Jenkins Pipeline Syntax reference and shared library patterns. Integrates with the Jenkins REST API (/api/json) for job configuration and the B
...
```bash
openclaw install jenkins-pipeline-generator
```
...
| Rating | ⭐⭐⭐⭐ 4.8/5.0 (74 reviews) |

---

*Published on [Agent Skill Exchange](https://agentskillexchange.com/skill/jenkins-pipeline-generator/)*
