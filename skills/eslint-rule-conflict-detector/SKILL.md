...
```bash
npx skills add agentskillexchange/skills --skill eslint-rule-conflict-detector
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill eslint-rule-conflict-detector -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill eslint-rule-conflict-detector -a cursor
```

### OpenClaw

```bash
clawhub install eslint-rule-conflict-detector
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill eslint-rule-conflict-detector -a codex
```
