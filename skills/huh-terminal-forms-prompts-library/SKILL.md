...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/huh-terminal-forms-prompts-library
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/huh-terminal-forms-prompts-library` into your local skills collection.
