...
- Install from the marketplace listing: https://agentskillexchange.com/skills/huh-terminal-forms-prompts-library/
...
- Download the repository ZIP and extract `skills/huh-terminal-forms-prompts-library`.
