...
# OpenClaw CLI
openclaw skills install huh-terminal-forms-prompts-library

# Chat command
/skill install huh-terminal-forms-prompts-library

# Direct download
curl -L https://agentskillexchange.com/skills/huh-terminal-forms-prompts-library/download -o huh-terminal-forms-prompts-library.zip

# Git clone this repo and copy the skill folder
cp -r skills/huh-terminal-forms-prompts-library ~/.openclaw/workspace/skills/
```
