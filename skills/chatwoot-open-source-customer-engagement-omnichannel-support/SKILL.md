...
# OpenClaw CLI
openclaw skill install chatwoot-open-source-customer-engagement-omnichannel-support

# Manual download
curl -L https://agentskillexchange.com/skills/chatwoot-open-source-customer-engagement-omnichannel-support/download -o SKILL.md
```
