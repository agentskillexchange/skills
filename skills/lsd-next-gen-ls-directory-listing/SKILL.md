...
- Install from the marketplace listing: https://agentskillexchange.com/skills/lsd-next-gen-ls-directory-listing/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/lsd-next-gen-ls-directory-listing
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/lsd-next-gen-ls-directory-listing`.
