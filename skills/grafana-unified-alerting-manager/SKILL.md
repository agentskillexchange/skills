...
- Install from the marketplace listing: https://agentskillexchange.com/skills/grafana-unified-alerting-manager/
...
- Download the repository ZIP and extract `skills/grafana-unified-alerting-manager`.
