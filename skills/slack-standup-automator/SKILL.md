...
- Install from the marketplace listing: https://agentskillexchange.com/skills/slack-standup-automator/
...
- Download the repository ZIP and extract `skills/slack-standup-automator`.
