...
Download the skill folder or repository archive and extract `skills/ghost-open-source-publishing-platform-memberships-newsletters-headless-cms` into your local skills collection.
