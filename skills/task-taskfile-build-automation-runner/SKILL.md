...
- Install from the marketplace listing: https://agentskillexchange.com/skills/task-taskfile-build-automation-runner/
...
- Download the repository ZIP and extract `skills/task-taskfile-build-automation-runner`.
