...
- Install from the marketplace listing: https://agentskillexchange.com/skills/repomix-codebase-context-packer-llm/
...
- Download the repository ZIP and extract `skills/repomix-codebase-context-packer-llm`.
