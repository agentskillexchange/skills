...
```
Install rumdl using one of the upstream-supported methods such as Cargo, Homebrew, pip, uv, npm, Nix, or standalone binaries; then run rumdl init, rumdl check ., rumdl check --fix ., or rumdl fmt . as appropriate.
```
