...
Download the skill folder or repository archive and extract `skills/implement-review-and-optimize-swiftui-code-with-trace-backed-diagnostics` into your local skills collection.
