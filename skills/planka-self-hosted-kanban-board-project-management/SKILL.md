...
# OpenClaw CLI
openclaw skills install planka-self-hosted-kanban-board-project-management

# Git (manual)
git clone https://github.com/agentskillexchange/skills.git
cp -r skills/skills/planka-self-hosted-kanban-board-project-management ~/.openclaw/workspace/skills/
```
