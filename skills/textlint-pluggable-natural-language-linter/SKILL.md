...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/textlint-pluggable-natural-language-linter
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/textlint-pluggable-natural-language-linter` into your local skills collection.
