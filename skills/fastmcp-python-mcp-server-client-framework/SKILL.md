...
source: "https://agentskillexchange.com/skills/fastmcp-python-mcp-server-client-framework/"
---
...
```bash
npx skills add agentskillexchange/skills --skill fastmcp-python-mcp-server-client-framework
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill fastmcp-python-mcp-server-client-framework -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill fastmcp-python-mcp-server-client-framework -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill fastmcp-python-mcp-server-client-framework -a codex
```
...
- [Source Repository](https://github.com/PrefectHQ/fastmcp)
