...
- Install from the marketplace listing: https://agentskillexchange.com/skills/fastmcp-python-mcp-server-client-framework/
...
- Download the repository ZIP and extract `skills/fastmcp-python-mcp-server-client-framework`.
