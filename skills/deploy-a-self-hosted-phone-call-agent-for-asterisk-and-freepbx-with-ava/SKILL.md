...
Download the skill folder or repository archive and extract `skills/deploy-a-self-hosted-phone-call-agent-for-asterisk-and-freepbx-with-ava` into your local skills collection.
