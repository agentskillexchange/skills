...
Download the skill folder or repository archive and extract `skills/debug-firefox-only-browser-issues-with-devtools-mcp-before-shipping-web-changes` into your local skills collection.
