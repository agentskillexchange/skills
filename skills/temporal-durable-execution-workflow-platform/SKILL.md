...
cp -r /tmp/ase-skills/skills/temporal-durable-execution-workflow-platform ./
```

### Manual Download
Download `SKILL.md` from the [GitHub repository](https://github.com/agentskillexchange/skills/tree/main/skills/temporal-durable-execution-workflow-platform) and place it in `~/.openclaw/workspace/skills/temporal-durable-execution-workflow-platform/`.

### OpenClaw Marketplace
Browse and install from [Agent Skill Exchange](https://agentskillexchange.com/skills/temporal-durable-execution-workflow-platform/).

### Direct curl
```bash
mkdir -p ~/.openclaw/workspace/skills/temporal-durable-execution-workflow-platform
curl -sL https://raw.githubusercontent.com/agentskillexchange/skills/main/skills/temporal-durable-execution-workflow-platform/SKILL.md > ~/.openclaw/workspace/skills/temporal-durable-execution-workflow-platform/SKILL.md
```
