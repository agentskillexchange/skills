...
### OpenClaw
```bash
clawhub install prometheus-alert-runbook-linker-2
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skills/prometheus-alert-runbook-linker-2/) · [Browse All Skills](https://agentskillexchange.com/)