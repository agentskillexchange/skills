...
- Install from the marketplace listing: https://agentskillexchange.com/skills/selenium-grid-session-manager/
...
- Download the repository ZIP and extract `skills/selenium-grid-session-manager`.
