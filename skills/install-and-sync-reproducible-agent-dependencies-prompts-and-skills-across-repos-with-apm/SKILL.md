...
Download the skill folder or repository archive and extract `skills/install-and-sync-reproducible-agent-dependencies-prompts-and-skills-across-repos-with-apm` into your local skills collection.
