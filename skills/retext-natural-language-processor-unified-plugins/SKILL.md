...
Download the skill folder or repository archive and extract `skills/retext-natural-language-processor-unified-plugins` into your local skills collection.
