...
- Install from the marketplace listing: https://agentskillexchange.com/skills/seo-schema-markup-generator-agent/
...
- Download the repository ZIP and extract `skills/seo-schema-markup-generator-agent`.
