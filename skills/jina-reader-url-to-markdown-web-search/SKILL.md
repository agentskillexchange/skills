...
```bash
# Using OpenClaw CLI
openclaw skills install jina-reader-url-to-markdown-web-search
```

**Or install from the Agent Skill Exchange:**
[https://agentskillexchange.com/skills/jina-reader-url-to-markdown-web-search/](https://agentskillexchange.com/skills/jina-reader-url-to-markdown-web-search/)
