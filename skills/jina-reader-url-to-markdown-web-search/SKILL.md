...
- Install from the marketplace listing: https://agentskillexchange.com/skills/jina-reader-url-to-markdown-web-search/
...
- Download the repository ZIP and extract `skills/jina-reader-url-to-markdown-web-search`.
