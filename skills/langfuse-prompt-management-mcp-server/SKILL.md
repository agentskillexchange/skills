...
- Install from the marketplace listing: https://agentskillexchange.com/skills/langfuse-prompt-management-mcp-server/
...
- Download the repository ZIP and extract `skills/langfuse-prompt-management-mcp-server`.
