...
- Install from the marketplace listing: https://agentskillexchange.com/skills/nock-http-server-mocking-nodejs/
...
- Download the repository ZIP and extract `skills/nock-http-server-mocking-nodejs`.
