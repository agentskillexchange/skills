...
- Install from the marketplace listing: https://agentskillexchange.com/skills/ffmpeg-media-transcoder/
...
- Download the repository ZIP and extract `skills/ffmpeg-media-transcoder`.
