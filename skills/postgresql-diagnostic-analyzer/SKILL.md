...
- Install from the marketplace listing: https://agentskillexchange.com/skills/postgresql-diagnostic-analyzer/
...
- Download the repository ZIP and extract `skills/postgresql-diagnostic-analyzer`.
