...
- Install from the marketplace listing: https://agentskillexchange.com/skills/notion-workspace-automator-api-v1/
...
- Download the repository ZIP and extract `skills/notion-workspace-automator-api-v1`.
