...
- Install from the marketplace listing: https://agentskillexchange.com/skills/brave-search-mcp-server-ai-web-search/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/brave-search-mcp-server-ai-web-search
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/brave-search-mcp-server-ai-web-search`.
