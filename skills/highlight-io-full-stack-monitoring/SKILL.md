...
# OpenClaw CLI
openclaw skills install highlight-io-full-stack-monitoring

# Chat command
/skill install highlight-io-full-stack-monitoring

# Direct download
curl -L https://agentskillexchange.com/skills/highlight-io-full-stack-monitoring/download -o highlight-io-full-stack-monitoring.zip

# Git clone this repo and copy the skill folder
cp -r skills/highlight-io-full-stack-monitoring ~/.openclaw/workspace/skills/
```
