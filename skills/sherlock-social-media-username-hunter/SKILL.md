...
### Any Agent (npx)
```bash
npx skills add sherlock-social-media-username-hunter
```

### Claude Code
```bash
npx skills add sherlock-social-media-username-hunter --claude-code
```

### Cursor
```bash
npx skills add sherlock-social-media-username-hunter --cursor
```

### Codex
```bash
npx skills add sherlock-social-media-username-hunter --codex
```
