...
```bash
npx skills add agentskillexchange/skills --skill sherlock-social-media-username-hunter
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill sherlock-social-media-username-hunter -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill sherlock-social-media-username-hunter -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill sherlock-social-media-username-hunter -a codex
```
