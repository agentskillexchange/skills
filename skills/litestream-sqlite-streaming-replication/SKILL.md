...
- Install from the marketplace listing: https://agentskillexchange.com/skills/litestream-sqlite-streaming-replication/
...
- Download the repository ZIP and extract `skills/litestream-sqlite-streaming-replication`.
