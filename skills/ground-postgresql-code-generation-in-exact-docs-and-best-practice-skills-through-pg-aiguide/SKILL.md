...
Download the skill folder or repository archive and extract `skills/ground-postgresql-code-generation-in-exact-docs-and-best-practice-skills-through-pg-aiguide` into your local skills collection.
