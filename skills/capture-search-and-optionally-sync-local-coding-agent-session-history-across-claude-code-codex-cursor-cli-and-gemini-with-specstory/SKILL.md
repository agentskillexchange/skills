...
Download the skill folder or repository archive and extract `skills/capture-search-and-optionally-sync-local-coding-agent-session-history-across-claude-code-codex-cursor-cli-and-gemini-with-specstory` into your local skills collection.
