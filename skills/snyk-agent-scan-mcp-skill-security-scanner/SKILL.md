...
- Install from the marketplace listing: https://agentskillexchange.com/skills/snyk-agent-scan-mcp-skill-security-scanner/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/snyk-agent-scan-mcp-skill-security-scanner
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/snyk-agent-scan-mcp-skill-security-scanner`.
