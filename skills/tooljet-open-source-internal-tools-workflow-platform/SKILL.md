...
Download the skill folder or repository archive and extract `skills/tooljet-open-source-internal-tools-workflow-platform` into your local skills collection.
