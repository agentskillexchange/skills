...
Comparison with Commercial Tools SEOnaut covers similar ground to commercial tools like Screaming Frog, Sitebulb, and Ahrefs Site Audit, but as a free, self-hosted, open-source solution it offers unlimited crawls with no page caps, full data ownership, and the ability to customize detection rules by modifying the Go source code.
...
```bash
npx skills add agentskillexchange/skills --skill seonaut-open-source-technical-seo-audit
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill seonaut-open-source-technical-seo-audit -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill seonaut-open-source-technical-seo-audit -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill seonaut-open-source-technical-seo-audit -a codex
```
