...
- Install from the marketplace listing: https://agentskillexchange.com/skills/quickwit-cloud-native-search-engine-observability/
...
- Download the repository ZIP and extract `skills/quickwit-cloud-native-search-engine-observability`.
