...
Download the skill folder or repository archive and extract `skills/generate-reusable-site-adapters-from-live-browser-behavior-with-opencli` into your local skills collection.
