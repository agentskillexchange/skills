...
- Install from the marketplace listing: https://agentskillexchange.com/skills/python-package-api-surface-mapper/
...
- Download the repository ZIP and extract `skills/python-package-api-surface-mapper`.
