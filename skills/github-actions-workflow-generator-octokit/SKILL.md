...
### OpenClaw
```bash
clawhub install github-actions-workflow-generator-octokit
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skills/github-actions-workflow-generator-octokit/) | [Browse All Skills](https://agentskillexchange.com)
