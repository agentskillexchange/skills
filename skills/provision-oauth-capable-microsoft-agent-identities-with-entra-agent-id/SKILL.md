...
Download the skill folder or repository archive and extract `skills/provision-oauth-capable-microsoft-agent-identities-with-entra-agent-id` into your local skills collection.
