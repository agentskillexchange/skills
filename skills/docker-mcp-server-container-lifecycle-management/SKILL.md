...
- Install from the marketplace listing: https://agentskillexchange.com/skills/docker-mcp-server-container-lifecycle-management/
...
- Download the repository ZIP and extract `skills/docker-mcp-server-container-lifecycle-management`.
