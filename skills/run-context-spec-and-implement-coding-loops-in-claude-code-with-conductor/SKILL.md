...
Download the skill folder or repository archive and extract `skills/run-context-spec-and-implement-coding-loops-in-claude-code-with-conductor` into your local skills collection.
