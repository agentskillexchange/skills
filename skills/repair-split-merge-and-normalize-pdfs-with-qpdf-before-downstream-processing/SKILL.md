...
Download the skill folder or repository archive and extract `skills/repair-split-merge-and-normalize-pdfs-with-qpdf-before-downstream-processing` into your local skills collection.
