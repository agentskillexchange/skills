...
# OpenClaw CLI
openclaw skills install docusaurus-react-documentation-framework-meta

# Manual (git clone)
git clone https://github.com/agentskillexchange/skills.git
cp -r skills/skills/docusaurus-react-documentation-framework-meta ~/.openclaw/workspace/skills/
```
