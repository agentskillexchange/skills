...
Download the skill folder or repository archive and extract `skills/puppeteer-browser-automation-library-for-chrome-and-firefox` into your local skills collection.
