...
- Install from the marketplace listing: https://agentskillexchange.com/skills/metamcp-unified-mcp-server-aggregator-gateway/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/metamcp-unified-mcp-server-aggregator-gateway
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/metamcp-unified-mcp-server-aggregator-gateway`.
