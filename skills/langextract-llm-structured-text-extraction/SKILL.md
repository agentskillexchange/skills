...
- Install from the marketplace listing: https://agentskillexchange.com/skills/langextract-llm-structured-text-extraction/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/langextract-llm-structured-text-extraction
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/langextract-llm-structured-text-extraction`.
