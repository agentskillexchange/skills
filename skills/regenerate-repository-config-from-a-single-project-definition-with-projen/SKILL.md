...
Download the skill folder or repository archive and extract `skills/regenerate-repository-config-from-a-single-project-definition-with-projen` into your local skills collection.
