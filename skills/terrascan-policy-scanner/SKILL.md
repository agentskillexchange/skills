...
- Install from the marketplace listing: https://agentskillexchange.com/skills/terrascan-policy-scanner/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/terrascan-policy-scanner
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/terrascan-policy-scanner`.
