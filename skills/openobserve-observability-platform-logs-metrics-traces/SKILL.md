...
- Install from the marketplace listing: https://agentskillexchange.com/skills/openobserve-observability-platform-logs-metrics-traces/
...
- Download the repository ZIP and extract `skills/openobserve-observability-platform-logs-metrics-traces`.
