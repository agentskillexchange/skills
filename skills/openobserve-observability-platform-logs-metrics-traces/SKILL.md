...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/openobserve-observability-platform-logs-metrics-traces
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/openobserve-observability-platform-logs-metrics-traces` into your local skills collection.
