...
- Install from the marketplace listing: https://agentskillexchange.com/skills/ffmpeg-thumbnail-grid-generator/
...
- Download the repository ZIP and extract `skills/ffmpeg-thumbnail-grid-generator`.
