...
Download the skill folder or repository archive and extract `skills/configure-and-interpret-launchdarkly-ai-config-online-evaluations-with-judge-attachments` into your local skills collection.
