...
description: Use Automattic’s official wp-plugin-development skill when an agent needs
  to build, refactor, secure, or package a WordPress plugin with correct activation
...
Download the skill folder or repository archive and extract `skills/develop-and-harden-wordpress-plugins-with-lifecycle-and-security-guardrails` into your local skills collection.
