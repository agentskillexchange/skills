...
- Install from the marketplace listing: https://agentskillexchange.com/skills/github-actions-workflow-composer-2/
...
- Download the repository ZIP and extract `skills/github-actions-workflow-composer-2`.
