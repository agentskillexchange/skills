...
- Install from the marketplace listing: https://agentskillexchange.com/skills/git-updater-wordpress-plugin-theme-auto-updater/
...
- Download the repository ZIP and extract `skills/git-updater-wordpress-plugin-theme-auto-updater`.
