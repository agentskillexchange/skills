...
# OpenClaw CLI
openclaw skill install verdaccio-private-npm-proxy-registry

# Manual download
curl -L https://agentskillexchange.com/skills/verdaccio-private-npm-proxy-registry/download -o SKILL.md
```
