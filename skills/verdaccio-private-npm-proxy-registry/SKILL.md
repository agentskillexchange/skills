...
- Install from the marketplace listing: https://agentskillexchange.com/skills/verdaccio-private-npm-proxy-registry/
...
- Download the repository ZIP and extract `skills/verdaccio-private-npm-proxy-registry`.
