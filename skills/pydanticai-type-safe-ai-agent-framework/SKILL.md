...
- Install from the marketplace listing: https://agentskillexchange.com/skills/pydanticai-type-safe-ai-agent-framework/
...
- Download the repository ZIP and extract `skills/pydanticai-type-safe-ai-agent-framework`.
