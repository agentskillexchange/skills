...
- Install from the marketplace listing: https://agentskillexchange.com/skills/windmill-workflow-engine-developer-platform/
...
- Download the repository ZIP and extract `skills/windmill-workflow-engine-developer-platform`.
