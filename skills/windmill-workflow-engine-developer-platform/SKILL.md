...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/windmill-workflow-engine-developer-platform
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/windmill-workflow-engine-developer-platform` into your local skills collection.
