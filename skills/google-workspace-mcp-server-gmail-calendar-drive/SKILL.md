...
- Install from the marketplace listing: https://agentskillexchange.com/skills/google-workspace-mcp-server-gmail-calendar-drive/
...
- Download the repository ZIP and extract `skills/google-workspace-mcp-server-gmail-calendar-drive`.
