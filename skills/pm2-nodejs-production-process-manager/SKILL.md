...
- Install from the marketplace listing: https://agentskillexchange.com/skills/pm2-nodejs-production-process-manager/
...
- Download the repository ZIP and extract `skills/pm2-nodejs-production-process-manager`.
