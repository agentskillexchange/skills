...
- Install from the marketplace listing: https://agentskillexchange.com/skills/terraform-drift-detector-2/
...
- Download the repository ZIP and extract `skills/terraform-drift-detector-2`.
