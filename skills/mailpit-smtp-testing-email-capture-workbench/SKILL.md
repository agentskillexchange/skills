...
description: This skill uses Mailpit as a safe SMTP sink for development, QA, and
  automated test runs. It helps teams capture, inspect, search, and validate transactional
  email without sending anything to real inboxes.
...
```bash
npx skills add agentskillexchange/skills --skill mailpit-smtp-testing-email-capture-workbench
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill mailpit-smtp-testing-email-capture-workbench -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill mailpit-smtp-testing-email-capture-workbench -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill mailpit-smtp-testing-email-capture-workbench -a codex
```
...
- [mailpit.axllent.org](https://mailpit.axllent.org/)
