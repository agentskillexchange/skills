...
```bash
npx skills add agentskillexchange/skills --skill imgproxy-high-performance-image-processing-proxy
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill imgproxy-high-performance-image-processing-proxy -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill imgproxy-high-performance-image-processing-proxy -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill imgproxy-high-performance-image-processing-proxy -a codex
```
