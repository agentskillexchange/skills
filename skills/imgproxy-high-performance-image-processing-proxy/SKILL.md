...
- Install from the marketplace listing: https://agentskillexchange.com/skills/imgproxy-high-performance-image-processing-proxy/
...
- Download the repository ZIP and extract `skills/imgproxy-high-performance-image-processing-proxy`.
