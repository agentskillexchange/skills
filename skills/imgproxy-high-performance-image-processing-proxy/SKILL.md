...
### Claude Code
```bash
npx skills add --claude imgproxy-high-performance-image-processing-proxy
```

### Cursor
```bash
npx skills add --cursor imgproxy-high-performance-image-processing-proxy
```

### Codex
```bash
npx skills add --codex imgproxy-high-performance-image-processing-proxy
```
