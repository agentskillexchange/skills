...
- Install from the marketplace listing: https://agentskillexchange.com/skills/sigstore-cosign-verification-pipeline/
...
- Download the repository ZIP and extract `skills/sigstore-cosign-verification-pipeline`.
