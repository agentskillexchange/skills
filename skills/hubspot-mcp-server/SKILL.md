...
- Install from the marketplace listing: https://agentskillexchange.com/skills/hubspot-mcp-server/
...
- Download the repository ZIP and extract `skills/hubspot-mcp-server`.
