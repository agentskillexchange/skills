...
Download the skill folder or repository archive and extract `skills/run-a-long-form-seo-blog-production-workflow-inside-claude-code-with-seo-machine` into your local skills collection.
