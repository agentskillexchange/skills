...
Download the skill folder or repository archive and extract `skills/generate-markdown-tables-of-contents-before-publishing-docs-or-readme-updates` into your local skills collection.
