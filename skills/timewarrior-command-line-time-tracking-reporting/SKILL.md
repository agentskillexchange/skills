...
- Install from the marketplace listing: https://agentskillexchange.com/skills/timewarrior-command-line-time-tracking-reporting/
...
- Download the repository ZIP and extract `skills/timewarrior-command-line-time-tracking-reporting`.
