...
- Install from the marketplace listing: https://agentskillexchange.com/skills/circleci-orb-pipeline-agent/
...
- Download the repository ZIP and extract `skills/circleci-orb-pipeline-agent`.
