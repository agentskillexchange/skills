...
- Install from the marketplace listing: https://agentskillexchange.com/skills/convex-reactive-database-backend/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/convex-reactive-database-backend
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/convex-reactive-database-backend`.
