...
description: smolagents is HuggingFace&#8217;s barebones Python library for building
  AI agents that think in code rather than JSON. Agents write and execute Python code
