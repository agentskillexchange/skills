...
- Install from the marketplace listing: https://agentskillexchange.com/skills/linear-sprint-planner/
...
- Download the repository ZIP and extract `skills/linear-sprint-planner`.
