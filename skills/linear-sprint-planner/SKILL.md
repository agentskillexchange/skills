...
description: Linear Sprint Planner is built around GraphQL API ecosystem. The underlying
...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/linear-sprint-planner
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/linear-sprint-planner` into your local skills collection.
