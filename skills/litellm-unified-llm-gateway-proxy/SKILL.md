...
- Install from the marketplace listing: https://agentskillexchange.com/skills/litellm-unified-llm-gateway-proxy/
...
- Download the repository ZIP and extract `skills/litellm-unified-llm-gateway-proxy`.
