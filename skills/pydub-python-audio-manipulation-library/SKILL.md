...
- Install from the marketplace listing: https://agentskillexchange.com/skills/pydub-python-audio-manipulation-library/
...
- Download the repository ZIP and extract `skills/pydub-python-audio-manipulation-library`.
