...
- Install from the marketplace listing: https://agentskillexchange.com/skills/kubernetes-troubleshooting-runbook/
...
- Download the repository ZIP and extract `skills/kubernetes-troubleshooting-runbook`.
