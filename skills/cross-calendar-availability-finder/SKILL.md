...
```bash
claude mcp add cross-calendar-availability-finder
```

### Manual

Visit the [skill page](https://agentskillexchange.com/skill/cross-calendar-availability-finder/) for detailed installation instructions.
