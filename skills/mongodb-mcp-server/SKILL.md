...
description: "MongoDB MCP Server is built around MongoDB document database. The underlying\
  ...
  \ a thin one-line wrapper, using stable interfaces like collections, aggregation\
  \ pipeline, indexes, Atlas, change streams, schema inspection and preserving the\
  \ […]"
