...
Download the skill folder or repository archive and extract `skills/scan-sites-for-accessibility-gaps-file-github-issues-and-route-fixes-through-copilot-with-accessibility-scanner` into your local skills collection.
