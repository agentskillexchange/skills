...
### Claude Code
```bash
npx skills add espeak-ng-multilingual-speech-synthesizer --claude
```

### Cursor
```bash
npx skills add espeak-ng-multilingual-speech-synthesizer --cursor
```

### Codex
```bash
npx skills add espeak-ng-multilingual-speech-synthesizer --codex
```
