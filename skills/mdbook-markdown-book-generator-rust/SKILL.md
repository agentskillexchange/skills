...
- Install from the marketplace listing: https://agentskillexchange.com/skills/mdbook-markdown-book-generator-rust/
...
- Download the repository ZIP and extract `skills/mdbook-markdown-book-generator-rust`.
