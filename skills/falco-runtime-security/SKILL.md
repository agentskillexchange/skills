...
description: Falco Runtime Security is built around Kubernetes orchestration platform.
...
- Install from the marketplace listing: https://agentskillexchange.com/skills/falco-runtime-security/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/falco-runtime-security
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/falco-runtime-security`.
