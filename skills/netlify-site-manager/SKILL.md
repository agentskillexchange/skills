...
- Install from the marketplace listing: https://agentskillexchange.com/skills/netlify-site-manager/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/netlify-site-manager
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/netlify-site-manager`.
