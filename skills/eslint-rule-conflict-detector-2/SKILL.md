...
- Install from the marketplace listing: https://agentskillexchange.com/skills/eslint-rule-conflict-detector-2/
...
- Download the repository ZIP and extract `skills/eslint-rule-conflict-detector-2`.
