...
- Install from the marketplace listing: https://agentskillexchange.com/skills/recon-ng-web-reconnaissance-framework/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/recon-ng-web-reconnaissance-framework
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/recon-ng-web-reconnaissance-framework`.
