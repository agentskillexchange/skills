...
```bash
npx skills add agentskillexchange/skills --skill rank-math-seo-plugin-wordpress-search-optimization
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill rank-math-seo-plugin-wordpress-search-optimization -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill rank-math-seo-plugin-wordpress-search-optimization -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill rank-math-seo-plugin-wordpress-search-optimization -a codex
```
