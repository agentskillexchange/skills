...
- Install from the marketplace listing: https://agentskillexchange.com/skills/dbt-model-dependency-analyzer/
...
- Download the repository ZIP and extract `skills/dbt-model-dependency-analyzer`.
