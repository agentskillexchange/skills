...
description: This entry turns GitHub Next’s Agentic Wiki Writer into a documentation-maintenance
  workflow. The agent watches for recent merges, reads the PAGES.md template, updates
  only the relevant wiki pages, and opens follow-up changes when the source structure
...
Download the skill folder or repository archive and extract `skills/keep-github-wiki-pages-synced-with-recently-merged-code-changes` into your local skills collection.
