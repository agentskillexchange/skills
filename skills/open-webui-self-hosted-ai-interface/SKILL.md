...
Deployment The platform supports Docker, Kubernetes (kubectl, kustomize, or Helm), and pip installation. It includes granular role-based access control for multi-user environments and supports LDAP/OAuth authentication for enterprise deployments.
...
Download the skill folder or repository archive and extract `skills/open-webui-self-hosted-ai-interface` into your local skills collection.
