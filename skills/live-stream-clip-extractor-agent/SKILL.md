...
- Install from the marketplace listing: https://agentskillexchange.com/skills/live-stream-clip-extractor-agent/
...
- Download the repository ZIP and extract `skills/live-stream-clip-extractor-agent`.
