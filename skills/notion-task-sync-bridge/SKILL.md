...
- Install from the marketplace listing: https://agentskillexchange.com/skills/notion-task-sync-bridge/
...
- Download the repository ZIP and extract `skills/notion-task-sync-bridge`.
