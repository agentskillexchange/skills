...
Download the skill folder or repository archive and extract `skills/amplication-open-source-backend-generation-platform` into your local skills collection.
