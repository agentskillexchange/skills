...
- Install from the marketplace listing: https://agentskillexchange.com/skills/amplication-open-source-backend-generation-platform/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/amplication-open-source-backend-generation-platform
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/amplication-open-source-backend-generation-platform`.
