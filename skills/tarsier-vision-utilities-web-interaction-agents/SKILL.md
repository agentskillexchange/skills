...
Download the skill folder or repository archive and extract `skills/tarsier-vision-utilities-web-interaction-agents` into your local skills collection.
