...
Download the skill folder or repository archive and extract `skills/catch-agent-era-ci-cd-and-permission-misconfigurations-before-shipping-with-ship-safe` into your local skills collection.
