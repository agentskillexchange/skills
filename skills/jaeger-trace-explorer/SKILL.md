...
- Install from the marketplace listing: https://agentskillexchange.com/skills/jaeger-trace-explorer/
...
- Download the repository ZIP and extract `skills/jaeger-trace-explorer`.
