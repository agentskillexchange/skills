...
```bash
npx skills add shellcheck-shell-script-static-analyzer
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skills/shellcheck-shell-script-static-analyzer/)
