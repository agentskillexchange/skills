...
Download the skill folder or repository archive and extract `skills/rehearse-and-run-scripted-terminal-demos-with-realistic-playback-using-doitlive` into your local skills collection.
