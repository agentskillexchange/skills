...
- Install from the marketplace listing: https://agentskillexchange.com/skills/swagger-codegen-api-client-builder/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/swagger-codegen-api-client-builder
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/swagger-codegen-api-client-builder`.
