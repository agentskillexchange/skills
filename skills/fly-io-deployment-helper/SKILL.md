...
- Install from the marketplace listing: https://agentskillexchange.com/skills/fly-io-deployment-helper/
...
- Download the repository ZIP and extract `skills/fly-io-deployment-helper`.
