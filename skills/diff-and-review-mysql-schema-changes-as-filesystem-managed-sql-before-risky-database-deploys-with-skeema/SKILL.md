---
name: Diff and review MySQL schema changes as filesystem-managed SQL before risky
...
Download the skill folder or repository archive and extract `skills/diff-and-review-mysql-schema-changes-as-filesystem-managed-sql-before-risky-database-deploys-with-skeema` into your local skills collection.
