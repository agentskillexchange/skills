...
- Install from the marketplace listing: https://agentskillexchange.com/skills/sonarqube-code-scanner-agent/
...
- Download the repository ZIP and extract `skills/sonarqube-code-scanner-agent`.
