...
- Install from the marketplace listing: https://agentskillexchange.com/skills/instructor-structured-data-extraction-llms/
...
- Download the repository ZIP and extract `skills/instructor-structured-data-extraction-llms`.
