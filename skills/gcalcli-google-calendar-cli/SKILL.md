...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/gcalcli-google-calendar-cli
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/gcalcli-google-calendar-cli` into your local skills collection.
