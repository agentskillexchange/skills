...
- Install from the marketplace listing: https://agentskillexchange.com/skills/gcalcli-google-calendar-cli/
...
- Download the repository ZIP and extract `skills/gcalcli-google-calendar-cli`.
