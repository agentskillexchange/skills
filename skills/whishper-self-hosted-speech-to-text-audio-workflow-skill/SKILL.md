...
Download the skill folder or repository archive and extract `skills/whishper-self-hosted-speech-to-text-audio-workflow-skill` into your local skills collection.
