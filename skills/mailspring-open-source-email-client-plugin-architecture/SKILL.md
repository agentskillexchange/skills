...
Download the skill folder or repository archive and extract `skills/mailspring-open-source-email-client-plugin-architecture` into your local skills collection.
