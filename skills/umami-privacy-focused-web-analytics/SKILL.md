...
### OpenClaw CLI
```bash
openclaw skills install umami-privacy-focused-web-analytics
```
...
cp -r skills/skills/umami-privacy-focused-web-analytics your-project/skills/
```

### Download
Download the SKILL.md file directly from [GitHub](https://github.com/agentskillexchange/skills/tree/main/skills/umami-privacy-focused-web-analytics).
