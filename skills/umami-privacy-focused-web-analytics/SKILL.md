...
- Install from the marketplace listing: https://agentskillexchange.com/skills/umami-privacy-focused-web-analytics/
...
- Download the repository ZIP and extract `skills/umami-privacy-focused-web-analytics`.
