...
Download the skill folder or repository archive and extract `skills/turn-notion-specs-into-implementation-plans-and-tasks-with-notion-spec-to-implementation` into your local skills collection.
