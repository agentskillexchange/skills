---
title: Capture network device config snapshots diffs and change attribution after
  edits with Oxidized
description: Pull running configs from routers and switches on a schedule or after
  change events so you can diff drift, audit edits, and recover known-good state.
verification: listed
