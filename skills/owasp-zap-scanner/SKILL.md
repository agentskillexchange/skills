...
- Install from the marketplace listing: https://agentskillexchange.com/skills/owasp-zap-scanner/
...
- Download the repository ZIP and extract `skills/owasp-zap-scanner`.
