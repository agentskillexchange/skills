...
Download the skill folder or repository archive and extract `skills/generate-podcast-style-audio-narratives-with-podcast-generation` into your local skills collection.
