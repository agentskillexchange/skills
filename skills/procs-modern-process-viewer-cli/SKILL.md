...
### Claude Code
```bash
npx skills add https://agentskillexchange.com/skills/procs-modern-process-viewer-cli/
```

### Cursor
```bash
npx skills add https://agentskillexchange.com/skills/procs-modern-process-viewer-cli/ --cursor
```

### Codex
```bash
npx skills add https://agentskillexchange.com/skills/procs-modern-process-viewer-cli/ --codex
```
