...
- Install from the marketplace listing: https://agentskillexchange.com/skills/hyperfine-command-line-benchmarking-tool/
...
- Download the repository ZIP and extract `skills/hyperfine-command-line-benchmarking-tool`.
