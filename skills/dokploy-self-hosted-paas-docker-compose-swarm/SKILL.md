...
description: "Dokploy is a free, self-hostable Platform as a Service that simplifies deploying and managing applications and databases. It supports Docker Compose natively, multi-node scaling with Docker Swarm, automated backups, and 280+ one-click templates with Traefik integration."
