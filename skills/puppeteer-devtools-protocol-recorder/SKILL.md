...
- Install from the marketplace listing: https://agentskillexchange.com/skills/puppeteer-devtools-protocol-recorder/
...
- Download the repository ZIP and extract `skills/puppeteer-devtools-protocol-recorder`.
