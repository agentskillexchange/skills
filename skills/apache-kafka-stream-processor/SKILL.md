...
- Install from the marketplace listing: https://agentskillexchange.com/skills/apache-kafka-stream-processor/
...
- Download the repository ZIP and extract `skills/apache-kafka-stream-processor`.
