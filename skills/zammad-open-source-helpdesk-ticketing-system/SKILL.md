...
# OpenClaw CLI
openclaw skill install zammad-open-source-helpdesk-ticketing-system

# Manual download
curl -L https://agentskillexchange.com/skills/zammad-open-source-helpdesk-ticketing-system/download -o SKILL.md
```
