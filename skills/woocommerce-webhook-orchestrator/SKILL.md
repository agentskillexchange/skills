...
- Install from the marketplace listing: https://agentskillexchange.com/skills/woocommerce-webhook-orchestrator/
...
- Download the repository ZIP and extract `skills/woocommerce-webhook-orchestrator`.
