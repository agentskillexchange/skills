...
- Install from the marketplace listing: https://agentskillexchange.com/skills/typesense-typo-tolerant-search-engine/
...
- Download the repository ZIP and extract `skills/typesense-typo-tolerant-search-engine`.
