...
Download the skill folder or repository archive and extract `skills/mailgun-javascript-sdk-email-delivery-and-domain-operations` into your local skills collection.
