...
- Install from the marketplace listing: https://agentskillexchange.com/skills/weaviate-mcp-server/
...
- Download the repository ZIP and extract `skills/weaviate-mcp-server`.
