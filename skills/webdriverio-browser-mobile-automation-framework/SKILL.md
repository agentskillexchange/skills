...
```bash
npx skills add agentskillexchange/skills --skill webdriverio-browser-mobile-automation-framework -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill webdriverio-browser-mobile-automation-framework -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill webdriverio-browser-mobile-automation-framework -a codex
```
