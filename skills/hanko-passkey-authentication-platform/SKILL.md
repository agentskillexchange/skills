...
- Install from the marketplace listing: https://agentskillexchange.com/skills/hanko-passkey-authentication-platform/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/hanko-passkey-authentication-platform
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/hanko-passkey-authentication-platform`.
