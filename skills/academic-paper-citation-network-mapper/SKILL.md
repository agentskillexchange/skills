...
- Install from the marketplace listing: https://agentskillexchange.com/skills/academic-paper-citation-network-mapper/
...
- Download the repository ZIP and extract `skills/academic-paper-citation-network-mapper`.
