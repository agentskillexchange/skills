...
Download the skill folder or repository archive and extract `skills/inspect-failing-github-actions-checks-and-plan-fixes-with-gh-fix-ci` into your local skills collection.
