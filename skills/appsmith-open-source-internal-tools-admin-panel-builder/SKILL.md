...
```bash
npx skills add agentskillexchange/skills --skill appsmith-open-source-internal-tools-admin-panel-builder -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill appsmith-open-source-internal-tools-admin-panel-builder -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill appsmith-open-source-internal-tools-admin-panel-builder -a codex
```
