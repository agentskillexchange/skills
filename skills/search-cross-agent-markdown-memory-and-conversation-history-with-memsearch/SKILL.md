...
Download the skill folder or repository archive and extract `skills/search-cross-agent-markdown-memory-and-conversation-history-with-memsearch` into your local skills collection.
