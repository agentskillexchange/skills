...
Download the skill folder or repository archive and extract `skills/run-code-review-and-pr-autofix-workflows-with-coderabbit-skills` into your local skills collection.
