...
### Any Agent (npx)
```bash
npx skills add "libsql-edge-sqlite-fork-turso"
```

### Claude Code
```bash
npx skills add "libsql-edge-sqlite-fork-turso" --claude
```

### Cursor
```bash
npx skills add "libsql-edge-sqlite-fork-turso" --cursor
```

### Codex
```bash
npx skills add "libsql-edge-sqlite-fork-turso" --codex
```
