...
- Install from the marketplace listing: https://agentskillexchange.com/skills/apache-kafka-schema-extractor/
...
- Download the repository ZIP and extract `skills/apache-kafka-schema-extractor`.
