...
### OpenClaw
```bash
clawhub install docker-container-health-inspector-2
```
...
- [View on Agent Skill Exchange](https://agentskillexchange.com/skill/docker-container-health-inspector-2/)
