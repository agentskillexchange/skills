...
- Install from the marketplace listing: https://agentskillexchange.com/skills/aws-cloudwatch-alarm-builder/
...
- Download the repository ZIP and extract `skills/aws-cloudwatch-alarm-builder`.
