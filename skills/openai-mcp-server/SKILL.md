...
- Install from the marketplace listing: https://agentskillexchange.com/skills/openai-mcp-server/
...
- Download the repository ZIP and extract `skills/openai-mcp-server`.
