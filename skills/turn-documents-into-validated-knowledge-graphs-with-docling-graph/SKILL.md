...
Download the skill folder or repository archive and extract `skills/turn-documents-into-validated-knowledge-graphs-with-docling-graph` into your local skills collection.
