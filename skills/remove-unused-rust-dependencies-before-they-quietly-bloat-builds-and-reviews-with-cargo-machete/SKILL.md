---
title: Remove unused Rust dependencies before they quietly bloat builds and reviews
  with cargo-machete
description: Use cargo-machete when an agent needs to find and remove unused Rust
  dependencies before they keep inflating build time, review noise, and manifest drift.
