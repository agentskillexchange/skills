...
description: Vercel Deployment Agent is built around Vercel deployment platform. The
  ...
  previews, edge runtime, project config and preserving […]
...
Download the skill folder or repository archive and extract `skills/vercel-deployment-agent` into your local skills collection.
