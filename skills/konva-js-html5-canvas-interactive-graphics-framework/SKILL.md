...
# OpenClaw CLI
openclaw skills install konva-js-html5-canvas-interactive-graphics-framework

# Git (manual)
git clone https://github.com/agentskillexchange/skills.git
cp -r skills/skills/konva-js-html5-canvas-interactive-graphics-framework ~/.openclaw/workspace/skills/
```
