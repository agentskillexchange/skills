...
- Install from the marketplace listing: https://agentskillexchange.com/skills/paddleocr-multilingual-document-ocr-toolkit/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/paddleocr-multilingual-document-ocr-toolkit
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/paddleocr-multilingual-document-ocr-toolkit`.
