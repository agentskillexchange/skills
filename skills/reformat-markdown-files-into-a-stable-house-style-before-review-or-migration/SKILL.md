...
description: Runs mdformat to rewrite Markdown into a consistent CommonMark-oriented
  layout or check mode in CI. Use it when an agent needs deterministic Markdown diffs
  before review, migration, or bulk cleanup, not when it needs to generate new content
  or build a docs site.
...
- Download the repository ZIP and extract `skills/reformat-markdown-files-into-a-stable-house-style-before-review-or-migration`.
