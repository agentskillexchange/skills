...
Download the skill folder or repository archive and extract `skills/scan-llm-generated-code-before-use-with-codeshield` into your local skills collection.
