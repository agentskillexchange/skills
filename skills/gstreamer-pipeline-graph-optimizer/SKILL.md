...
- Install from the marketplace listing: https://agentskillexchange.com/skills/gstreamer-pipeline-graph-optimizer/
...
- Download the repository ZIP and extract `skills/gstreamer-pipeline-graph-optimizer`.
