...
Download the skill folder or repository archive and extract `skills/ghost-admin-api-headless-publishing-cms-automation` into your local skills collection.
