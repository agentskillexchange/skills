...
- Install from the marketplace listing: https://agentskillexchange.com/skills/openapi-spec-compliance-checker/
...
- Download the repository ZIP and extract `skills/openapi-spec-compliance-checker`.
