...
```bash
npx skills add agentskillexchange/skills --skill formbricks-open-source-survey-experience-management
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill formbricks-open-source-survey-experience-management -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill formbricks-open-source-survey-experience-management -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill formbricks-open-source-survey-experience-management -a codex
```
