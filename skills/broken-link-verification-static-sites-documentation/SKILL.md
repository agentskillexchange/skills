...
- Install from the marketplace listing: https://agentskillexchange.com/skills/broken-link-verification-static-sites-documentation/
...
- Download the repository ZIP and extract `skills/broken-link-verification-static-sites-documentation`.
