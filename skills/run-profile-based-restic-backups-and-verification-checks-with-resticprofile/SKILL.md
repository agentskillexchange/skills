...
Download the skill folder or repository archive and extract `skills/run-profile-based-restic-backups-and-verification-checks-with-resticprofile` into your local skills collection.
