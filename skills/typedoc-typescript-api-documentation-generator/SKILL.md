...
Download the skill folder or repository archive and extract `skills/typedoc-typescript-api-documentation-generator` into your local skills collection.
