...
- Install from the marketplace listing: https://agentskillexchange.com/skills/grafana-dashboard-json-assembler/
...
- Download the repository ZIP and extract `skills/grafana-dashboard-json-assembler`.
