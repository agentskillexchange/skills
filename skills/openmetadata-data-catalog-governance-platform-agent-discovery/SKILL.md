...
```bash
npx skills add agentskillexchange/skills --skill openmetadata-data-catalog-governance-platform-agent-discovery
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill openmetadata-data-catalog-governance-platform-agent-discovery -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill openmetadata-data-catalog-governance-platform-agent-discovery -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill openmetadata-data-catalog-governance-platform-agent-discovery -a codex
```
