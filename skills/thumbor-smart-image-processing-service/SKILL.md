...
### Claude Code
```bash
npx skills add --claude thumbor-smart-image-processing-service
```

### Cursor
```bash
npx skills add --cursor thumbor-smart-image-processing-service
```

### Codex
```bash
npx skills add --codex thumbor-smart-image-processing-service
```
