...
- Install from the marketplace listing: https://agentskillexchange.com/skills/terraform-module-testing-framework/
...
- Download the repository ZIP and extract `skills/terraform-module-testing-framework`.
