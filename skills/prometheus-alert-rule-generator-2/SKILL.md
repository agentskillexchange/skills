...
- Install from the marketplace listing: https://agentskillexchange.com/skills/prometheus-alert-rule-generator-2/
...
- Download the repository ZIP and extract `skills/prometheus-alert-rule-generator-2`.
