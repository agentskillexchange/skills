...
- Install from the marketplace listing: https://agentskillexchange.com/skills/makedown-task-runner/
...
- Download the repository ZIP and extract `skills/makedown-task-runner`.
