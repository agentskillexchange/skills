...
- Install from the marketplace listing: https://agentskillexchange.com/skills/stagehand-ai-browser-automation-framework/
...
- Download the repository ZIP and extract `skills/stagehand-ai-browser-automation-framework`.
