...
- Install from the marketplace listing: https://agentskillexchange.com/skills/stable-diffusion-controlnet-compositor/
...
- Download the repository ZIP and extract `skills/stable-diffusion-controlnet-compositor`.
