...
### Claude Code
```bash
npx skills add coqui-tts-deep-learning-text-to-speech-toolkit --claude
```

### Cursor
```bash
npx skills add coqui-tts-deep-learning-text-to-speech-toolkit --cursor
```

### Codex
```bash
npx skills add coqui-tts-deep-learning-text-to-speech-toolkit --codex
```
