...
- Install from the marketplace listing: https://agentskillexchange.com/skills/terraform-module-boilerplate-assembler/
...
- Download the repository ZIP and extract `skills/terraform-module-boilerplate-assembler`.
