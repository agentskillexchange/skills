...
Download the skill folder or repository archive and extract `skills/gate-risky-agent-actions-behind-approval-checkpoints-with-latch` into your local skills collection.
