...
# OpenClaw CLI
openclaw skill install aerc-extensible-terminal-email-client

# Git clone
git clone https://github.com/agentskillexchange/skills.git
cp -r skills/skills/aerc-extensible-terminal-email-client ~/.openclaw/workspace/skills/

# Manual download
# Download from https://agentskillexchange.com/skills/aerc-extensible-terminal-email-client/
```
