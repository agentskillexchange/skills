...
### Claude Code
```bash
npx @anthropic/agent-skills add memos-self-hosted-note-capture-knowledge-api --agent claude-code
```

### Cursor
```bash
npx @anthropic/agent-skills add memos-self-hosted-note-capture-knowledge-api --agent cursor
```

### Codex
```bash
npx @anthropic/agent-skills add memos-self-hosted-note-capture-knowledge-api --agent codex
```
