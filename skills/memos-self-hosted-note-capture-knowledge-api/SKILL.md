...
```bash
npx skills add agentskillexchange/skills --skill memos-self-hosted-note-capture-knowledge-api
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill memos-self-hosted-note-capture-knowledge-api -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill memos-self-hosted-note-capture-knowledge-api -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill memos-self-hosted-note-capture-knowledge-api -a codex
```
