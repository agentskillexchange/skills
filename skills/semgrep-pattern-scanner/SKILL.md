...
- Install from the marketplace listing: https://agentskillexchange.com/skills/semgrep-pattern-scanner/
...
- Download the repository ZIP and extract `skills/semgrep-pattern-scanner`.
