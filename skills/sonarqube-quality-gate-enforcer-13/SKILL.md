...
### OpenClaw
```bash
clawhub install sonarqube-quality-gate-enforcer-13
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skill/sonarqube-quality-gate-enforcer-13/) · [Browse All Skills](https://agentskillexchange.com/)
