...
Download the skill folder or repository archive and extract `skills/saleor-open-source-headless-commerce-graphql-api` into your local skills collection.
