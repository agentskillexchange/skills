...
- Install from the marketplace listing: https://agentskillexchange.com/skills/npm-dependency-audit-scanner/
...
- Download the repository ZIP and extract `skills/npm-dependency-audit-scanner`.
