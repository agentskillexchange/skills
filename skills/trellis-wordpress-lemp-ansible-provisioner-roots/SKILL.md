...
Download the skill folder or repository archive and extract `skills/trellis-wordpress-lemp-ansible-provisioner-roots` into your local skills collection.
