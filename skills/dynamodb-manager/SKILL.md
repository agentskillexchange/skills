...
- Install from the marketplace listing: https://agentskillexchange.com/skills/dynamodb-manager/
...
- Download the repository ZIP and extract `skills/dynamodb-manager`.
