...
description: GraphQL Schema Explorer is built around GraphQL API ecosystem. The underlying
  ...
  schema exploration, and integration workflows. Key integration points include typed
