...
- Install from the marketplace listing: https://agentskillexchange.com/skills/graphql-schema-explorer/
...
- Download the repository ZIP and extract `skills/graphql-schema-explorer`.
