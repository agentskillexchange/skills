...
description: This ASE skill uses ghz to run repeatable gRPC load tests from proto
  files, protosets, or server reflection. An agent can replay request fixtures at
  controlled concurrency, capture latency and error rates, and export machine-readable
  reports for regression checks or performance investigations.
...
- Install from the marketplace listing: https://agentskillexchange.com/skills/load-test-grpc-services-from-proto-files-and-reusable-request-fixtures/
...
- Download the repository ZIP and extract `skills/load-test-grpc-services-from-proto-files-and-reusable-request-fixtures`.
