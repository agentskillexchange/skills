...
Download the skill folder or repository archive and extract `skills/prepare-meeting-agendas-and-pre-reads-from-notion-context-with-notion-meeting-intelligence` into your local skills collection.
...
- [Agent Skill Exchange](https://agentskillexchange.com/skills/prepare-meeting-agendas-and-pre-reads-from-notion-context-with-notion-meeting-intelligence/)
