...
tool_ecosystem:
  github_repo: "https://github.com/seleniumbase/seleniumbase"
  github_stars: 12560
...
```bash
npx skills add agentskillexchange/skills --skill seleniumbase-python-browser-automation-stealth-testing-framework
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill seleniumbase-python-browser-automation-stealth-testing-framework -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill seleniumbase-python-browser-automation-stealth-testing-framework -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill seleniumbase-python-browser-automation-stealth-testing-framework -a codex
```
