...
- Install from the marketplace listing: https://agentskillexchange.com/skills/satori-html-css-svg-image-generator/
...
- Download the repository ZIP and extract `skills/satori-html-css-svg-image-generator`.
