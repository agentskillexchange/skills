...
```bash
npx skills add agentskillexchange/skills --skill gitui-terminal-git-interface
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill gitui-terminal-git-interface -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill gitui-terminal-git-interface -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill gitui-terminal-git-interface -a codex
```
...
- Marketplace: https://agentskillexchange.com/skills/gitui-terminal-git-interface/
