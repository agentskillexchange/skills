...
- Install from the marketplace listing: https://agentskillexchange.com/skills/sharp-image-cdn-optimizer/
...
- Download the repository ZIP and extract `skills/sharp-image-cdn-optimizer`.
