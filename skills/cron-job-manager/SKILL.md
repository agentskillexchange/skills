...
description: Cron Job Manager is built around Amazon Web Services cloud APIs. The
  ...
  and audit pipelines. Key integration points include cloud automation, identity,
  serverless jobs, storage, and audit pipelines. In a real environment that usually
