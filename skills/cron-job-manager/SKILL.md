...
- Install from the marketplace listing: https://agentskillexchange.com/skills/cron-job-manager/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/cron-job-manager
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/cron-job-manager`.
