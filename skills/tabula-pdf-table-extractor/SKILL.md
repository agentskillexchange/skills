...
- Install from the marketplace listing: https://agentskillexchange.com/skills/tabula-pdf-table-extractor/
...
- Download the repository ZIP and extract `skills/tabula-pdf-table-extractor`.
