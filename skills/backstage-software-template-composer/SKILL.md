...
- Install from the marketplace listing: https://agentskillexchange.com/skills/backstage-software-template-composer/
...
- Download the repository ZIP and extract `skills/backstage-software-template-composer`.
