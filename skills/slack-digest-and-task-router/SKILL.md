...
- Install from the marketplace listing: https://agentskillexchange.com/skills/slack-digest-and-task-router/
...
- Download the repository ZIP and extract `skills/slack-digest-and-task-router`.
