...
- Install from the marketplace listing: https://agentskillexchange.com/skills/sonarqube-quality-gate-checker/
...
- Download the repository ZIP and extract `skills/sonarqube-quality-gate-checker`.
