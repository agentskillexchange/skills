...
Download the skill folder or repository archive and extract `skills/run-blocked-site-browser-tasks-through-anti-bot-friendly-sessions-with-camofox-browser` into your local skills collection.
