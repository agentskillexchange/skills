...
```bash
npx skills add faustjs-headless-wordpress-toolkit-nextjs
```

### Cursor
```bash
npx skills add faustjs-headless-wordpress-toolkit-nextjs --cursor
```

### Codex
```bash
npx skills add faustjs-headless-wordpress-toolkit-nextjs --codex
```
