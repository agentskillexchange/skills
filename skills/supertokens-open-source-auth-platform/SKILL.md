...
- Install from the marketplace listing: https://agentskillexchange.com/skills/supertokens-open-source-auth-platform/
...
- Download the repository ZIP and extract `skills/supertokens-open-source-auth-platform`.
