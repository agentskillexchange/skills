...
- Install from the marketplace listing: https://agentskillexchange.com/skills/circleci-workflow-analyzer/
...
- Download the repository ZIP and extract `skills/circleci-workflow-analyzer`.
