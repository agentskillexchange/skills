...
Download the skill folder or repository archive and extract `skills/playwright-cross-browser-testing-and-automation-framework` into your local skills collection.
