...
- Install from the marketplace listing: https://agentskillexchange.com/skills/stripe-reporting-agent/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/stripe-reporting-agent
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/stripe-reporting-agent`.
