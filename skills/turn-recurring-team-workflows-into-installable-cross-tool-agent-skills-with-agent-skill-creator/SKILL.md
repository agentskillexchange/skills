...
Download the skill folder or repository archive and extract `skills/turn-recurring-team-workflows-into-installable-cross-tool-agent-skills-with-agent-skill-creator` into your local skills collection.
