...
- Install from the marketplace listing: https://agentskillexchange.com/skills/conftest-policy-tester/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/conftest-policy-tester
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/conftest-policy-tester`.
