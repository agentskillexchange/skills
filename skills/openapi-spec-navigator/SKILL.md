...
- Install from the marketplace listing: https://agentskillexchange.com/skills/openapi-spec-navigator/
...
- Download the repository ZIP and extract `skills/openapi-spec-navigator`.
