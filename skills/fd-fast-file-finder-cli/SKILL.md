...
- Install from the marketplace listing: https://agentskillexchange.com/skills/fd-fast-file-finder-cli/
...
- Download the repository ZIP and extract `skills/fd-fast-file-finder-cli`.
