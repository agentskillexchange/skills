...
### Claude Code
```bash
npx skills add https://agentskillexchange.com/skills/fd-fast-file-finder-cli/
```

### Cursor
```bash
npx skills add https://agentskillexchange.com/skills/fd-fast-file-finder-cli/ --cursor
```

### Codex
```bash
npx skills add https://agentskillexchange.com/skills/fd-fast-file-finder-cli/ --codex
```
