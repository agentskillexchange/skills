...
Download the skill folder or repository archive and extract `skills/benchmark-browser-agents-on-repeatable-playwright-web-tasks-with-bananalyzer` into your local skills collection.
