...
slug: "adscrawl-browser"
description: "Read, capture, or interact with browser-rendered websites through AdsCrawl. Use it to extract rendered pages as Markdown, structured article JSON, or HTML; capture viewport or full-page PNG screenshots; and create remote CDP sessions for login flows, JavaScript-heavy applications, Playwright, Puppeteer, Selenium, or browser debugging."
category: "Browser Automation"
framework: "Multi-Framework"
verification: listed
source: "https://github.com/AdsCrawl/skills"
---
...
```bash
clawhub install @adscrawl/adscrawl
```
...
cp -R skills/skills/adscrawl-browser ~/.agent-skills/adscrawl-browser
```

### Optional third-party installer

The `skills` npm package is maintained by Vercel Labs and other third parties, not Agent Skill Exchange. If you choose to use it, pin the package version:

```bash
npm exec --package=skills@1.5.7 -- skills add agentskillexchange/skills --skill adscrawl-browser
```
