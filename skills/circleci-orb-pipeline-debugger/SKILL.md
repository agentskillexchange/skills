...
- Install from the marketplace listing: https://agentskillexchange.com/skills/circleci-orb-pipeline-debugger/
...
- Download the repository ZIP and extract `skills/circleci-orb-pipeline-debugger`.
