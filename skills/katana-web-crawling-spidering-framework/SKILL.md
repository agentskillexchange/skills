...
verification: listed
source: "https://agentskillexchange.com/skills/katana-web-crawling-spidering-framework/"
---
...
### Any Agent (npx)
```bash
npx skills add katana-web-crawling-spidering-framework
```

### Claude Code
```bash
npx skills add katana-web-crawling-spidering-framework --claude-code
```

### Cursor
```bash
npx skills add katana-web-crawling-spidering-framework --cursor
```

### Codex
```bash
npx skills add katana-web-crawling-spidering-framework --codex
```
