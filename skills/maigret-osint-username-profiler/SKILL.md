...
- Install from the marketplace listing: https://agentskillexchange.com/skills/maigret-osint-username-profiler/
...
- Download the repository ZIP and extract `skills/maigret-osint-username-profiler`.
