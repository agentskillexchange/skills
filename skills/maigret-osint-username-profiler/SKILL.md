...
### Any Agent (npx)
```bash
npx skills add maigret-osint-username-profiler
```

### Claude Code
```bash
npx skills add maigret-osint-username-profiler --claude-code
```

### Cursor
```bash
npx skills add maigret-osint-username-profiler --cursor
```

### Codex
```bash
npx skills add maigret-osint-username-profiler --codex
```
