...
- Install from the marketplace listing: https://agentskillexchange.com/skills/python-package-docs-fetcher/
...
- Download the repository ZIP and extract `skills/python-package-docs-fetcher`.
