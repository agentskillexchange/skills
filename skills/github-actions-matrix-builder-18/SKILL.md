...
### OpenClaw
```bash
clawhub install github-actions-matrix-builder-18
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skills/github-actions-matrix-builder-18/) | [Browse All Skills](https://agentskillexchange.com)
