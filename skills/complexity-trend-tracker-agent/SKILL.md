...
- Install from the marketplace listing: https://agentskillexchange.com/skills/complexity-trend-tracker-agent/
...
- Download the repository ZIP and extract `skills/complexity-trend-tracker-agent`.
