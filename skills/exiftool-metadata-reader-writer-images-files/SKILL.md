...
```bash
npx skills add exiftool-metadata-reader-writer-images-files
```

### Cursor

```bash
npx skills add --cursor exiftool-metadata-reader-writer-images-files
```

### Codex

```bash
npx skills add --codex exiftool-metadata-reader-writer-images-files
```
