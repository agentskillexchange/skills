...
- Install from the marketplace listing: https://agentskillexchange.com/skills/exiftool-metadata-reader-writer-images-files/
...
- Download the repository ZIP and extract `skills/exiftool-metadata-reader-writer-images-files`.
