...
- Install from the marketplace listing: https://agentskillexchange.com/skills/stripe-connect-marketplace-sync/
...
- Download the repository ZIP and extract `skills/stripe-connect-marketplace-sync`.
