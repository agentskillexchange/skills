...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/karakeep-bookmark-manager-ai-tagging
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/karakeep-bookmark-manager-ai-tagging` into your local skills collection.
