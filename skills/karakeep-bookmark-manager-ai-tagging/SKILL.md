...
- Install from the marketplace listing: https://agentskillexchange.com/skills/karakeep-bookmark-manager-ai-tagging/
...
- Download the repository ZIP and extract `skills/karakeep-bookmark-manager-ai-tagging`.
