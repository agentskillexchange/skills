...
### Claude Code
```bash
npx skills add chatterbox-sota-open-source-text-to-speech --claude
```

### Cursor
```bash
npx skills add chatterbox-sota-open-source-text-to-speech --cursor
```

### Codex
```bash
npx skills add chatterbox-sota-open-source-text-to-speech --codex
```
