...
- Install from the marketplace listing: https://agentskillexchange.com/skills/argocd-sync-orchestrator/
...
- Download the repository ZIP and extract `skills/argocd-sync-orchestrator`.
