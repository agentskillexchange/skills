...
Download the skill folder or repository archive and extract `skills/simulate-buyer-and-user-personas-to-pressure-test-ideas-and-messaging-with-tinytroupe` into your local skills collection.
