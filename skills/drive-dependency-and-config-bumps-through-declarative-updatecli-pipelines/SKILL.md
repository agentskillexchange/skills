...
Download the skill folder or repository archive and extract `skills/drive-dependency-and-config-bumps-through-declarative-updatecli-pipelines` into your local skills collection.
