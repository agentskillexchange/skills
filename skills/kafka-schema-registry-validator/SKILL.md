...
- Install from the marketplace listing: https://agentskillexchange.com/skills/kafka-schema-registry-validator/
...
- Download the repository ZIP and extract `skills/kafka-schema-registry-validator`.
