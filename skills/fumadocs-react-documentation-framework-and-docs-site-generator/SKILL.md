---
name: "Fumadocs React Documentation Framework and Docs Site Generator"
...
```bash
npx skills add agentskillexchange/skills --skill fumadocs-react-documentation-framework-and-docs-site-generator
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill fumadocs-react-documentation-framework-and-docs-site-generator -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill fumadocs-react-documentation-framework-and-docs-site-generator -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill fumadocs-react-documentation-framework-and-docs-site-generator -a codex
```

### OpenClaw

```bash
clawhub install fumadocs-react-documentation-framework-and-docs-site-generator
```
