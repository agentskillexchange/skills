...
- Install from the marketplace listing: https://agentskillexchange.com/skills/datadog-apm-anomaly-detector/
...
- Download the repository ZIP and extract `skills/datadog-apm-anomaly-detector`.
