...
cp -r skills/skills/oxipng-png-compression-optimizer ~/.openclaw/workspace/skills/

# Manual download
# Download from https://agentskillexchange.com/skills/oxipng-png-compression-optimizer/
```
