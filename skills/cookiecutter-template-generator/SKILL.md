...
- Install from the marketplace listing: https://agentskillexchange.com/skills/cookiecutter-template-generator/
...
- Download the repository ZIP and extract `skills/cookiecutter-template-generator`.
