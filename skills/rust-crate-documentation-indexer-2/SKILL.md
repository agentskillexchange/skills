...
- Install from the marketplace listing: https://agentskillexchange.com/skills/rust-crate-documentation-indexer-2/
...
- Download the repository ZIP and extract `skills/rust-crate-documentation-indexer-2`.
