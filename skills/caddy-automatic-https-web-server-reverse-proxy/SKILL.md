...
```bash
npx skills add caddy-automatic-https-web-server-reverse-proxy
```

### Cursor

```bash
npx skills add --cursor caddy-automatic-https-web-server-reverse-proxy
```

### Codex

```bash
npx skills add --codex caddy-automatic-https-web-server-reverse-proxy
```
