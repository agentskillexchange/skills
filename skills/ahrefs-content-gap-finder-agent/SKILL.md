...
- Install from the marketplace listing: https://agentskillexchange.com/skills/ahrefs-content-gap-finder-agent/
...
- Download the repository ZIP and extract `skills/ahrefs-content-gap-finder-agent`.
