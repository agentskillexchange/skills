...
- Install from the marketplace listing: https://agentskillexchange.com/skills/wxt-next-gen-web-extension-framework/
...
- Download the repository ZIP and extract `skills/wxt-next-gen-web-extension-framework`.
