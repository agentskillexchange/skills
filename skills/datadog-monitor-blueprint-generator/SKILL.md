...
- Install from the marketplace listing: https://agentskillexchange.com/skills/datadog-monitor-blueprint-generator/
...
- Download the repository ZIP and extract `skills/datadog-monitor-blueprint-generator`.
