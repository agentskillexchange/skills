...
- Install from the marketplace listing: https://agentskillexchange.com/skills/argocd-application-sync-manager-2/
...
- Download the repository ZIP and extract `skills/argocd-application-sync-manager-2`.
