...
- Install from the marketplace listing: https://agentskillexchange.com/skills/generate-adversarial-api-test-cases-from-openapi-or-graphql-schema/
...
- Download the repository ZIP and extract `skills/generate-adversarial-api-test-cases-from-openapi-or-graphql-schema`.
