...
- Install from the marketplace listing: https://agentskillexchange.com/skills/airbyte-connector-config-generator/
...
- Download the repository ZIP and extract `skills/airbyte-connector-config-generator`.
