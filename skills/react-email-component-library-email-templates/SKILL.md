...
Installation Install components: npm install @react-email/components -E. For the development preview server: npm install react-email -D. Requires React 18+ and Node.js 18+. The library is MIT licensed and maintained by the Resend team with frequent releases.
...
```bash
npx skills add agentskillexchange/skills --skill react-email-component-library-email-templates
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill react-email-component-library-email-templates -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill react-email-component-library-email-templates -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill react-email-component-library-email-templates -a codex
```
