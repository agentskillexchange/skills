...
- Install from the marketplace listing: https://agentskillexchange.com/skills/react-email-component-library-email-templates/
...
- Download the repository ZIP and extract `skills/react-email-component-library-email-templates`.
