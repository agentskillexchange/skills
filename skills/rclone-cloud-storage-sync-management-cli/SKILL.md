...
```
/install rclone-cloud-storage-sync-management-cli
```
...
cp -r skills/skills/rclone-cloud-storage-sync-management-cli /your/agent/skills/
```

### Option 5: Direct Download
```bash
curl -O https://raw.githubusercontent.com/agentskillexchange/skills/main/skills/rclone-cloud-storage-sync-management-cli/SKILL.md
```
