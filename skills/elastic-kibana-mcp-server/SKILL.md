...
description: Elastic / Kibana MCP Server is built around Elasticsearch search and
  ...
  aggregations, indices, shards, mappings, cluster health […]
...
- Install from the marketplace listing: https://agentskillexchange.com/skills/elastic-kibana-mcp-server/
...
- Download the repository ZIP and extract `skills/elastic-kibana-mcp-server`.
