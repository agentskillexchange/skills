...
- Install from the marketplace listing: https://agentskillexchange.com/skills/playwright-cross-browser-test-runner/
...
- Download the repository ZIP and extract `skills/playwright-cross-browser-test-runner`.
