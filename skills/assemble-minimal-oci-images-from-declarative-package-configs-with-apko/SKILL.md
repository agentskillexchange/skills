...
description: Use apko to build small OCI images from declarative package manifests
  when supply-chain clarity and minimal contents matter more than a conventional Dockerfile
  flow.
verification: listed
