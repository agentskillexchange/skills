...
Download the skill folder or repository archive and extract `skills/logfire-python-observability-sdk-llm-agent-tracing` into your local skills collection.
