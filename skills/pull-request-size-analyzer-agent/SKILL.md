...
- Install from the marketplace listing: https://agentskillexchange.com/skills/pull-request-size-analyzer-agent/
...
- Download the repository ZIP and extract `skills/pull-request-size-analyzer-agent`.
