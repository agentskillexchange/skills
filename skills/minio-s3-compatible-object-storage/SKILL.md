...
- Install from the marketplace listing: https://agentskillexchange.com/skills/minio-s3-compatible-object-storage/
...
- Download the repository ZIP and extract `skills/minio-s3-compatible-object-storage`.
