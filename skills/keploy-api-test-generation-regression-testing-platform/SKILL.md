...
Download the skill folder or repository archive and extract `skills/keploy-api-test-generation-regression-testing-platform` into your local skills collection.
