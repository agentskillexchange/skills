...
- Install from the marketplace listing: https://agentskillexchange.com/skills/gitlab-pipeline-dag-optimizer/
...
- Download the repository ZIP and extract `skills/gitlab-pipeline-dag-optimizer`.
