...
- Install from the marketplace listing: https://agentskillexchange.com/skills/stripe-connect-platform-bridge/
...
- Download the repository ZIP and extract `skills/stripe-connect-platform-bridge`.
