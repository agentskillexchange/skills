...
- Install from the marketplace listing: https://agentskillexchange.com/skills/eslint-autofix-pipeline/
...
- Download the repository ZIP and extract `skills/eslint-autofix-pipeline`.
