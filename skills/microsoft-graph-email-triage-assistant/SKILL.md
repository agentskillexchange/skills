...
- Install from the marketplace listing: https://agentskillexchange.com/skills/microsoft-graph-email-triage-assistant/
...
- Download the repository ZIP and extract `skills/microsoft-graph-email-triage-assistant`.
