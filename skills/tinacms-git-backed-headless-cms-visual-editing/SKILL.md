...
TinaCMS is a fully open-source headless CMS backed by Git that supports Markdown, MDX, JSON, and YAML content. It provides a GraphQL API for querying content, real-time visual editing for non-technical users, and seamless integration with static site generators and Next.js.
...
```bash
npx skills add agentskillexchange/skills --skill tinacms-git-backed-headless-cms-visual-editing
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill tinacms-git-backed-headless-cms-visual-editing -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill tinacms-git-backed-headless-cms-visual-editing -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill tinacms-git-backed-headless-cms-visual-editing -a codex
```
