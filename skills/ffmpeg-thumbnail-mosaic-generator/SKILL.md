...
- Install from the marketplace listing: https://agentskillexchange.com/skills/ffmpeg-thumbnail-mosaic-generator/
...
- Download the repository ZIP and extract `skills/ffmpeg-thumbnail-mosaic-generator`.
