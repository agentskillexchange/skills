...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/goreleaser-cross-platform-release-automation
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/goreleaser-cross-platform-release-automation` into your local skills collection.
