...
- Install from the marketplace listing: https://agentskillexchange.com/skills/goreleaser-cross-platform-release-automation/
...
- Download the repository ZIP and extract `skills/goreleaser-cross-platform-release-automation`.
