...
- Install from the marketplace listing: https://agentskillexchange.com/skills/playwright-multi-browser-test-suite/
...
- Download the repository ZIP and extract `skills/playwright-multi-browser-test-suite`.
