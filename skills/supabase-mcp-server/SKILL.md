...
- Install from the marketplace listing: https://agentskillexchange.com/skills/supabase-mcp-server/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/supabase-mcp-server
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/supabase-mcp-server`.
