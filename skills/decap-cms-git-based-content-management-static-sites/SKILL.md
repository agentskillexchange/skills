...
```bash
npx skills add agentskillexchange/skills --skill decap-cms-git-based-content-management-static-sites
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill decap-cms-git-based-content-management-static-sites -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill decap-cms-git-based-content-management-static-sites -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill decap-cms-git-based-content-management-static-sites -a codex
```
