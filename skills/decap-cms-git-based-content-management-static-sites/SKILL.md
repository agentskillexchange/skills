...
### Claude Code
```bash
npx skills add --claude decap-cms-git-based-content-management-static-sites
```

### Cursor
```bash
npx skills add --cursor decap-cms-git-based-content-management-static-sites
```

### Codex
```bash
npx skills add --codex decap-cms-git-based-content-management-static-sites
```
