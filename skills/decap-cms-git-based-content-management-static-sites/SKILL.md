...
- Install from the marketplace listing: https://agentskillexchange.com/skills/decap-cms-git-based-content-management-static-sites/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/decap-cms-git-based-content-management-static-sites
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/decap-cms-git-based-content-management-static-sites`.
