...
- Install from the marketplace listing: https://agentskillexchange.com/skills/great-expectations-data-validation-pipeline/
...
- Download the repository ZIP and extract `skills/great-expectations-data-validation-pipeline`.
