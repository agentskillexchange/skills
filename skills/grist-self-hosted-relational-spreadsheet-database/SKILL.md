...
# OpenClaw CLI
openclaw skill install grist-self-hosted-relational-spreadsheet-database

# Git clone
git clone https://github.com/agentskillexchange/skills.git
cp -r skills/skills/grist-self-hosted-relational-spreadsheet-database ~/.openclaw/workspace/skills/

# Manual download
# Download from https://agentskillexchange.com/skills/grist-self-hosted-relational-spreadsheet-database/
```
