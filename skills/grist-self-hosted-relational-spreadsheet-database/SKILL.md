...
- Install from the marketplace listing: https://agentskillexchange.com/skills/grist-self-hosted-relational-spreadsheet-database/
...
- Download the repository ZIP and extract `skills/grist-self-hosted-relational-spreadsheet-database`.
