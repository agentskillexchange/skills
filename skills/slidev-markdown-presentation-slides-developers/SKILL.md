...
```bash
npx skills add slidev-markdown-presentation-slides-developers
```
...
[View on Agent Skill Exchange](https://agentskillexchange.com/skills/slidev-markdown-presentation-slides-developers/)
