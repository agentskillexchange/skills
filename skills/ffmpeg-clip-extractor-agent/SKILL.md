...
- Install from the marketplace listing: https://agentskillexchange.com/skills/ffmpeg-clip-extractor-agent/
...
- Download the repository ZIP and extract `skills/ffmpeg-clip-extractor-agent`.
