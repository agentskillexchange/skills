...
- Install from the marketplace listing: https://agentskillexchange.com/skills/circleci-pipeline-optimizer/
...
- Download the repository ZIP and extract `skills/circleci-pipeline-optimizer`.
