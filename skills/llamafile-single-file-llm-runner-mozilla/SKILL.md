...
```bash
npx skills add agentskillexchange/skills --skill llamafile-single-file-llm-runner-mozilla
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill llamafile-single-file-llm-runner-mozilla -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill llamafile-single-file-llm-runner-mozilla -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill llamafile-single-file-llm-runner-mozilla -a codex
```
