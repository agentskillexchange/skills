...
- Install from the marketplace listing: https://agentskillexchange.com/skills/tokei-code-statistics-counter/
...
- Download the repository ZIP and extract `skills/tokei-code-statistics-counter`.
