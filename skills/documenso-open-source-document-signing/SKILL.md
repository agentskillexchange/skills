...
- Install from the marketplace listing: https://agentskillexchange.com/skills/documenso-open-source-document-signing/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/documenso-open-source-document-signing
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/documenso-open-source-document-signing`.
