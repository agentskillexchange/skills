...
- Install from the marketplace listing: https://agentskillexchange.com/skills/bearer-cli-sast-code-security-privacy-scanner/
...
- Download the repository ZIP and extract `skills/bearer-cli-sast-code-security-privacy-scanner`.
