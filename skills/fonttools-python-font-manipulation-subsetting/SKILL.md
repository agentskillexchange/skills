...
- Install from the marketplace listing: https://agentskillexchange.com/skills/fonttools-python-font-manipulation-subsetting/
...
- Download the repository ZIP and extract `skills/fonttools-python-font-manipulation-subsetting`.
