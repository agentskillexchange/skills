...
**From GitHub:**
```bash
clawhub install github:agentskillexchange/skills/skills/fonttools-python-font-manipulation-subsetting
```

**Manual Download:**
Download from [Agent Skill Exchange](https://agentskillexchange.com/skills/fonttools-python-font-manipulation-subsetting/) and place in your skills directory.
