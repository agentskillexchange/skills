...
Download the skill folder or repository archive and extract `skills/put-approval-gates-and-audit-ready-policy-checks-between-agents-and-external-actions-with-dashclaw` into your local skills collection.
