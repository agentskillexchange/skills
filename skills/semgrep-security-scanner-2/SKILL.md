...
- Install from the marketplace listing: https://agentskillexchange.com/skills/semgrep-security-scanner-2/
...
- Download the repository ZIP and extract `skills/semgrep-security-scanner-2`.
