...
- Install from the marketplace listing: https://agentskillexchange.com/skills/chafa-terminal-image-graphics-renderer/
...
- Download the repository ZIP and extract `skills/chafa-terminal-image-graphics-renderer`.
