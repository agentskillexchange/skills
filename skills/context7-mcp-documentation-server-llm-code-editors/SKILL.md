...
```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/context7-mcp-documentation-server-llm-code-editors
```

### Option 3, Download ZIP

Download the skill folder or repository archive and extract `skills/context7-mcp-documentation-server-llm-code-editors` into your local skills collection.
