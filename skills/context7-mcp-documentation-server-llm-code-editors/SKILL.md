...
- Install from the marketplace listing: https://agentskillexchange.com/skills/context7-mcp-documentation-server-llm-code-editors/
...
- Download the repository ZIP and extract `skills/context7-mcp-documentation-server-llm-code-editors`.
