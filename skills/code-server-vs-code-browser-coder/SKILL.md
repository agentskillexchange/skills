...
cp -r skills/skills/code-server-vs-code-browser-coder ~/.openclaw/workspace/skills/
```

### Manual Download
Download from the [Agent Skill Exchange](https://agentskillexchange.com/skills/code-server-vs-code-browser-coder/) and place in your skills directory.
