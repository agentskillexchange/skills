...
- Install from the marketplace listing: https://agentskillexchange.com/skills/activitywatch-automated-time-tracker/
...
- Download the repository ZIP and extract `skills/activitywatch-automated-time-tracker`.
