...
```bash
npx skills add agentskillexchange/skills --skill spiderfoot-osint-automation-framework
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill spiderfoot-osint-automation-framework -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill spiderfoot-osint-automation-framework -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill spiderfoot-osint-automation-framework -a codex
```
