...
- Install from the marketplace listing: https://agentskillexchange.com/skills/gitxray-github-repository-security-xray/
...
- Download the repository ZIP and extract `skills/gitxray-github-repository-security-xray`.
