...
Download the skill folder or repository archive and extract `skills/cloudflare-mcp-servers-workers-security-observability` into your local skills collection.
