...
verification: listed
source: "https://agentskillexchange.com/skills/instaloader-instagram-content-metadata-downloader/"
---
...
### Any Agent (npx)
```bash
npx skills add instaloader-instagram-content-metadata-downloader
```

### Claude Code
```bash
npx skills add instaloader-instagram-content-metadata-downloader --claude-code
```

### Cursor
```bash
npx skills add instaloader-instagram-content-metadata-downloader --cursor
```

### Codex
```bash
npx skills add instaloader-instagram-content-metadata-downloader --codex
```
