...
- Install from the marketplace listing: https://agentskillexchange.com/skills/wp-cli-wordpress-command-line-interface/

### Method 2, Git clone

```bash
git clone https://github.com/agentskillexchange/skills.git && cd skills/skills/wp-cli-wordpress-command-line-interface
```

### Method 3, Download ZIP

- Download the repository ZIP and extract `skills/wp-cli-wordpress-command-line-interface`.
