...
Download the skill folder or repository archive and extract `skills/parallelize-large-pytest-suites-and-isolate-slow-feedback-loops-with-pytest-xdist` into your local skills collection.
