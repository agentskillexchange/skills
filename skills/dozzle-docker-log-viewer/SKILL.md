...
- Install from the marketplace listing: https://agentskillexchange.com/skills/dozzle-docker-log-viewer/
...
- Download the repository ZIP and extract `skills/dozzle-docker-log-viewer`.
