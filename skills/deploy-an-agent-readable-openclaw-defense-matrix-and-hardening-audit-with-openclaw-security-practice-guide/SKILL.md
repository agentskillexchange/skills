...
Download the skill folder or repository archive and extract `skills/deploy-an-agent-readable-openclaw-defense-matrix-and-hardening-audit-with-openclaw-security-practice-guide` into your local skills collection.
