...
- Install from the marketplace listing: https://agentskillexchange.com/skills/playwright-accessibility-audit-runner/
...
- Download the repository ZIP and extract `skills/playwright-accessibility-audit-runner`.
