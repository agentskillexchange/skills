...
Download the skill folder or repository archive and extract `skills/run-http-and-rest-request-files-with-variables-hooks-and-assertions-during-local-or-ci-checks-with-httpyac` into your local skills collection.
