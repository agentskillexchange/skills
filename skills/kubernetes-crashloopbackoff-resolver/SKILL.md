...
- Install from the marketplace listing: https://agentskillexchange.com/skills/kubernetes-crashloopbackoff-resolver/
...
- Download the repository ZIP and extract `skills/kubernetes-crashloopbackoff-resolver`.
