---
name: "Contact Form 7 WordPress Form Builder and Mail Integration"
...
```bash
npx skills add agentskillexchange/skills --skill contact-form-7-wordpress-form-builder-mail-integration
```

### Claude Code

```bash
npx skills add agentskillexchange/skills --skill contact-form-7-wordpress-form-builder-mail-integration -a claude-code
```

### Cursor

```bash
npx skills add agentskillexchange/skills --skill contact-form-7-wordpress-form-builder-mail-integration -a cursor
```

### Codex

```bash
npx skills add agentskillexchange/skills --skill contact-form-7-wordpress-form-builder-mail-integration -a codex
```

### OpenClaw

```bash
clawhub install contact-form-7-wordpress-form-builder-mail-integration
```
