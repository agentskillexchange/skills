...
- Install from the marketplace listing: https://agentskillexchange.com/skills/codecov-coverage-diff-analyzer-2/
...
- Download the repository ZIP and extract `skills/codecov-coverage-diff-analyzer-2`.
