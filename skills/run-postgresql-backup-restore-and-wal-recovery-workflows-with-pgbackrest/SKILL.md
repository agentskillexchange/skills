...
Download the skill folder or repository archive and extract `skills/run-postgresql-backup-restore-and-wal-recovery-workflows-with-pgbackrest` into your local skills collection.
