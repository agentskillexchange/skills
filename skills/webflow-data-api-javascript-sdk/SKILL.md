...
- Install from the marketplace listing: https://agentskillexchange.com/skills/webflow-data-api-javascript-sdk/
...
- Download the repository ZIP and extract `skills/webflow-data-api-javascript-sdk`.
