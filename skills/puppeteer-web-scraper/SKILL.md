...
- Install from the marketplace listing: https://agentskillexchange.com/skills/puppeteer-web-scraper/
...
- Download the repository ZIP and extract `skills/puppeteer-web-scraper`.
