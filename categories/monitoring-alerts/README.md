...
|---|---|---:|---|
| [Kubernetes Event Stream Analyzer](../../skills/kubernetes-event-stream-analyzer/) | Security Reviewed | ⭐ 121.4k | `clawhub install kubernetes-event-stream-analyzer` |
...
| [AWS CloudWatch Anomaly Detector](../../skills/aws-cloudwatch-anomaly-detector/) | Security Reviewed | 3.6k | 9.1M/wk | `clawhub install aws-cloudwatch-anomaly-detector` |
| [AWS CloudWatch Composite Alarm Builder](../../skills/aws-cloudwatch-composite-alarm-builder/) | Security Reviewed | 3.6k | 9.1M/wk | `clawhub install aws-cloudwatch-composite-alarm-builder` |
| [AWS CloudWatch Insights Agent](../../skills/aws-cloudwatch-insights-agent/) | Security Reviewed | 3.6k | 9.1M/wk | `clawhub install aws-cloudwatch-insights-agent` |
| [AWS CloudWatch Insights Query Builder](../../skills/aws-cloudwatch-insights-query-builder/) | Security Reviewed | 3.6k | 9.1M/wk | `clawhub install aws-cloudwatch-insights-query-builder` |
| [CloudWatch Anomaly Detector](../../skills/cloudwatch-anomaly-detector/) | Security Reviewed | 3.6k | 9.1M/wk | `clawhub install cloudwatch-anomaly-detector` |
| [CloudWatch Intelligent Alarms](../../skills/cloudwatch-intelligent-alarms/) | Security Reviewed | 3.6k | 9.1M/wk | `clawhub install cloudwatch-intelligent-alarms` |
| [CloudWatch Log Anomaly Detector](../../skills/cloudwatch-log-anomaly-detector/) | Security Reviewed | 3.6k | 9.1M/wk | `clawhub install cloudwatch-log-anomaly-detector` |
...
| [New Relic NRQL Query Agent](../../skills/new-relic-nrql-query-agent/) | Security Reviewed | 2.9k | 2.2M/wk | `clawhub install new-relic-nrql-query-agent` |
| [New Relic SLO Compliance Monitor](../../skills/new-relic-slo-compliance-monitor/) | Security Reviewed | 2.9k | 2.2M/wk | `clawhub install new-relic-slo-compliance-monitor` |
...
| [PagerDuty Incident Escalator](../../skills/pagerduty-incident-escalator/) | Security Reviewed | 69 | 207.4k/wk | `clawhub install pagerduty-incident-escalator` |
| [PagerDuty Incident Orchestrator](../../skills/pagerduty-incident-orchestrator-2/) | Security Reviewed | 69 | 207.4k/wk | `clawhub install pagerduty-incident-orchestrator-2` |
