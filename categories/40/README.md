...
> **4 skills** · [Browse on agentskillexchange.com →](https://agentskillexchange.com/browse-skills/?category=40)

Skills in this category.

**Live views:** [Top Starred](https://agentskillexchange.com/browse-skills/?category=40&sort=stars) · [Top Downloaded](https://agentskillexchange.com/browse-skills/?category=40&sort=downloads) · [Security Reviewed](https://agentskillexchange.com/browse-skills/?category=40&verification=security_reviewed)

## At a Glance

- **Top Starred:** 4 visible with GitHub signal data
- **Top Downloaded:** 4 visible with npm signal data
...
| [Elastic APM Transaction Anomaly Spotter](../../skills/elastic-apm-transaction-anomaly-spotter/) | Security Reviewed | 🛡️ Security Reviewed | `clawhub install elastic-apm-transaction-anomaly-spotter` |
| [Sentry Issue Spike Detection Agent](../../skills/sentry-issue-spike-detection-agent/) | Security Reviewed | 🛡️ Security Reviewed | `clawhub install sentry-issue-spike-detection-agent` |
| [Uptime Robot Status Page Webhook Alerter](../../skills/uptime-robot-status-page-webhook-alerter/) | Security Reviewed | 🛡️ Security Reviewed | `clawhub install uptime-robot-status-page-webhook-alerter` |
