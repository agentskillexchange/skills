...
> **1778 skills** across **17 categories**
...
| 🔄 | [**Data Extraction & Transformation**](data-extraction-transformation/) | **130** | Parsing, ETL pipelines, format conversion, data wrangling, and transf... |
...
| 🌐 | [**Browser Automation**](browser-automation/) | **80** | Web scraping, UI testing, headless browser control, and browser-based... |
