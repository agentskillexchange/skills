...
> **1515 skills** across **17 categories**

| | Category | Skills | Description |
|---|---|:---:|---|
| 🛠️ | [**Developer Tools**](developer-tools/) | **175** | CLI helpers, dev environment setup, productivity utilities, and devel... |
...
| 🔄 | [**Data Extraction & Transformation**](data-extraction-transformation/) | **113** | Parsing, ETL pipelines, format conversion, data wrangling, and transf... |
| 🔒 | [**Security & Verification**](security-verification/) | **102** | Auth setup, vulnerability scanning, compliance checks, and security a... |
| 📚 | [**Library & API Reference**](library-api-reference/) | **95** | SDK documentation, API guides, framework reference material, and libr... |
...
| 📅 | [**Calendar, Email & Productivity**](calendar-email-productivity/) | **76** | Email automation, calendar management, task coordination, and product... |
| 🎙️ | [**Media & Transcription**](media-transcription/) | **69** | Audio/video processing, speech-to-text, media conversion, and transcr... |
