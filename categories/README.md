...
> **2671 skills** across **17 categories**
...
| 🔄 | [**Data Extraction & Transformation**](data-extraction-transformation/) | **206** | Parsing, ETL pipelines, format conversion, data wrangling, and transf... |
...
| 🔗 | [**Integrations & Connectors**](integrations-connectors/) | **143** | Third-party API bridges, webhook handlers, service connectors, and pl... |
