...
> **2541 skills** across **17 categories**
...
| 🔄 | [**Data Extraction & Transformation**](data-extraction-transformation/) | **175** | Parsing, ETL pipelines, format conversion, data wrangling, and transf... |
...
| 🔗 | [**Integrations & Connectors**](integrations-connectors/) | **124** | Third-party API bridges, webhook handlers, service connectors, and pl... |
| 📚 | [**Library & API Reference**](library-api-reference/) | **122** | SDK documentation, API guides, framework reference material, and libr... |
| 🌐 | [**Browser Automation**](browser-automation/) | **110** | Web scraping, UI testing, headless browser control, and browser-based... |
