...
> **2336 skills** across **17 categories**

| | Category | Skills | Description |
|---|---|:---:|---|
| 🛠️ | [**Developer Tools**](developer-tools/) | **289** | CLI helpers, dev environment setup, productivity utilities, and devel... |
| 🔒 | [**Security & Verification**](security-verification/) | **212** | Auth setup, vulnerability scanning, compliance checks, and security a... |
...
| 🌐 | [**Browser Automation**](browser-automation/) | **99** | Web scraping, UI testing, headless browser control, and browser-based... |
