...
> **1611 skills** across **17 categories**

| | Category | Skills | Description |
|---|---|:---:|---|
| 🛠️ | [**Developer Tools**](developer-tools/) | **200** | CLI helpers, dev environment setup, productivity utilities, and devel... |
...
| ✅ | [**Code Quality & Review**](code-quality-review/) | **93** | Linting rules, review checklists, code standards enforcement, and qua... |
| 📊 | [**Monitoring & Alerts**](monitoring-alerts/) | **91** | Metrics collection, alerting rules, observability setup, and system m... |
| 📅 | [**Calendar, Email & Productivity**](calendar-email-productivity/) | **81** | Email automation, calendar management, task coordination, and product... |
