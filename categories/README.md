...
> **1344 skills** across **17 categories**
...
| 📊 | [**Monitoring & Alerts**](monitoring-alerts/) | **83** | Metrics collection, alerting rules, observability setup, and system m... |
...
| 📅 | [**Calendar, Email & Productivity**](calendar-email-productivity/) | **53** | Email automation, calendar management, task coordination, and product... |
...
| 🌐 | [**Browser Automation**](browser-automation/) | **49** | Web scraping, UI testing, headless browser control, and browser-based... |
| ✍️ | [**Content Writing & SEO**](content-writing-seo/) | **43** | Blog posts, SEO optimization, content strategy, and writing assistance. |
| 📰 | [**WordPress & CMS**](wordpress-cms/) | **43** | Theme/plugin development, WP-CLI automation, CMS management, and Word... |
