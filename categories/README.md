...
> **2669 skills** across **17 categories**

| | Category | Skills | Description |
|---|---|:---:|---|
| 🛠️ | [**Developer Tools**](developer-tools/) | **352** | CLI helpers, dev environment setup, productivity utilities, and devel... |
| 🔒 | [**Security & Verification**](security-verification/) | **235** | Auth setup, vulnerability scanning, compliance checks, and security a... |
| 🔄 | [**Data Extraction & Transformation**](data-extraction-transformation/) | **205** | Parsing, ETL pipelines, format conversion, data wrangling, and transf... |
...
| 🔗 | [**Integrations & Connectors**](integrations-connectors/) | **142** | Third-party API bridges, webhook handlers, service connectors, and pl... |
