...
> **1364 skills** across **17 categories**

| | Category | Skills | Description |
|---|---|:---:|---|
| 🔧 | [**CI/CD Integrations**](ci-cd-integrations/) | **225** | Pipeline configs, deployment automation, build tooling, and ... |
...
| 📚 | [**Library & API Reference**](library-api-reference/) | **98** | SDK documentation, API guides, framework reference material,... |
| 📊 | [**Monitoring & Alerts**](monitoring-alerts/) | **80** | Metrics collection, alerting rules, observability setup, and... |
| 🔄 | [**Data Extraction & Transformation**](data-extraction-transformation/) | **79** | Parsing, ETL pipelines, format conversion, data wrangling, a... |
| 🔒 | [**Security & Verification**](security-verification/) | **75** | Auth setup, vulnerability scanning, compliance checks, and s... |
...
| 🌐 | [**Browser Automation**](browser-automation/) | **43** | Web scraping, UI testing, headless browser control, and brow... |
