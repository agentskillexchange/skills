...
> **1876 skills** across **17 categories**
...
| ✅ | [**Code Quality & Review**](code-quality-review/) | **103** | Linting rules, review checklists, code standards enforcement, and qua... |
| 📰 | [**WordPress & CMS**](wordpress-cms/) | **95** | Theme/plugin development, WP-CLI automation, CMS management, and Word... |
| 🌐 | [**Browser Automation**](browser-automation/) | **89** | Web scraping, UI testing, headless browser control, and browser-based... |
...
| 📄 | [**Templates & Workflows**](templates-workflows/) | **79** | Project scaffolding, boilerplate generators, workflow templates, and ... |
