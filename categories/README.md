...
> **2568 skills** across **17 categories**

| | Category | Skills | Description |
|---|---|:---:|---|
| 🛠️ | [**Developer Tools**](developer-tools/) | **333** | CLI helpers, dev environment setup, productivity utilities, and devel... |
...
| 🔄 | [**Data Extraction & Transformation**](data-extraction-transformation/) | **184** | Parsing, ETL pipelines, format conversion, data wrangling, and transf... |
...
| 📊 | [**Monitoring & Alerts**](monitoring-alerts/) | **136** | Metrics collection, alerting rules, observability setup, and system m... |
