...
> **1197 skills** across **20 categories**
...
| 🛠️ | [**Developer Tools**](developer-tools/) | **102** | CLI helpers, dev environment setup, productivity utilities, and devel... |
...
| 🌐 | [**Browser Automation**](browser-automation/) | **45** | Web scraping, UI testing, headless browser control, and browser-based... |
| 🎙️ | [**Media & Transcription**](media-transcription/) | **40** | Audio/video processing, speech-to-text, media conversion, and transcr... |
| 🔗 | [**Integrations & Connectors**](integrations-connectors/) | **38** | Third-party API bridges, webhook handlers, service connectors, and pl... |
