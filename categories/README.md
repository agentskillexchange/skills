...
> **1154 skills** across **20 categories**
...
| 🔄 | [**Data Extraction & Transformation**](data-extraction-transformation/) | **81** | Parsing, ETL pipelines, format conversion, data wrangling, and transf... |
| 📊 | [**Monitoring & Alerts**](monitoring-alerts/) | **77** | Metrics collection, alerting rules, observability setup, and system m... |
| 🛠️ | [**Developer Tools**](developer-tools/) | **76** | CLI helpers, dev environment setup, productivity utilities, and devel... |
