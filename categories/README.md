...
> **1522 skills** across **17 categories**

| | Category | Skills | Description |
|---|---|:---:|---|
| 🛠️ | [**Developer Tools**](developer-tools/) | **173** | CLI helpers, dev environment setup, productivity utilities, and devel... |
| 🔧 | [**CI/CD Integrations**](ci-cd-integrations/) | **142** | Pipeline configs, deployment automation, build tooling, and continuou... |
| 🔄 | [**Data Extraction & Transformation**](data-extraction-transformation/) | **114** | Parsing, ETL pipelines, format conversion, data wrangling, and transf... |
