...
> **65 skills** · [Browse on agentskillexchange.com →](https://agentskillexchange.com/browse-skills/?category=Research%20%26%20Scraping)
...
|---|---|---:|---|
| [Puppeteer Scraping Framework](../../skills/puppeteer-scraping-framework-2/) | Security Reviewed | ⭐ 93.9k | `clawhub install puppeteer-scraping-framework-2` |
...
| Skill | Tier | Signal | Install |
|---|---|---:|---|
| [Puppeteer Scraping Framework](../../skills/puppeteer-scraping-framework-2/) | Security Reviewed | ⬇ 8.7M/wk | `clawhub install puppeteer-scraping-framework-2` |
...
| Skill | Tier | Signal | Install |
|---|---|---:|---|
| [Puppeteer Scraping Framework](../../skills/puppeteer-scraping-framework-2/) | Security Reviewed | 🛡️ Security Reviewed | `clawhub install puppeteer-scraping-framework-2` |
