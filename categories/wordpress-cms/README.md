...
| Skill | Tier | Signal | Install |
|---|---|---:|---|
| [WP Multisite Domain Mapping Agent](../../skills/wp-multisite-domain-mapping-agent/) | Security Reviewed | 🛡️ Security Reviewed | `clawhub install wp-multisite-domain-mapping-agent` |
...
| [ACF to Gutenberg Block Migrator](../../skills/acf-to-gutenberg-block-migrator/) | Security Reviewed | 🛡️ Security Reviewed | `clawhub install acf-to-gutenberg-block-migrator` |
| [Advanced Custom Fields REST Schema Mapper](../../skills/advanced-custom-fields-rest-schema-mapper/) | Security Reviewed | 🛡️ Security Reviewed | `clawhub install advanced-custom-fields-rest-schema-mapper` |
