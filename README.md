...
[![Published](https://img.shields.io/badge/published-1%2C872-6366f1?style=for-the-badge)](skills/)
...
*1,872 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 151 | Pipeline configs, deployment automation, build tooling |
...
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 89 | Web scraping, UI testing, headless browser control |
...
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 77 | Scaffolders, boilerplate generators, workflow templates |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,872 | In the catalog — every skill is backed by a real tool, repo, or package |
