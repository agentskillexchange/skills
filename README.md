...
[![Published](https://img.shields.io/badge/published-2%2C389-6366f1?style=for-the-badge)](skills/)
[![Categories](https://img.shields.io/badge/categories-17-0ea5e9?style=for-the-badge)](categories/)
[![Security%20Reviewed](https://img.shields.io/badge/security_reviewed-2%2C062-10b981?style=for-the-badge)](verification/)
...
*2,389 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 295 | CLI tools, scaffolders, dev environment setup |
...
| ✅ | [**Code Quality & Review**](categories/code-quality-review/) | 178 | Linting, code review, test generators, coverage |
...
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 106 | Third-party API bridges, webhooks, service connectors |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,389 | In the catalog, every skill is backed by a real tool, repo, or package |
| 🛡️ **Security Reviewed** | 2,062 | Scanned for malicious patterns, prompt injection, and unsafe instructions |
