...
[![Published](https://img.shields.io/badge/published-1%2C705-6366f1?style=for-the-badge)](skills/)
...
*1,705 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 238 | CLI tools, scaffolders, dev environment setup |
...
| 📚 | [**Library & API Reference**](categories/library-api-reference/) | 101 | SDK docs, API parsers, symbol resolvers |
...
| 📅 | [**Calendar, Email & Productivity**](categories/calendar-email-productivity/) | 93 | Email automation, calendar management, task coordination |
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 79 | Third-party API bridges, webhooks, service connectors |
| 🎨 | [**Image & Creative Automation**](categories/image-creative-automation/) | 75 | Image generation, asset processing, design automation |
| 🎙️ | [**Media & Transcription**](categories/media-transcription/) | 74 | Audio/video processing, speech-to-text |
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 74 | Web research, content discovery, data collection |
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 73 | Scaffolders, boilerplate generators, workflow templates |
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 71 | Theme/plugin dev, WP-CLI automation, CMS management |
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 68 | Web scraping, UI testing, headless browser control |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,705 | In the catalog — every skill is backed by a real tool, repo, or package |
