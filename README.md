...
[![Published](https://img.shields.io/badge/published-2%2C108-6366f1?style=for-the-badge)](skills/)
...
*2,108 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔒 | [**Security & Verification**](categories/security-verification/) | 160 | Vulnerability scanning, auth setup, compliance |
...
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 105 | Scaffolders, boilerplate generators, workflow templates |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,108 | In the catalog — every skill is backed by a real tool, repo, or package |
