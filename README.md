...
[![Published](https://img.shields.io/badge/published-1%2C515-6366f1?style=for-the-badge)](skills/)
...
*1,515 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 📅 | [**Calendar, Email & Productivity**](categories/calendar-email-productivity/) | 76 | Email automation, calendar management, task coordination |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,515 | In the catalog — every skill is backed by a real tool, repo, or package |
