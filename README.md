...
[![Published](https://img.shields.io/badge/published-2%2C264-6366f1?style=for-the-badge)](skills/)
...
*2,264 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 📋 | [**Runbooks & Diagnostics**](categories/runbooks-diagnostics/) | 153 | Incident response, troubleshooting, system diagnostics |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,264 | In the catalog — every skill is backed by a real tool, repo, or package |
