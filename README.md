...
[![Published](https://img.shields.io/badge/published-1%2C660-6366f1?style=for-the-badge)](skills/)
[![Categories](https://img.shields.io/badge/categories-17-0ea5e9?style=for-the-badge)](categories/)
[![Security%20Reviewed](https://img.shields.io/badge/security_reviewed-1%2C594-10b981?style=for-the-badge)](verification/)
...
*1,660 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 232 | CLI tools, scaffolders, dev environment setup |
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 145 | Pipeline configs, deployment automation, build tooling |
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 121 | ETL pipelines, parsing, format conversion |
| 🔒 | [**Security & Verification**](categories/security-verification/) | 114 | Vulnerability scanning, auth setup, compliance |
| 📋 | [**Runbooks & Diagnostics**](categories/runbooks-diagnostics/) | 113 | Incident response, troubleshooting, system diagnostics |
| 📊 | [**Monitoring & Alerts**](categories/monitoring-alerts/) | 100 | Metrics, alerting rules, observability |
...
| 📅 | [**Calendar, Email & Productivity**](categories/calendar-email-productivity/) | 90 | Email automation, calendar management, task coordination |
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 75 | Third-party API bridges, webhooks, service connectors |
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 72 | Scaffolders, boilerplate generators, workflow templates |
| 🎨 | [**Image & Creative Automation**](categories/image-creative-automation/) | 72 | Image generation, asset processing, design automation |
| 🎙️ | [**Media & Transcription**](categories/media-transcription/) | 72 | Audio/video processing, speech-to-text |
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 70 | Web research, content discovery, data collection |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,660 | In the catalog — every skill is backed by a real tool, repo, or package |
| 🛡️ **Security Reviewed** | 1,594 | Scanned for malicious patterns, prompt injection, and unsafe instructions |
