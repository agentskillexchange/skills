...
[![Published](https://img.shields.io/badge/published-2%2C130-6366f1?style=for-the-badge)](skills/)
...
*2,130 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 269 | CLI tools, scaffolders, dev environment setup |
...
| 📋 | [**Runbooks & Diagnostics**](categories/runbooks-diagnostics/) | 141 | Incident response, troubleshooting, system diagnostics |
| 📊 | [**Monitoring & Alerts**](categories/monitoring-alerts/) | 121 | Metrics, alerting rules, observability |
...
| 📚 | [**Library & API Reference**](categories/library-api-reference/) | 112 | SDK docs, API parsers, symbol resolvers |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,130 | In the catalog — every skill is backed by a real tool, repo, or package |
