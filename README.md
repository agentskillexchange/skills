...
[![Published](https://img.shields.io/badge/published-1%2C740-6366f1?style=for-the-badge)](skills/)
...
*1,740 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🎙️ | [**Media & Transcription**](categories/media-transcription/) | 77 | Audio/video processing, speech-to-text |
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 76 | Web scraping, UI testing, headless browser control |
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 75 | Theme/plugin dev, WP-CLI automation, CMS management |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,740 | In the catalog — every skill is backed by a real tool, repo, or package |
