...
[![Published](https://img.shields.io/badge/published-2%2C451-6366f1?style=for-the-badge)](skills/)
[![Categories](https://img.shields.io/badge/categories-17-0ea5e9?style=for-the-badge)](categories/)
[![Security%20Reviewed](https://img.shields.io/badge/security_reviewed-2%2C448-10b981?style=for-the-badge)](verification/)
...
*2,451 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
**[Directus SQL-Native Headless CMS and Internal App Platform](https://agentskillexchange.com/skills/directus-sql-native-headless-cms-internal-app-platform/)** — Directus turns a SQL database into a headless CMS, admin app, and instant API layer without forcing a proprietary data model. It is a strong fit for teams…
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 312 | CLI tools, scaffolders, dev environment setup |
...
| ✅ | [**Code Quality & Review**](categories/code-quality-review/) | 182 | Linting, code review, test generators, coverage |
...
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 153 | Scaffolders, boilerplate generators, workflow templates |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,451 | In the catalog — every skill is backed by a real tool, repo, or package |
| 🛡️ **Security Reviewed** | 2,448 | Scanned for malicious patterns, prompt injection, and unsafe instructions |
