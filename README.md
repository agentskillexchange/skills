...
[![Published](https://img.shields.io/badge/published-2%2C279-6366f1?style=for-the-badge)](skills/)
...
*2,279 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 284 | CLI tools, scaffolders, dev environment setup |
| 🔒 | [**Security & Verification**](categories/security-verification/) | 203 | Vulnerability scanning, auth setup, compliance |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,279 | In the catalog — every skill is backed by a real tool, repo, or package |
