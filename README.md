...
[![Published](https://img.shields.io/badge/published-1%2C354-6366f1?style=for-the-badge)](skills/)
...
*1,354 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 52 | Web scraping, UI testing, headless browser control |
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 52 | Web research, content discovery, data collection |
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 47 | Theme/plugin dev, WP-CLI automation, CMS management |
| ✍️ | [**Content Writing & SEO**](categories/content-writing-seo/) | 44 | SEO content, blog automation, editorial workflows |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,354 | In the catalog — every skill is backed by a real tool, repo, or package |
