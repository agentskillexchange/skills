...
[![Published](https://img.shields.io/badge/published-1%2C654-6366f1?style=for-the-badge)](skills/)
...
*1,654 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 212 | CLI tools, scaffolders, dev environment setup |
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 144 | Pipeline configs, deployment automation, build tooling |
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 120 | ETL pipelines, parsing, format conversion |
...
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 72 | Third-party API bridges, webhooks, service connectors |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,654 | In the catalog — every skill is backed by a real tool, repo, or package |
