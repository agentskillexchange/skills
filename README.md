...
[![Published](https://img.shields.io/badge/published-3%2C020-6366f1?style=for-the-badge)](CATALOG.md)
...
*3,020 published skills · 15 Industry Collections · 17 categories · Real ecosystem signals · Updated daily*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 482 | CLI tools, scaffolders, dev environment setup |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 3,020 | In the catalog — every skill is backed by a real tool, repo, or package |
