...
[![Published](https://img.shields.io/badge/published-1%2C665-6366f1?style=for-the-badge)](skills/)
...
*1,665 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 231 | CLI tools, scaffolders, dev environment setup |
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 145 | Pipeline configs, deployment automation, build tooling |
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 122 | ETL pipelines, parsing, format conversion |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,665 | In the catalog — every skill is backed by a real tool, repo, or package |
