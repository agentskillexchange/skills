...
[![Security%20Reviewed](https://img.shields.io/badge/security--reviewed-2%2C398-10b981?style=for-the-badge)](verification/)
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 393 | CLI tools, scaffolders, dev environment setup |
...
| 🛡️ **Security Reviewed** | 2,398 | Scanned for malicious patterns, prompt injection, and unsafe instructions |
