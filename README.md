...
[![Published](https://img.shields.io/badge/published-2%2C102-6366f1?style=for-the-badge)](skills/)
...
*2,102 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 268 | CLI tools, scaffolders, dev environment setup |
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 166 | Pipeline configs, deployment automation, build tooling |
...
| 📋 | [**Runbooks & Diagnostics**](categories/runbooks-diagnostics/) | 139 | Incident response, troubleshooting, system diagnostics |
...
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 103 | Scaffolders, boilerplate generators, workflow templates |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,102 | In the catalog — every skill is backed by a real tool, repo, or package |
