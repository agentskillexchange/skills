...
[![Published](https://img.shields.io/badge/published-1%2C769-6366f1?style=for-the-badge)](skills/)
...
*1,769 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 📊 | [**Monitoring & Alerts**](categories/monitoring-alerts/) | 106 | Metrics, alerting rules, observability |
...
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 82 | Web research, content discovery, data collection |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,769 | In the catalog — every skill is backed by a real tool, repo, or package |
