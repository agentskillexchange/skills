...
[![Published](https://img.shields.io/badge/published-1%2C393-6366f1?style=for-the-badge)](skills/)
...
*1,393 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🎙️ | [**Media & Transcription**](categories/media-transcription/) | 58 | Audio/video processing, speech-to-text |
...
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 57 | Web research, content discovery, data collection |
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 56 | Web scraping, UI testing, headless browser control |
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 53 | Theme/plugin dev, WP-CLI automation, CMS management |
| ✍️ | [**Content Writing & SEO**](categories/content-writing-seo/) | 51 | SEO content, blog automation, editorial workflows |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,393 | In the catalog — every skill is backed by a real tool, repo, or package |
