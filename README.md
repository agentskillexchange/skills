...
[![Published](https://img.shields.io/badge/published-1%2C760-6366f1?style=for-the-badge)](skills/)
...
*1,760 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 📚 | [**Library & API Reference**](categories/library-api-reference/) | 105 | SDK docs, API parsers, symbol resolvers |
| 📊 | [**Monitoring & Alerts**](categories/monitoring-alerts/) | 104 | Metrics, alerting rules, observability |
...
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 84 | Third-party API bridges, webhooks, service connectors |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,760 | In the catalog — every skill is backed by a real tool, repo, or package |
