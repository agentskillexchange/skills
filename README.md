...
[![Published](https://img.shields.io/badge/published-2%2C281-6366f1?style=for-the-badge)](skills/)
...
*2,281 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔒 | [**Security & Verification**](categories/security-verification/) | 204 | Vulnerability scanning, auth setup, compliance |
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 183 | Pipeline configs, deployment automation, build tooling |
| ✅ | [**Code Quality & Review**](categories/code-quality-review/) | 165 | Linting, code review, test generators, coverage |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,281 | In the catalog — every skill is backed by a real tool, repo, or package |
