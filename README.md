...
[![Published](https://img.shields.io/badge/published-2%2C523-6366f1?style=for-the-badge)](skills/)
[![Categories](https://img.shields.io/badge/categories-17-0ea5e9?style=for-the-badge)](categories/)
[![Security%20Reviewed](https://img.shields.io/badge/security--reviewed-2%2C171-10b981?style=for-the-badge)](verification/)
...
*2,523 published skills · 17 categories · Real ecosystem signals · Updated daily*
...
**[Control authenticated Chrome sessions through MCP with OpenChrome](skills/control-authenticated-chrome-sessions-through-mcp-with-openchrome/)** — Let an agent drive a real logged-in Chrome profile through MCP for authenticated browsing, parallel tab work, and token-efficient page interaction without re-authenticating each run.
...
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 173 | ETL pipelines, parsing, format conversion |
| 📋 | [**Runbooks & Diagnostics**](categories/runbooks-diagnostics/) | 171 | Incident response, troubleshooting, system diagnostics |
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 169 | Scaffolders, boilerplate generators, workflow templates |
...
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 121 | Third-party API bridges, webhooks, service connectors |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,523 | In the catalog — every skill is backed by a real tool, repo, or package |
| 🛡️ **Security Reviewed** | 2,171 | Scanned for malicious patterns, prompt injection, and unsafe instructions |
