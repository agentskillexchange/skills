...
[![Published](https://img.shields.io/badge/published-2%2C135-6366f1?style=for-the-badge)](skills/)
...
*2,135 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 153 | ETL pipelines, parsing, format conversion |
| ✅ | [**Code Quality & Review**](categories/code-quality-review/) | 144 | Linting, code review, test generators, coverage |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,135 | In the catalog — every skill is backed by a real tool, repo, or package |
