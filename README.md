...
[![Published](https://img.shields.io/badge/published-1%2C869-6366f1?style=for-the-badge)](skills/)
...
*1,869 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 251 | CLI tools, scaffolders, dev environment setup |
...
| ✍️ | [**Content Writing & SEO**](categories/content-writing-seo/) | 64 | SEO content, blog automation, editorial workflows |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,869 | In the catalog — every skill is backed by a real tool, repo, or package |
