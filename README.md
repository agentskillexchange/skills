...
[![Published](https://img.shields.io/badge/published-1%2C623-6366f1?style=for-the-badge)](skills/)
...
*1,623 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 204 | CLI tools, scaffolders, dev environment setup |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,623 | In the catalog — every skill is backed by a real tool, repo, or package |
