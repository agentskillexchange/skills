...
[![Published](https://img.shields.io/badge/published-1%2C381-6366f1?style=for-the-badge)](skills/)
...
*1,381 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 56 | Web research, content discovery, data collection |
| 🎙️ | [**Media & Transcription**](categories/media-transcription/) | 55 | Audio/video processing, speech-to-text |
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 54 | Web scraping, UI testing, headless browser control |
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 51 | Theme/plugin dev, WP-CLI automation, CMS management |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,381 | In the catalog — every skill is backed by a real tool, repo, or package |
