...
- **1364+ skills and growing** — new skills added every hour, automatically synced from the [live marketplace](https://agentskillexchange.com)
...
All 1364+ skills in this repo have reached **Verified Metadata** or higher. See the [verification criteria](verification/) for details.
