...
[![Published](https://img.shields.io/badge/published-1%2C900-6366f1?style=for-the-badge)](skills/)
...
*1,900 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔒 | [**Security & Verification**](categories/security-verification/) | 127 | Vulnerability scanning, auth setup, compliance |
...
| ✅ | [**Code Quality & Review**](categories/code-quality-review/) | 110 | Linting, code review, test generators, coverage |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,900 | In the catalog — every skill is backed by a real tool, repo, or package |
