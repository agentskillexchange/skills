...
[![Published](https://img.shields.io/badge/published-2%2C092-6366f1?style=for-the-badge)](skills/)
...
*2,092 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔒 | [**Security & Verification**](categories/security-verification/) | 157 | Vulnerability scanning, auth setup, compliance |
...
| 📋 | [**Runbooks & Diagnostics**](categories/runbooks-diagnostics/) | 137 | Incident response, troubleshooting, system diagnostics |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,092 | In the catalog — every skill is backed by a real tool, repo, or package |
