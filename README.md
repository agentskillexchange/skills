...
[![Published](https://img.shields.io/badge/published-1%2C492-6366f1?style=for-the-badge)](skills/)
...
*1,492 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 📅 | [**Calendar, Email & Productivity**](categories/calendar-email-productivity/) | 74 | Email automation, calendar management, task coordination |
...
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 65 | Web research, content discovery, data collection |
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 62 | Third-party API bridges, webhooks, service connectors |
...
| ✍️ | [**Content Writing & SEO**](categories/content-writing-seo/) | 57 | SEO content, blog automation, editorial workflows |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,492 | In the catalog — every skill is backed by a real tool, repo, or package |
