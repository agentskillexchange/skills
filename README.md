...
[![Security%20Reviewed](https://img.shields.io/badge/security--reviewed-2%2C556-10b981?style=for-the-badge)](verification/)
...
**[Run CodeWhale terminal coding agent workflows](skills/run-codewhale-terminal-coding-agent-workflows/)** — Use CodeWhale as a local terminal coding agent for repository edits, test repair, provider-switched sessions, approval-gated commands, MCP tools, skills, and hooks.
...
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 173 | Third-party API bridges, webhooks, service connectors |
...
| 🛡️ **Security Reviewed** | 2,556 | Scanned for malicious patterns, prompt injection, and unsafe instructions |
