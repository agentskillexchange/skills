...
[![Published](https://img.shields.io/badge/published-2%2C301-6366f1?style=for-the-badge)](skills/)
...
*2,301 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 285 | CLI tools, scaffolders, dev environment setup |
...
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 124 | Scaffolders, boilerplate generators, workflow templates |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,301 | In the catalog — every skill is backed by a real tool, repo, or package |
