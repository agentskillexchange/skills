...
[![Published](https://img.shields.io/badge/published-1%2C957-6366f1?style=for-the-badge)](skills/)
...
*1,957 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 257 | CLI tools, scaffolders, dev environment setup |
...
| ✅ | [**Code Quality & Review**](categories/code-quality-review/) | 115 | Linting, code review, test generators, coverage |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,957 | In the catalog — every skill is backed by a real tool, repo, or package |
