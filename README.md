...
[![Published](https://img.shields.io/badge/published-2%2C080-6366f1?style=for-the-badge)](skills/)
...
*2,080 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 150 | ETL pipelines, parsing, format conversion |
| ✅ | [**Code Quality & Review**](categories/code-quality-review/) | 138 | Linting, code review, test generators, coverage |
...
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 100 | Scaffolders, boilerplate generators, workflow templates |
...
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 95 | Web research, content discovery, data collection |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,080 | In the catalog — every skill is backed by a real tool, repo, or package |
