...
[![Published](https://img.shields.io/badge/published-1%2C537-6366f1?style=for-the-badge)](skills/)
...
*1,537 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 65 | Third-party API bridges, webhooks, service connectors |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,537 | In the catalog — every skill is backed by a real tool, repo, or package |
