...
[![Published](https://img.shields.io/badge/published-1%2C426-6366f1?style=for-the-badge)](skills/)
...
*1,426 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 155 | CLI tools, scaffolders, dev environment setup |
...
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 106 | ETL pipelines, parsing, format conversion |
...
| 🎨 | [**Image & Creative Automation**](categories/image-creative-automation/) | 63 | Image generation, asset processing, design automation |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,426 | In the catalog — every skill is backed by a real tool, repo, or package |
