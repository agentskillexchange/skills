...
[![Published](https://img.shields.io/badge/published-1%2C961-6366f1?style=for-the-badge)](skills/)
...
*1,961 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔒 | [**Security & Verification**](categories/security-verification/) | 131 | Vulnerability scanning, auth setup, compliance |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,961 | In the catalog — every skill is backed by a real tool, repo, or package |
