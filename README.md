...
[![Published](https://img.shields.io/badge/published-1%2C818-6366f1?style=for-the-badge)](skills/)
...
*1,818 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 246 | CLI tools, scaffolders, dev environment setup |
...
| 🔒 | [**Security & Verification**](categories/security-verification/) | 122 | Vulnerability scanning, auth setup, compliance |
...
| 📅 | [**Calendar, Email & Productivity**](categories/calendar-email-productivity/) | 99 | Email automation, calendar management, task coordination |
...
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 85 | Web scraping, UI testing, headless browser control |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,818 | In the catalog — every skill is backed by a real tool, repo, or package |
