...
[![Published](https://img.shields.io/badge/published-1%2C963-6366f1?style=for-the-badge)](skills/)
...
*1,963 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| ✅ | [**Code Quality & Review**](categories/code-quality-review/) | 116 | Linting, code review, test generators, coverage |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,963 | In the catalog — every skill is backed by a real tool, repo, or package |
