...
[![Published](https://img.shields.io/badge/published-1%2C906-6366f1?style=for-the-badge)](skills/)
...
*1,906 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 137 | ETL pipelines, parsing, format conversion |
...
| 📅 | [**Calendar, Email & Productivity**](categories/calendar-email-productivity/) | 106 | Email automation, calendar management, task coordination |
...
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 87 | Web research, content discovery, data collection |
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 87 | Third-party API bridges, webhooks, service connectors |
| 🎙️ | [**Media & Transcription**](categories/media-transcription/) | 85 | Audio/video processing, speech-to-text |
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 83 | Scaffolders, boilerplate generators, workflow templates |
| 🎨 | [**Image & Creative Automation**](categories/image-creative-automation/) | 80 | Image generation, asset processing, design automation |
| ✍️ | [**Content Writing & SEO**](categories/content-writing-seo/) | 66 | SEO content, blog automation, editorial workflows |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,906 | In the catalog — every skill is backed by a real tool, repo, or package |
