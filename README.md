...
[![Published](https://img.shields.io/badge/published-1%2C648-6366f1?style=for-the-badge)](skills/)
...
*1,648 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 210 | CLI tools, scaffolders, dev environment setup |
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 143 | Pipeline configs, deployment automation, build tooling |
...
| 🔒 | [**Security & Verification**](categories/security-verification/) | 111 | Vulnerability scanning, auth setup, compliance |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,648 | In the catalog — every skill is backed by a real tool, repo, or package |
