...
[![Published](https://img.shields.io/badge/published-1%2C543-6366f1?style=for-the-badge)](skills/)
...
*1,543 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 180 | CLI tools, scaffolders, dev environment setup |
...
| ✍️ | [**Content Writing & SEO**](categories/content-writing-seo/) | 60 | SEO content, blog automation, editorial workflows |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,543 | In the catalog — every skill is backed by a real tool, repo, or package |
