...
[![Published](https://img.shields.io/badge/published-1%2C789-6366f1?style=for-the-badge)](skills/)
...
*1,789 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 131 | ETL pipelines, parsing, format conversion |
...
| 📊 | [**Monitoring & Alerts**](categories/monitoring-alerts/) | 109 | Metrics, alerting rules, observability |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,789 | In the catalog — every skill is backed by a real tool, repo, or package |
