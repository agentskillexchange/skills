...
[![Published](https://img.shields.io/badge/published-1%2C702-6366f1?style=for-the-badge)](skills/)
...
*1,702 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 📚 | [**Library & API Reference**](categories/library-api-reference/) | 99 | SDK docs, API parsers, symbol resolvers |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,702 | In the catalog — every skill is backed by a real tool, repo, or package |
