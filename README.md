...
**[Firecrawl Web Data API for AI Search Scraping and Crawl Workflows](skills/firecrawl-web-data-api-ai-search-scraping-crawl-workflows/)** — Firecrawl is an open source web data platform for search, scraping, crawling, and browser-like page interaction. It gives agents LLM-ready markdown, structured JSON, screenshots, and agent-oriented endpoints for…
