...
[![Published](https://img.shields.io/badge/published-2%2C383-6366f1?style=for-the-badge)](skills/)
...
*2,383 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 177 | Pipeline configs, deployment automation, build tooling |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,383 | In the catalog, every skill is backed by a real tool, repo, or package |
| 🛡️ **Security Reviewed** | 1,988 | Scanned for malicious patterns, prompt injection, and unsafe instructions |
