...
[![Published](https://img.shields.io/badge/published-2%2C045-6366f1?style=for-the-badge)](skills/)
...
*2,045 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 162 | Pipeline configs, deployment automation, build tooling |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,045 | In the catalog — every skill is backed by a real tool, repo, or package |
