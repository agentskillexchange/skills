...
[![Published](https://img.shields.io/badge/published-2%2C669-6366f1?style=for-the-badge)](CATALOG.md)
...
*2,669 published skills · 15 Industry Collections · 17 categories · Real ecosystem signals · Updated daily*
...
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 142 | Third-party API bridges, webhooks, service connectors |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,669 | In the catalog — every skill is backed by a real tool, repo, or package |
