...
[![Published](https://img.shields.io/badge/published-1%2C414-6366f1?style=for-the-badge)](skills/)
...
*1,414 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🎙️ | [**Media & Transcription**](categories/media-transcription/) | 61 | Audio/video processing, speech-to-text |
...
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 54 | Theme/plugin dev, WP-CLI automation, CMS management |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,414 | In the catalog — every skill is backed by a real tool, repo, or package |
