...
[![Published](https://img.shields.io/badge/published-1%2C344-6366f1?style=for-the-badge)](skills/)
...
*1,344 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 49 | Web scraping, UI testing, headless browser control |
| ✍️ | [**Content Writing & SEO**](categories/content-writing-seo/) | 43 | SEO content, blog automation, editorial workflows |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,344 | In the catalog — every skill is backed by a real tool, repo, or package |
