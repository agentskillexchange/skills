...
[![Published](https://img.shields.io/badge/published-1%2C671-6366f1?style=for-the-badge)](skills/)
...
*1,671 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 123 | ETL pipelines, parsing, format conversion |
| 🔒 | [**Security & Verification**](categories/security-verification/) | 115 | Vulnerability scanning, auth setup, compliance |
...
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 71 | Web research, content discovery, data collection |
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 66 | Theme/plugin dev, WP-CLI automation, CMS management |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,671 | In the catalog — every skill is backed by a real tool, repo, or package |
