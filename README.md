...
[![Published](https://img.shields.io/badge/published-1%2C614-6366f1?style=for-the-badge)](skills/)
...
*1,614 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 📊 | [**Monitoring & Alerts**](categories/monitoring-alerts/) | 92 | Metrics, alerting rules, observability |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,614 | In the catalog — every skill is backed by a real tool, repo, or package |
