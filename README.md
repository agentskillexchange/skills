...
[![Published](https://img.shields.io/badge/published-2%2C054-6366f1?style=for-the-badge)](skills/)
...
*2,054 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 263 | CLI tools, scaffolders, dev environment setup |
...
| 🔒 | [**Security & Verification**](categories/security-verification/) | 149 | Vulnerability scanning, auth setup, compliance |
| 📋 | [**Runbooks & Diagnostics**](categories/runbooks-diagnostics/) | 135 | Incident response, troubleshooting, system diagnostics |
| ✅ | [**Code Quality & Review**](categories/code-quality-review/) | 134 | Linting, code review, test generators, coverage |
...
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 97 | Scaffolders, boilerplate generators, workflow templates |
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 96 | Theme/plugin dev, WP-CLI automation, CMS management |
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 95 | Web scraping, UI testing, headless browser control |
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 95 | Third-party API bridges, webhooks, service connectors |
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 92 | Web research, content discovery, data collection |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,054 | In the catalog — every skill is backed by a real tool, repo, or package |
