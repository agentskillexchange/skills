...
[![Published](https://img.shields.io/badge/published-1%2C736-6366f1?style=for-the-badge)](skills/)
...
*1,736 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 77 | Web research, content discovery, data collection |
| 📄 | [**Templates & Workflows**](categories/templates-workflows/) | 74 | Scaffolders, boilerplate generators, workflow templates |
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 74 | Theme/plugin dev, WP-CLI automation, CMS management |
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 74 | Web scraping, UI testing, headless browser control |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,736 | In the catalog — every skill is backed by a real tool, repo, or package |
