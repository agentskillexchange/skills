...
[![Published](https://img.shields.io/badge/published-1%2C686-6366f1?style=for-the-badge)](skills/)
...
*1,686 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 239 | CLI tools, scaffolders, dev environment setup |
...
| 📚 | [**Library & API Reference**](categories/library-api-reference/) | 98 | SDK docs, API parsers, symbol resolvers |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,686 | In the catalog — every skill is backed by a real tool, repo, or package |
