...
[![Published](https://img.shields.io/badge/published-2%2C145-6366f1?style=for-the-badge)](skills/)
...
*2,145 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 172 | Pipeline configs, deployment automation, build tooling |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,145 | In the catalog — every skill is backed by a real tool, repo, or package |
