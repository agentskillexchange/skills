...
[![Published](https://img.shields.io/badge/published-1%2C407-6366f1?style=for-the-badge)](skills/)
...
*1,407 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 📅 | [**Calendar, Email & Productivity**](categories/calendar-email-productivity/) | 62 | Email automation, calendar management, task coordination |
...
| 🎙️ | [**Media & Transcription**](categories/media-transcription/) | 59 | Audio/video processing, speech-to-text |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,407 | In the catalog — every skill is backed by a real tool, repo, or package |
