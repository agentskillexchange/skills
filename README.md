...
[![Published](https://img.shields.io/badge/published-2%2C192-6366f1?style=for-the-badge)](skills/)
...
*2,192 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔒 | [**Security & Verification**](categories/security-verification/) | 176 | Vulnerability scanning, auth setup, compliance |
| ✅ | [**Code Quality & Review**](categories/code-quality-review/) | 156 | Linting, code review, test generators, coverage |
...
| 📅 | [**Calendar, Email & Productivity**](categories/calendar-email-productivity/) | 117 | Email automation, calendar management, task coordination |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,192 | In the catalog — every skill is backed by a real tool, repo, or package |
