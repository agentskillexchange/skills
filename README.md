...
[![Published](https://img.shields.io/badge/published-2%2C050-6366f1?style=for-the-badge)](skills/)
...
*2,050 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 163 | Pipeline configs, deployment automation, build tooling |
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 150 | ETL pipelines, parsing, format conversion |
| 🔒 | [**Security & Verification**](categories/security-verification/) | 146 | Vulnerability scanning, auth setup, compliance |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,050 | In the catalog — every skill is backed by a real tool, repo, or package |
