...
[![Published](https://img.shields.io/badge/published-1%2C743-6366f1?style=for-the-badge)](skills/)
...
*1,743 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔍 | [**Research & Scraping**](categories/research-scraping/) | 78 | Web research, content discovery, data collection |
| 🎨 | [**Image & Creative Automation**](categories/image-creative-automation/) | 77 | Image generation, asset processing, design automation |
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 76 | Theme/plugin dev, WP-CLI automation, CMS management |
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 76 | Web scraping, UI testing, headless browser control |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,743 | In the catalog — every skill is backed by a real tool, repo, or package |
