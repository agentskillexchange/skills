...
[![Published](https://img.shields.io/badge/published-1%2C718-6366f1?style=for-the-badge)](skills/)
...
*1,718 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🌐 | [**Browser Automation**](categories/browser-automation/) | 69 | Web scraping, UI testing, headless browser control |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,718 | In the catalog — every skill is backed by a real tool, repo, or package |
