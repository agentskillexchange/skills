...
[![Published](https://img.shields.io/badge/published-2%2C247-6366f1?style=for-the-badge)](skills/)
...
*2,247 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔒 | [**Security & Verification**](categories/security-verification/) | 188 | Vulnerability scanning, auth setup, compliance |
...
| 🔄 | [**Data Extraction & Transformation**](categories/data-extraction-transformation/) | 158 | ETL pipelines, parsing, format conversion |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,247 | In the catalog — every skill is backed by a real tool, repo, or package |
