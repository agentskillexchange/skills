...
[![Published](https://img.shields.io/badge/published-1%2C667-6366f1?style=for-the-badge)](skills/)
...
*1,667 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 📅 | [**Calendar, Email & Productivity**](categories/calendar-email-productivity/) | 87 | Email automation, calendar management, task coordination |
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 74 | Third-party API bridges, webhooks, service connectors |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,667 | In the catalog — every skill is backed by a real tool, repo, or package |
