...
[![Published](https://img.shields.io/badge/published-1%2C386-6366f1?style=for-the-badge)](skills/)
...
*1,386 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 52 | Theme/plugin dev, WP-CLI automation, CMS management |
| ✍️ | [**Content Writing & SEO**](categories/content-writing-seo/) | 47 | SEO content, blog automation, editorial workflows |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,386 | In the catalog — every skill is backed by a real tool, repo, or package |
