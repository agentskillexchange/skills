...
[![Published](https://img.shields.io/badge/published-2%2C141-6366f1?style=for-the-badge)](skills/)
...
*2,141 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 🔧 | [**CI/CD Integrations**](categories/ci-cd-integrations/) | 171 | Pipeline configs, deployment automation, build tooling |
...
| 📋 | [**Runbooks & Diagnostics**](categories/runbooks-diagnostics/) | 142 | Incident response, troubleshooting, system diagnostics |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 2,141 | In the catalog — every skill is backed by a real tool, repo, or package |
