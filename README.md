...
[![Published](https://img.shields.io/badge/published-1%2C561-6366f1?style=for-the-badge)](skills/)
...
*1,561 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
|---|---|---:|---|
| 🛠️ | [**Developer Tools**](categories/developer-tools/) | 186 | CLI tools, scaffolders, dev environment setup |
...
| 🔒 | [**Security & Verification**](categories/security-verification/) | 104 | Vulnerability scanning, auth setup, compliance |
...
| 🎨 | [**Image & Creative Automation**](categories/image-creative-automation/) | 69 | Image generation, asset processing, design automation |
...
| 🔗 | [**Integrations & Connectors**](categories/integrations-connectors/) | 67 | Third-party API bridges, webhooks, service connectors |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,561 | In the catalog — every skill is backed by a real tool, repo, or package |
