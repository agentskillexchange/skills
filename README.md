...
[![Published](https://img.shields.io/badge/published-1%2C696-6366f1?style=for-the-badge)](skills/)
...
*1,696 published skills · 17 categories · Real ecosystem signals · Updated hourly*
...
| 📅 | [**Calendar, Email & Productivity**](categories/calendar-email-productivity/) | 92 | Email automation, calendar management, task coordination |
...
| 📰 | [**WordPress & CMS**](categories/wordpress-cms/) | 70 | Theme/plugin dev, WP-CLI automation, CMS management |
...
| Tier | Count | Meaning |
|------|------:|---|
| 📋 **Published** | 1,696 | In the catalog — every skill is backed by a real tool, repo, or package |
