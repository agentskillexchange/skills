...
lines.append("")
lines.append("An open, machine-readable catalog of reusable skills for AI agents. Each skill wraps a real tool, API, or workflow into a format that agents and runtimes like OpenClaw, Claude Code, Codex, Gemini, Cursor, MCP clients, LangChain, OpenAI Agents, Hermes, and custom agent workflows can install and use.")
lines.append("")
