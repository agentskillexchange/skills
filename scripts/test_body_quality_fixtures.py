...
Copy the configuration file into your agent workspace.""",
    ...
    {
        "name": "actionable_quick_start_security_reviewed_passes",
        "slug": "agent-vision-toolkit-install-quality-fixture",
        "verification": "security_reviewed",
        "source": "https://github.com/Anionex/agent-vision-toolkit",
        "repo": "Anionex/agent-vision-toolkit",
        "installation": "Follow the upstream README quick start: configure VISION_API_KEY, VISION_BASE_URL, and VISION_MODEL; clone https://github.com/Anionex/agent-vision-toolkit; add its bin directory to PATH; and copy the vision-tools skill into your agent workspace.",
        "pass": True,
    },
    {
        "name": "marketing_only_quick_start_security_reviewed_fails",
        "slug": "marketing-quick-start-install-quality-fixture",
        "verification": "security_reviewed",
        "source": "https://github.com/acme/marketing-tool",
        "repo": "acme/marketing-tool",
        "installation": "Quick Start\nCommunity showcase\nBenchmark results",
        "pass": False,
        "reason": "only marketing/features/screenshots/badges found",
    },
    {
