...
| 9 | [Storybook Component Tester](skills/storybook-component-tester/) | 89.7k | storybook | Code Quality & Review |
| 10 | [Hugo Fast Static Site Generator and CMS Framework](skills/hugo-static-site-generator-cms-framework/) | 87.4k | hugo | WordPress & CMS |
| 11 | [Playwright Cross-Browser Testing and Automation Framework](skills/playwright-cross-browser-testing-and-automation-framework/) | 85.5k | playwright | Browser Automation |
| 12 | [browser-use Browser Automation Framework](skills/browser-use-browser-automation-framework/) | 85.2k | browser-use | Browser Automation |
| 13 | [PostgreSQL MCP Server](skills/postgresql-mcp-server/) | 83.3k | servers | Data Extraction & Transformation |
| 14 | [uv Ultra-Fast Python Package and Project Manager](skills/uv-ultra-fast-python-package-project-manager/) | 82.4k | uv | Developer Tools |
| 15 | [fzf Command-Line Fuzzy Finder](skills/fzf-command-line-fuzzy-finder/) | 79.2k | fzf | Developer Tools |
| 16 | [Hoppscotch Open Source API Development Ecosystem](skills/hoppscotch-api-development-ecosystem/) | 78.7k | hoppscotch | Developer Tools |
| 17 | [ElasticSearch Cluster Vitals Agent](skills/elasticsearch-cluster-vitals-agent/) | 76.5k | elasticsearch | Monitoring & Alerts |
| 18 | [Sherlock Social Media Username Hunter Across 400+ Networks](skills/sherlock-social-media-username-hunter/) | 76.2k | sherlock | Research & Scraping |
| 19 | [lazygit Terminal UI for Git Operations](skills/lazygit-terminal-ui-git-operations/) | 75.4k | lazygit | Developer Tools |
| 20 | [vLLM High-Throughput LLM Serving Engine with PagedAttention](skills/vllm-high-throughput-llm-serving/) | 75.1k | vllm | Developer Tools |
| 21 | [PaddleOCR Multilingual Document OCR and Structured Data Toolkit](skills/paddleocr-multilingual-document-ocr-toolkit/) | 73.7k | paddleocr | Data Extraction & Transformation |
| 22 | [Strapi Open Source Headless CMS with REST and GraphQL APIs](skills/strapi-headless-cms-rest-graphql/) | 71.7k | strapi | WordPress & CMS |
| 23 | [Caddy Automatic HTTPS Web Server and Reverse Proxy](skills/caddy-automatic-https-web-server-reverse-proxy/) | 71.2k | caddy | Developer Tools |
