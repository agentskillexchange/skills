...
| 23 | [act Local GitHub Actions Runner](skills/act-local-github-actions-runner/) | 69.7k | act | CI/CD Integrations |
| 24 | [Docusaurus React Documentation Framework by Meta](skills/docusaurus-react-documentation-framework-meta/) | 64.3k | docusaurus | Developer Tools |
| 25 | [Crawl4AI LLM-Ready Web Crawler and Scraper](skills/crawl4ai-llm-web-crawler-scraper/) | 63.1k | crawl4ai | Research & Scraping |
| 26 | [Open Interpreter Natural Language Computer Interface](skills/open-interpreter-natural-language-computer-interface/) | 62.9k | open-interpreter | Developer Tools |
| 27 | [NocoDB Self-Hosted No-Code Database Platform with REST API](skills/nocodb-self-hosted-no-code-database-rest-api/) | 62.6k | nocodb | Integrations & Connectors |
| 28 | [ripgrep Recursive Regex Search Tool](skills/ripgrep-recursive-regex-search-tool/) | 61.7k | ripgrep | Developer Tools |
| 29 | [Memos Self-Hosted Note Capture and Knowledge API](skills/memos-self-hosted-note-capture-knowledge-api/) | 58.5k | memos | Calendar, Email & Productivity |
| 30 | [mkcert Zero-Config Local Development TLS Certificate Generator](skills/mkcert-local-dev-tls-certificate-generator/) | 58.4k | mkcert | Developer Tools |
| 31 | [Astro Content-Driven Web Framework](skills/astro-content-driven-web-framework/) | 58k | astro | Developer Tools |
| 32 | [bat Syntax-Highlighting Cat Replacement](skills/bat-syntax-highlighting-cat-replacement/) | 57.9k | bat | Developer Tools |
| 33 | [MinerU PDF-to-Markdown Document Parser](skills/mineru-pdf-to-markdown-document-parser/) | 57.8k | mineru | Data Extraction & Transformation |
| 34 | [PocketBase Open Source Realtime Backend in a Single Binary](skills/pocketbase-open-source-realtime-backend-single-binary/) | 57.3k | pocketbase | Developer Tools |
| 35 | [Docling AI Document Intelligence Pipeline](skills/docling-ai-document-intelligence-pipeline/) | 56.9k | docling | Data Extraction & Transformation |
| 36 | [Rclone Cloud Storage Sync and Management CLI](skills/rclone-cloud-storage-sync-management-cli/) | 56.4k | rclone | Integrations & Connectors |
| 37 | [Starship Cross-Shell Prompt Configurator](skills/starship-cross-shell-prompt-configurator/) | 55.7k | starship | Developer Tools |
