...
| 11 | [Use Dify for production agentic workflow apps](skills/use-dify-for-production-agentic-workflow-apps/) | 143.7k | dify | Templates & Workflows |
| 12 | [Open WebUI Self-Hosted AI Interface for LLMs](skills/open-webui-self-hosted-ai-interface/) | 130.4k | open-webui | Developer Tools |
| 13 | [Kubernetes Troubleshooting Runbook](skills/k8s-troubleshooting-runbook/) | 122.6k | kubernetes | Monitoring & Alerts |
| 14 | [Excalidraw Virtual Whiteboard and Diagram SDK](skills/excalidraw-virtual-whiteboard-diagram-sdk/) | 119.9k | excalidraw | Image & Creative Automation |
| 15 | [shadcn/ui — Re-usable UI Component Collection for React](skills/shadcn-ui-react-component-collection/) | 112.1k | ui | Developer Tools |
| 16 | [Stable Diffusion ComfyUI Workflow Runner](skills/stable-diffusion-comfyui-workflow-runner-2/) | 112.0k | stable.diffusion | Image & Creative Automation |
| 17 | [ComfyUI Workflow Executor](skills/comfyui-workflow-executor/) | 109.1k | vault | Image & Creative Automation |
| 18 | [Firecrawl Web Data API for AI Agents](skills/firecrawl-web-data-api-for-ai-agents/) | 108.8k | firecrawl | Research & Scraping |
| 19 | [Run terminal-native repo analysis, edits, and command loops with Gemini in a bounded CLI workflow with Gemini CLI](skills/run-terminal-native-repo-analysis-edits-and-command-loops-with-gemini-in-a-bounded-cli-workflow-with-gemini-cli/) | 101.6k | gemini-cli | Developer Tools |
| 20 | [OpenAI Whisper Transcription](skills/openai-whisper-transcription/) | 101.1k | whisper | Media & Transcription |
