...
|---|---|---:|---|
| 🎙️ | [**Media & Publishing Systems**](media-publishing-systems.md) | 17 | Transcription, subtitles, podcast workflows, chaptering, localization, loudness cleanup, and final-mile publishing prep. |
| 💼 | [**Finance & Filings**](finance-filings.md) | 22 | Filings research, invoice intake, billing operations, reconciliation, and finance-adjacent reporting. |
...
| 🎧 | [**Customer Support & Success**](customer-support-success.md) | 24 | Helpdesk queues, ticket triage, conversation lookup, knowledge-base workflows, customer context, CRM sync, and reply-drafting support. |
...
| 🎓 | [**Education & Research Workflows**](education-research-workflows.md) | 22 | Literature review, citation context, research synthesis, paper drafting, replication checks, and evidence packets for academic and technical teams. |
...
| 🧭 | [**AI Agency Operations & FDE Workflows**](ai-agency-operations.md) | 20 | Client-facing AI delivery, forward deployed engineering workflows, browser automation, implementation systems, documentation, spreadsheets, proposals, and client handoff workflows. |
...
| 🗄️ | [**Data Platform & Analytics Engineering**](data-platform-analytics-engineering.md) | 26 | Data engineering and analytics operations workflows for SQL, dbt, Airflow, warehouses, Postgres, CSV cleanup, schema quality, backups, lineage, dashboards, and query tuning. |
