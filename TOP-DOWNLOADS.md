...
| 4 | [pnpm Fast Disk-Efficient Package Manager](skills/pnpm-fast-disk-efficient-package-manager/) | 66.3M/wk | pnpm | Developer Tools |
...
| 12 | [OpenAI Image Gen](skills/openai-image-gen/) | 20.5M/wk | openai | Image & Creative Automation |
...
| 17 | [Stripe API Reference Navigator](skills/stripe-api-reference-navigator/) | 9.3M/wk | stripe | Library & API Reference |
| 18 | [MySQL Query Agent](skills/mysql-query-agent/) | 8.9M/wk | mysql | Developer Tools |
| 19 | [Pixelmatch Pixel-Level Image Comparison Library by Mapbox](skills/pixelmatch-image-comparison-library/) | 8.7M/wk | pixelmatch | Image & Creative Automation |
| 20 | [Convert HTML emails and web fragments into clean plain text for downstream agents](skills/convert-html-emails-and-web-fragments-into-clean-plain-text-for-downstream-agents/) | 8.2M/wk | html-to-text | Data Extraction & Transformation |
...
| 37 | [Metrics Dashboard Builder](skills/metrics-dashboard-builder/) | 2.3M/wk | datadog-api-client-typescript | Monitoring & Alerts |
...
| 40 | [LangChain MCP Server](skills/langchain-mcp-server/) | 2M/wk | langchain | Developer Tools |
